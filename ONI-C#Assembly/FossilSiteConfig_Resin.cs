...
{
  public static readonly HashedString FossilQuestCriteriaID = (HashedString) "LostResinFossil";
  public const string ID = "FossilResin";

  public GameObject CreatePrefab()
  {
    string name = (string) CODEX.STORY_TRAITS.FOSSILHUNT.ENTITIES.FOSSIL_RESIN.NAME;
    string desc = (string) CODEX.STORY_TRAITS.FOSSILHUNT.ENTITIES.FOSSIL_RESIN.DESC;
    EffectorValues tieR4 = TUNING.BUILDINGS.DECOR.BONUS.TIER4;
    EffectorValues tieR3 = NOISE_POLLUTION.NOISY.TIER3;
    KAnimFile anim = Assets.GetAnim((HashedString) "fossil_resin_kanim");
    EffectorValues decor = tieR4;
    EffectorValues noise = tieR3;
    GameObject placedEntity = EntityTemplates.CreatePlacedEntity("FossilResin", name, desc, 4000f, anim, "object", Grid.SceneLayer.BuildingBack, 2, 2, decor, noise, additionalTags: new List<Tag>()
    {
      GameTags.Gravitas
    });
    ...
    placedEntity.AddOrGetDef<MinorFossilDigSite.Def>().fossilQuestCriteriaID = FossilSiteConfig_Resin.FossilQuestCriteriaID;
