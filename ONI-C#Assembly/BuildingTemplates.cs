...
public class BuildingTemplates
{
    ...
    bool clusterRocket = false)
  {
    ...
    if (vanillaBGAnim != null)
      rocketModule.SetBGKAnim(Assets.GetAnim((HashedString) vanillaBGAnim));
    ...
    float fuelCostPerDistance = 0.0f)
  {
    ...
    if ((bool) (UnityEngine.Object) template.GetComponent<RocketEngineCluster>())
    {
    ...
    if ((bool) (UnityEngine.Object) template.GetComponent<PassengerRocketModule>())
      template.GetComponent<ReorderableBuilding>().buildConditions.Add((SelectModuleCondition) new NoFreeRocketInterior());
    if ((bool) (UnityEngine.Object) template.GetComponent<CargoBay>())
