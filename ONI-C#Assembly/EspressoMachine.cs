  ...
  IGameObjectEffectDescriptor
{
  ...
  public class StatesInstance(EspressoMachine smi) : 
    GameStateMachine<EspressoMachine.States, EspressoMachine.StatesInstance, EspressoMachine, object>.GameInstance(smi)
  {
  }
}
