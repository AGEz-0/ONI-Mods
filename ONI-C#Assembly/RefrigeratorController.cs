  ...
  GameStateMachine<RefrigeratorController, RefrigeratorController.StatesInstance, IStateMachineTarget, RefrigeratorController.Def>
{
  ...
  private bool AllFoodCool(RefrigeratorController.StatesInstance smi, float dt)
  {
    foreach (GameObject gameObject in smi.storage.items)
    {
      if (!((UnityEngine.Object) gameObject == (UnityEngine.Object) null))
      {
        ...
        if (!((UnityEngine.Object) component == (UnityEngine.Object) null) && (double) component.Mass >= 0.0099999997764825821 && (double) component.Temperature >= (double) smi.def.simulatedInternalTemperature + (double) smi.def.activeCoolingStopBuffer)
          return false;
      }
    }
    return true;
  ...
  private bool AnyWarmFood(RefrigeratorController.StatesInstance smi, float dt)
  {
    foreach (GameObject gameObject in smi.storage.items)
    {
      ...
      {
        PrimaryElement component = gameObject.GetComponent<PrimaryElement>();
        if (!((UnityEngine.Object) component == (UnityEngine.Object) null) && (double) component.Mass >= 0.0099999997764825821 && (double) component.Temperature >= (double) smi.def.simulatedInternalTemperature + (double) smi.def.activeCoolingStartBuffer)
          return true;
      }
    }
    return false;
    ...
    GameStateMachine<RefrigeratorController, RefrigeratorController.StatesInstance, IStateMachineTarget, RefrigeratorController.Def>.GameInstance
  {
    ...
    {
      GameComps.StructureTemperatures.ProduceEnergy(this.structureTemperature, this.def.coolingHeatKW * dt, (string) BUILDING.STATUSITEMS.OPERATINGENERGY.FOOD_TRANSFER, dt);
    }

    public void ApplySteadyExhaust(float dt)
    {
      GameComps.StructureTemperatures.ProduceEnergy(this.structureTemperature, this.def.steadyHeatKW * dt, (string) BUILDING.STATUSITEMS.OPERATINGENERGY.FOOD_TRANSFER, dt);
    }
  }
}
