...
public class BalloonArtistChore : Chore<BalloonArtistChore.StatesInstance>, IWorkerPrioritizable
{
    ...
    GameStateMachine<BalloonArtistChore.States, BalloonArtistChore.StatesInstance, BalloonArtistChore>
  {
    ...
    public override void InitializeStates(out StateMachine.BaseState default_state)
    {
      ...
      this.balloonStand.ToggleAnims("anim_interacts_balloon_artist_kanim").Enter((StateMachine<BalloonArtistChore.States, BalloonArtistChore.StatesInstance, BalloonArtistChore, object>.State.Callback) (smi => smi.SpawnBalloonStand())).Enter((StateMachine<BalloonArtistChore.States, BalloonArtistChore.StatesInstance, BalloonArtistChore, object>.State.Callback) (smi => this.balloonArtist.GetSMI<BalloonArtist.Instance>(smi).Internal_InitBalloons())).Exit((StateMachine<BalloonArtistChore.States, BalloonArtistChore.StatesInstance, BalloonArtistChore, object>.State.Callback) (smi => smi.DestroyBalloonStand())).DefaultState(this.balloonStand.idle);
    ...
    GameStateMachine<BalloonArtistChore.States, BalloonArtistChore.StatesInstance, BalloonArtistChore, object>.GameInstance
  {
    ...
    public bool IsSameRoom()
    {
      ...
      return cavityForCell1 != null && cavityForCell2 != null && cavityForCell1.handle == cavityForCell2.handle;
    }
    ...
    public void SpawnBalloonStand()
    {
      ...
      this.balloonStand = Util.KInstantiate(Assets.GetPrefab((Tag) "BalloonStand"), pos, Quaternion.identity);
      this.balloonStand.SetActive(true);
      this.balloonStand.GetComponent<GetBalloonWorkable>().SetBalloonArtist(this.smi);
    }

    public void DestroyBalloonStand() => this.balloonStand.DeleteObject();
