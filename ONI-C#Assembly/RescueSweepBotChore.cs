...
public class RescueSweepBotChore : Chore<RescueSweepBotChore.StatesInstance>
{
  ...
  public override void Begin(Chore.Precondition.Context context)
  {
    ...
    this.smi.sm.deliverTarget.Set(this.gameObject.GetSMI<SweepBotTrappedStates.Instance>().sm.GetSweepLocker(this.gameObject.GetSMI<SweepBotTrappedStates.Instance>()).gameObject, this.smi, false);
    base.Begin(context);
  }
  ...
  public class StatesInstance(RescueSweepBotChore master) : 
    GameStateMachine<RescueSweepBotChore.States, RescueSweepBotChore.StatesInstance, RescueSweepBotChore, object>.GameInstance(master)
  {
  }
