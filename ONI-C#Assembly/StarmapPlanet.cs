  ...
  public void ShowAsCurrentRocketDestination(bool show)
  {
    foreach (StarmapPlanetVisualizer visualizer in this.visualizers)
    {
      ...
      if (rectTransform.childCount > 0)
        rectTransform.GetChild(rectTransform.childCount - 1).GetComponent<HierarchyReferences>().GetReference<Image>("fg").color = show ? new Color(0.117647059f, 0.8627451f, 0.3137255f) : Color.white;
    }
  }
