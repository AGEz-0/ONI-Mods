    ...
    else
    {
      ...
      else
      {
        ...
        if (!(bool) (Object) componentInChildren)
          return;
        this.SetPortrait(Sprite.Create((Texture2D) componentInChildren.material.mainTexture, new UnityEngine.Rect(0.0f, 0.0f, (float) componentInChildren.material.mainTexture.width, (float) componentInChildren.material.mainTexture.height), new Vector2(0.5f, 0.5f)));
      }
    }
  }
