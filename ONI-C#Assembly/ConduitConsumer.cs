...
public class ConduitConsumer : KMonoBehaviour, IConduitConsumer
{
  ...
  public bool IsConnected
  {
    get
    {
      return (UnityEngine.Object) Grid.Objects[this.utilityCell, this.conduitType == ConduitType.Gas ? 12 : 16 /*0x10*/] != (UnityEngine.Object) null && (UnityEngine.Object) this.m_buildingComplete != (UnityEngine.Object) null;
    }
  }
  ...
  protected virtual int GetInputCell(ConduitType inputConduitType)
  {
    ...
    ISecondaryInput[] components = this.GetComponents<ISecondaryInput>();
