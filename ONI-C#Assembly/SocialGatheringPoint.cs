...
public class SocialGatheringPoint : StateMachineComponent<SocialGatheringPoint.StatesInstance>
{
  ...
  protected override void OnSpawn()
  {
    ...
    this.smi.StartSM();
    Components.SocialGatheringPoints.Add((int) Grid.WorldIdx[Grid.PosToCell((KMonoBehaviour) this)], this);
  }
  ...
  protected override void OnCleanUp()
  {
    ...
    Components.SocialGatheringPoints.Remove((int) Grid.WorldIdx[Grid.PosToCell((KMonoBehaviour) this)], this);
    base.OnCleanUp();
  }
  ...
  public class StatesInstance(SocialGatheringPoint smi) : 
    GameStateMachine<SocialGatheringPoint.States, SocialGatheringPoint.StatesInstance, SocialGatheringPoint, object>.GameInstance(smi)
  {
  }
}
