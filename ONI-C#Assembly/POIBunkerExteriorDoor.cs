...
public class POIBunkerExteriorDoor : IBuildingConfig
{
  ...
  {
    BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef(nameof (POIBunkerExteriorDoor), 1, 2, "door_poi_kanim", 30, 60f, BUILDINGS.CONSTRUCTION_MASS_KG.TIER3, MATERIALS.ALL_METALS, 1600f, BuildLocationRule.Anywhere, BUILDINGS.DECOR.PENALTY.TIER2, NOISE_POLLUTION.NONE);
