...
public class CrewJobsScreen : CrewListScreen<CrewJobsEntry>
{
  ...
  protected override void SpawnEntries()
  {
    ...
    {
      CrewJobsEntry component = Util.KInstantiateUI(this.Prefab_CrewEntry, this.EntriesPanelTransform.gameObject).GetComponent<CrewJobsEntry>();
  ...
  private void Refresh()
  {
    ...
    float num = 31f;
    this.GetComponent<LayoutElement>().minWidth = this.screenWidth + num;
    this.dirty = false;
  }
