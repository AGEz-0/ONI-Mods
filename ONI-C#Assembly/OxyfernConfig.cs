...
public class OxyfernConfig : IEntityConfig
{
  ...
  public GameObject CreatePrefab()
  {
    ...
    {
      new ElementConverter.ConsumedElement(SimHashes.CarbonDioxide.ToString().ToTag(), 0.000625000044f)
    };
    ...
    EntityTemplates.CreateAndRegisterPreviewForPlant(EntityTemplates.CreateAndRegisterSeedForPlant(plant, dlcRestrictions, SeedProducer.ProductionType.Hidden, "OxyfernSeed", name2, desc2, anim2, additionalTags: additionalTags, replantGroundTag: replantGroundTag, sortOrder: 20, domesticatedDescription: domesticatedDescription, width: 0.3f, height: 0.3f), "Oxyfern_preview", Assets.GetAnim((HashedString) "oxy_fern_kanim"), "place", 1, 2);
