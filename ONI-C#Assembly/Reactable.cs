...
public abstract class Reactable
{
  ...
  public bool IsReacting => (UnityEngine.Object) this.reactor != (UnityEngine.Object) null;
    ...
    ObjectLayer overrideLayer = ObjectLayer.NumLayers)
  {
    ...
    this.initialDelay = (double) max_initial_delay > 0.0 ? UnityEngine.Random.Range(0.0f, max_initial_delay) : 0.0f;
  ...
  public bool CanBegin(GameObject reactor, Navigator.ActiveTransition transition)
  {
    ...
    Chore currentChore = (UnityEngine.Object) component != (UnityEngine.Object) null ? component.choreDriver.GetCurrentChore() : (Chore) null;
  ...
  {
    return (double) GameClock.Instance.GetTime() - (double) this.creationTime > (double) this.lifeSpan;
  }
  ...
  private void UpdateLocation()
  {
    ...
    this.partitionerEntry = GameScenePartitioner.Instance.Add(nameof (Reactable), (object) this, new Extents(Grid.PosToXY(this.gameObject.transform.GetPosition()).x - this.rangeWidth / 2, Grid.PosToXY(this.gameObject.transform.GetPosition()).y - this.rangeHeight / 2, this.rangeWidth, this.rangeHeight), GameScenePartitioner.Instance.objectLayers[(int) this.reactionLayer], (Action<object>) null);
  }
