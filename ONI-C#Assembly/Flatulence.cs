...
public class Flatulence : StateMachineComponent<Flatulence.StatesInstance>
{
  ...
  private void Emit(object data)
  {
    ...
    Vector3 vector3 = go.transform.GetPosition() with
    {
      z = 0.0f
    };
    float volume = 1f;
  ...
  public class StatesInstance(Flatulence master) : 
    GameStateMachine<Flatulence.States, Flatulence.StatesInstance, Flatulence, object>.GameInstance(master)
  {
  }
