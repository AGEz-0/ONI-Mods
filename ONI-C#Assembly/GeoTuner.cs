  ...
  GameStateMachine<GeoTuner, GeoTuner.Instance, IStateMachineTarget, GeoTuner.Def>
{
  ...
  private static void TriggerSoundsForGeyserChange(GeoTuner.Instance smi)
  {
    ...
    switch (assignedGeyser.configuration.geyserType.shape)
    {
      case GeyserConfigurator.GeyserShape.Gas:
        instance = SoundEvent.BeginOneShot(GeoTuner.gasGeyserTuningSoundPath, smi.transform.GetPosition());
        break;
      case GeyserConfigurator.GeyserShape.Liquid:
        instance = SoundEvent.BeginOneShot(GeoTuner.liquidGeyserTuningSoundPath, smi.transform.GetPosition());
        break;
      case GeyserConfigurator.GeyserShape.Molten:
        instance = SoundEvent.BeginOneShot(GeoTuner.metalGeyserTuningSoundPath, smi.transform.GetPosition());
        break;
    }
  ...
  private static void RefreshStorageRequirements(GeoTuner.Instance smi)
  {
    ...
    if ((UnityEngine.Object) assignedGeyser == (UnityEngine.Object) null)
    {
      ...
      smi.manualDelivery.RequestedItemTag = (Tag) (string) null;
  ...
  private static void DropStorage(GeoTuner.Instance smi) => smi.storage.DropAll();
    ...
    if ((UnityEngine.Object) assignedGeyser != (UnityEngine.Object) null)
    {
      ...
      else
      {
        ...
        if ((double) amount <= 0.0)
          return;
        smi.storage.DropSome(tag, amount);
      }
    }
    else
      smi.storage.DropAll();
  ...
  {
    Geyser assignedGeyser = smi.GetAssignedGeyser();
    return (UnityEngine.Object) assignedGeyser != (UnityEngine.Object) null && assignedGeyser.smi.GetCurrentState() != null && assignedGeyser.smi.GetCurrentState().parent != assignedGeyser.smi.sm.erupt;
  }
  ...
  {
    smi.animController.Play((HashedString) "broadcasting", KAnim.PlayMode.Loop);
  }

  public static void StopPlayingBroadcastingAnimation(GeoTuner.Instance smi)
  {
    smi.animController.Play((HashedString) "broadcasting");
  }
  ...
  {
    return (Chore) new WorkChore<GeoTunerWorkable>(Db.Get().ChoreTypes.Research, (IStateMachineTarget) smi.workable);
  }
  ...
  {
    return GeoTuner.IsInLabRoom(smi) && (double) smi.storage.MassStored() == (double) smi.storage.capacityKg;
  }
    ...
    GameStateMachine<GeoTuner, GeoTuner.Instance, IStateMachineTarget, GeoTuner.Def>.GameInstance
  {
    ...
    public Instance(IStateMachineTarget master, GeoTuner.Def def)
      : base(master, def)
    {
      this.originID = $"{UI.StripLinkFormatting(nameof (GeoTuner))} [{this.gameObject.GetInstanceID().ToString()}]";
    ...
    public override void StartSM()
    {
      ...
      this.gameObject.Subscribe(-905833192, new System.Action<object>(this.OnCopySettings));
    }

    public Geyser GetFutureGeyser()
    {
      return this.smi.sm.FutureGeyser.IsNull(this) ? (Geyser) null : this.sm.FutureGeyser.Get(this).GetComponent<Geyser>();
    }

    public Geyser GetAssignedGeyser()
    {
      return this.smi.sm.AssignedGeyser.IsNull(this) ? (Geyser) null : this.sm.AssignedGeyser.Get(this).GetComponent<Geyser>();
    }

    public void AssignFutureGeyser(Geyser newFutureGeyser)
    {
      int num = (UnityEngine.Object) newFutureGeyser != (UnityEngine.Object) this.GetFutureGeyser() ? 1 : 0;
      bool flag = (UnityEngine.Object) this.GetAssignedGeyser() != (UnityEngine.Object) newFutureGeyser;
    ...
    {
      this.gameObject.GetComponent<KSelectable>().AddStatusItem(Db.Get().BuildingStatusItems.PendingSwitchToggle);
    }

    private void HideSwitchingGeyserStatusItem(Chore chore)
    {
      this.gameObject.GetComponent<KSelectable>().RemoveStatusItem(Db.Get().BuildingStatusItems.PendingSwitchToggle);
    }
    ...
    private void OnSwitchGeyserChoreCompleted(Chore chore)
    {
      ...
      bool flag = (UnityEngine.Object) this.GetAssignedGeyser() != (UnityEngine.Object) futureGeyser;
    ...
    {
      Geyser assignedGeyser = this.GetAssignedGeyser();
      if ((UnityEngine.Object) assignedGeyser != (UnityEngine.Object) null && (UnityEngine.Object) assignedGeyser != (UnityEngine.Object) geyser)
      {
      ...
      this.RefreshModification();
      if (!((UnityEngine.Object) geyser1 != (UnityEngine.Object) geyser))
        return;
      ...
      if ((UnityEngine.Object) geyser1 != (UnityEngine.Object) null)
    ...
    {
      this.switchGeyserMeter.meterController.Play((HashedString) this.GetAnimationSymbol().ToString());
    }
    ...
    public void RefreshLogicOutput()
    {
      ...
      bool flag1 = (UnityEngine.Object) assignedGeyser != (UnityEngine.Object) null && this.GetCurrentState() != this.smi.sm.operational.noGeyserSelected;
      bool flag2 = (UnityEngine.Object) assignedGeyser != (UnityEngine.Object) null && assignedGeyser.smi.GetCurrentState() != null && (assignedGeyser.smi.GetCurrentState() == assignedGeyser.smi.sm.erupt || assignedGeyser.smi.GetCurrentState().parent == assignedGeyser.smi.sm.erupt);
      int num2 = flag1 ? 1 : 0;
      bool is_visible = (num1 & num2 & (flag2 ? 1 : 0)) != 0;
      this.logicPorts.SendSignal((HashedString) this.def.OUTPUT_LOGIC_PORT_ID, is_visible ? 1 : 0);
      this.switchGeyserMeter.meterController.SetSymbolVisiblity((KAnimHashedString) "light_bloom", is_visible);
    }
    ...
    public void OnCopySettings(object data)
    {
      ...
      if (smi == null || !((UnityEngine.Object) smi.GetFutureGeyser() != (UnityEngine.Object) this.GetFutureGeyser()))
        return;
      Geyser futureGeyser = smi.GetFutureGeyser();
      if (!((UnityEngine.Object) futureGeyser != (UnityEngine.Object) null) || futureGeyser.GetAmountOfGeotunersPointingOrWillPointAtThisGeyser() >= 5)
        return;
