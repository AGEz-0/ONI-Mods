...
{
  private static PermitItems.ItemInfo[] ItemInfos = new PermitItems.ItemInfo[536]
  {
    ...
    new PermitItems.ItemInfo("pants_basic_blue_middle", 16U /*0x10*/, "BottomBasicAqua"),
    ...
    new PermitItems.ItemInfo("shoes_basic_red", 31U /*0x1F*/, "ShoesBasicRed"),
    new PermitItems.ItemInfo("shoes_basic_orange", 32U /*0x20*/, "ShoesBasicOrange"),
    ...
    new PermitItems.ItemInfo("elegantbed_puft", 48U /*0x30*/, "LuxuryBed_puft"),
    ...
    new PermitItems.ItemInfo("walls_sun", 63U /*0x3F*/, "ExteriorWall_sun"),
    new PermitItems.ItemInfo("walls_polka", 64U /*0x40*/, "ExteriorWall_polka"),
    ...
    new PermitItems.ItemInfo("shorts_basic_pink_flamingo", 96U /*0x60*/, "ShortsBasicPinkFlamingo"),
    ...
    new PermitItems.ItemInfo("walls_diagonal_red_deep_white", 112U /*0x70*/, "ExteriorWall_diagonal_red_deep_white"),
    ...
    new PermitItems.ItemInfo("bed_canopy", (uint) sbyte.MaxValue, "Bed_canopy"),
    new PermitItems.ItemInfo("bed_rowan_tropical", 128U /*0x80*/, "Bed_rowan_tropical"),
    ...
    new PermitItems.ItemInfo("balloon_babypokeshell_egg_kanim", 144U /*0x90*/, "BalloonBabyPokeshellEgg"),
    ...
    new PermitItems.ItemInfo("gloves_cuffless_lime", 160U /*0xA0*/, "GlovesCufflessLime"),
    ...
    new PermitItems.ItemInfo("walls_blueberries", 176U /*0xB0*/, "ExteriorWall_blueberries"),
    ...
    new PermitItems.ItemInfo("atmo_suit_puft", 192U /*0xC0*/, "AtmoSuitPuft"),
    ...
    new PermitItems.ItemInfo("pants_circuit_green", 208U /*0xD0*/, "PantsCircuitGreen"),
    ...
    new PermitItems.ItemInfo("atmo_belt_sparkle_green", 224U /*0xE0*/, "AtmoBeltSparkleGreen"),
    ...
    new PermitItems.ItemInfo("painting_wide_art_j", 240U /*0xF0*/, "CanvasWide_Good8"),
    ...
    new PermitItems.ItemInfo("bottom_briefs_stakeholder", (uint) byte.MaxValue, "BottomBriefsStakeholder"),
    new PermitItems.ItemInfo("bottom_briefs_admin", 256U /*0x0100*/, "BottomBriefsAdmin"),
    ...
    new PermitItems.ItemInfo("toiletflush_purple_brainfat", 511U /*0x01FF*/, "FlushToilet_purple_brainfat"),
    new PermitItems.ItemInfo("toiletflush_yellow_tartar", 512U /*0x0200*/, "FlushToilet_yellow_tartar"),
  ...
  private static Dictionary<string, string> ItemToPermit = ((IEnumerable<PermitItems.ItemInfo>) PermitItems.ItemInfos).ToDictionary<PermitItems.ItemInfo, string, string>((Func<PermitItems.ItemInfo, string>) (x => x.ItemType), (Func<PermitItems.ItemInfo, string>) (x => x.PermitId));
  private static PermitItems.BoxInfo[] BoxInfos = new PermitItems.BoxInfo[8]
  {
    new PermitItems.BoxInfo("MYSTERYBOX_u44_box_a", "Shipment X", "Unaddressed packages have been discovered near the Printing Pod. They bear Gravitas logos, and trace amounts of Neutronium have been detected.", 80U /*0x50*/, "ONI_giftbox_u44_box_a", true),
    ...
    new PermitItems.BoxInfo("MYSTERYBOX_u47_klei_fest", (string) EQUIPMENT.PREFABS.ATMO_SUIT_SET.PUFT.NAME, (string) EQUIPMENT.PREFABS.ATMO_SUIT_SET.PUFT.DESC, 196U, "ONI_box_puft_atmo_set", false),
    new PermitItems.BoxInfo("MYSTERYBOX_u50_winter_holiday", (string) EQUIPMENT.PREFABS.HOLIDAY_2023_CRATE.NAME, (string) EQUIPMENT.PREFABS.HOLIDAY_2023_CRATE.DESC, 414U, "Holiday_2023_gift_box", false)
  };
  ...
  private static Dictionary<string, PermitItems.BoxInfo> BoxMappings = ((IEnumerable<PermitItems.BoxInfo>) PermitItems.BoxInfos).ToDictionary<PermitItems.BoxInfo, string>((Func<PermitItems.BoxInfo, string>) (x => x.ItemType));
  private static HashSet<string> BoxSet = new HashSet<string>(((IEnumerable<PermitItems.BoxInfo>) PermitItems.BoxInfos).Select<PermitItems.BoxInfo, string>((Func<PermitItems.BoxInfo, string>) (x => x.ItemType)));
  ...
  public static int GetOwnedCount(PermitResource permit)
  {
    ...
    if (PermitItems.Mappings.TryGetValue(permit.Id, out itemInfo))
      ownedCount = KleiItems.GetOwnedItemCount(itemInfo.ItemType);
    return ownedCount;
  }

  public static bool TryGetBoxInfo(
  ...
  public static void QueueRequestOpenOrUnboxItem(
    KleiItems.ItemData item,
  ...
  public static string GetServerTypeFromPermit(PermitResource resource)
  {
    ...
    Debug.LogError((object) ("No matching server ItemType for requested PermitResource " + resource.Id));
    return (string) null;
  }

  private struct ItemInfo(string itemType, uint typeId, string permitId)
  {
    public string ItemType = itemType;
    public uint TypeId = typeId;
    public string PermitId = permitId;
  }
    ...
    bool account_reward)
  {
    ...
    public uint TypeId = id;
    public string IconName = icon;
    public bool AccountReward = account_reward;
  }
}
