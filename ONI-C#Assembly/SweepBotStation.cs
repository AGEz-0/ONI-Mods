...
public class SweepBotStation : KMonoBehaviour
{
  ...
  private static readonly Operational.Flag dockedRobot = new Operational.Flag(nameof (dockedRobot), Operational.Flag.Type.Functional);
  ...
  {
    base.OnPrefabInit();
    this.GetComponent<Operational>().SetFlag(SweepBotStation.dockedRobot, false);
  }
  ...
  private void RequestNewSweepBot(object data = null)
  {
    if ((UnityEngine.Object) this.botMaterialStorage.FindFirstWithMass(GameTags.RefinedMetal, SweepBotConfig.MASS) == (UnityEngine.Object) null)
    {
      ...
      fetchList2.Add(this.GetComponent<PrimaryElement>().Element.tag, amount: SweepBotConfig.MASS);
  ...
  private void MakeNewSweepBot(object data = null)
  {
    ...
    this.botMaterialStorage.ConsumeAndGetDisease(sweepBotMaterial.CreateTag(), SweepBotConfig.MASS, out float _, out disease, out temperature);
    this.UpdateMeter();
  ...
  {
    this.GetComponent<Operational>().SetFlag(SweepBotStation.dockedRobot, docked);
  }
  ...
  private void OnOperationalChanged(object data)
  {
    ...
    component.SetActive(!component.Flags.ContainsValue(false));
    if (this.sweepBot != null && !((UnityEngine.Object) this.sweepBot.Get() == (UnityEngine.Object) null))
      return;
    this.RequestNewSweepBot();
  }
