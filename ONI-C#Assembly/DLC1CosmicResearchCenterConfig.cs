...
// Type: DLC1CosmicResearchCenterConfig
...
public class DLC1CosmicResearchCenterConfig : IBuildingConfig
{
  ...
  public override BuildingDef CreateBuildingDef()
  {
    ...
    BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef("DLC1CosmicResearchCenter", 4, 4, "research_space_kanim", 30, 30f, tieR4, allMetals, 1600f, BuildLocationRule.OnFloor, none, noise);
  ...
  public override void ConfigureBuildingTemplate(GameObject go, Tag prefab_tag)
  {
    ...
    {
      new ElementConverter.ConsumedElement(DLC1CosmicResearchCenterConfig.INPUT_MATERIAL, 0.02f)
    };
