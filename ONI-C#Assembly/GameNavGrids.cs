...
public class GameNavGrids
{
  ...
  public GameNavGrids(Pathfinding pathfinding)
  {
    ...
    this.SwimmerGrid2x2 = this.CreateLargeSwimmerNavigation(pathfinding, nameof (SwimmerGrid2x2), new CellOffset[2]
    {
      new CellOffset(0, 0),
      new CellOffset(0, 1)
    });
    ...
    bool use_x_offset = false)
  {
    NavGrid.Transition[] transitions = this.MirrorTransitions(new NavGrid.Transition[5]
    {
      ...
      new NavGrid.Transition(NavType.Swim, NavType.Swim, 1, 1, NavAxis.NA, true, true, true, 2, "swim_swim_1_0", new CellOffset[2]
      {
        new CellOffset(1, 0),
        new CellOffset(0, 1)
      }, new CellOffset[0], new NavOffset[0], new NavOffset[0], useOffsetX: (use_x_offset ? 1 : 0) != 0),
      new NavGrid.Transition(NavType.Swim, NavType.Swim, 1, -1, NavAxis.NA, true, true, true, 2, "swim_swim_1_0", new CellOffset[2]
      {
        new CellOffset(1, 0),
        new CellOffset(0, -1)
  ...
  private NavGrid CreateLargeSwimmerNavigation(
    ...
    CellOffset[] bounding_offsets)
  {
    NavGrid.Transition[] transitions = this.MirrorTransitions(new NavGrid.Transition[8]
    {
      ...
      new NavGrid.Transition(NavType.Swim, NavType.Swim, -1, 0, NavAxis.NA, true, true, true, 2, "swim_swim_1_0", new CellOffset[0], new CellOffset[0], new NavOffset[0], new NavOffset[0]),
      new NavGrid.Transition(NavType.Swim, NavType.Swim, 0, 1, NavAxis.NA, true, true, true, 3, "swim_swim_1_0", new CellOffset[0], new CellOffset[0], new NavOffset[2]
      {
      ...
      new NavGrid.Transition(NavType.Swim, NavType.Swim, 1, 1, NavAxis.NA, true, true, true, 2, "swim_swim_1_0", new CellOffset[2]
      {
        new CellOffset(1, 0),
        new CellOffset(0, 1)
      }, new CellOffset[0], new NavOffset[3]
      {
      ...
      new NavGrid.Transition(NavType.Swim, NavType.Swim, -1, -1, NavAxis.NA, true, true, true, 2, "swim_swim_1_0", new CellOffset[2]
      {
        new CellOffset(-1, 0),
        new CellOffset(0, -1)
      }, new CellOffset[0], new NavOffset[2]
      {
        new NavOffset(NavType.Swim, 0, -1),
        new NavOffset(NavType.Swim, 1, -1)
      }, new NavOffset[0])
