...
public class CrabWoodConfig : IEntityConfig
{
  ...
  public static GameObject CreateCrabWood(
    ...
    float deathDropCount = 5f)
  {
    GameObject wildCreature = EntityTemplates.ExtendEntityToWildCreature(BaseCrabConfig.BaseCrab(id, name, desc, anim_file, "CrabWoodBaseTrait", is_baby, CrabWoodConfig.animPrefix, deathDropID, deathDropCount), CrabTuning.PEN_SIZE_PER_CREATURE);
  ...
  {
    GameObject fertileCreature = EntityTemplates.ExtendEntityToFertileCreature(CrabWoodConfig.CreateCrabWood("CrabWood", (string) STRINGS.CREATURES.SPECIES.CRAB.VARIANT_WOOD.NAME, (string) STRINGS.CREATURES.SPECIES.CRAB.VARIANT_WOOD.DESC, "pincher_kanim", false, deathDropCount: 500f), this as IHasDlcRestrictions, "CrabWoodEgg", (string) STRINGS.CREATURES.SPECIES.CRAB.VARIANT_WOOD.EGG_NAME, (string) STRINGS.CREATURES.SPECIES.CRAB.VARIANT_WOOD.DESC, "egg_pincher_kanim", CrabTuning.EGG_MASS, "CrabWoodBaby", 60.0000038f, 20f, CrabTuning.EGG_CHANCES_WOOD, CrabWoodConfig.EGG_SORT_ORDER);
