  ...
  IGameObjectEffectDescriptor
{
  ...
  protected override void OnSpawn()
  {
    ...
    this.particleMeter = new MeterController((KAnimControllerBase) this.GetComponent<KBatchedAnimController>(), "meter_target", "meter", this.particleMeterOffset, Grid.SceneLayer.NoLayer, new string[1]
    {
      "meter_target"
    });
    ...
    GameStateMachine<NuclearResearchCenter.States, NuclearResearchCenter.StatesInstance, NuclearResearchCenter>
  {
    ...
    public override void InitializeStates(out StateMachine.BaseState default_state)
    {
      ...
      this.ready.idle.WorkableStartTransition((Func<NuclearResearchCenter.StatesInstance, Workable>) (smi => (Workable) smi.master.GetComponent<NuclearResearchCenterWorkable>()), this.ready.working);
      this.ready.working.Enter("SetActive(true)", (StateMachine<NuclearResearchCenter.States, NuclearResearchCenter.StatesInstance, NuclearResearchCenter, object>.State.Callback) (smi => smi.master.operational.SetActive(true))).Exit("SetActive(false)", (StateMachine<NuclearResearchCenter.States, NuclearResearchCenter.StatesInstance, NuclearResearchCenter, object>.State.Callback) (smi => smi.master.operational.SetActive(false))).WorkableStopTransition((Func<NuclearResearchCenter.StatesInstance, Workable>) (smi => (Workable) smi.master.GetComponent<NuclearResearchCenterWorkable>()), this.ready.idle).WorkableCompleteTransition((Func<NuclearResearchCenter.StatesInstance, Workable>) (smi => (Workable) smi.master.GetComponent<NuclearResearchCenterWorkable>()), this.ready.idle);
    }
    ...
    {
      return (double) smi.GetComponent<HighEnergyParticleStorage>().Particles > (double) smi.master.materialPerPoint;
    }
  ...
  public class StatesInstance(NuclearResearchCenter master) : 
    GameStateMachine<NuclearResearchCenter.States, NuclearResearchCenter.StatesInstance, NuclearResearchCenter, object>.GameInstance(master)
  {
    private WorkChore<NuclearResearchCenterWorkable> chore;

    public void CreateChore()
    {
      Workable component = (Workable) this.smi.master.GetComponent<NuclearResearchCenterWorkable>();
