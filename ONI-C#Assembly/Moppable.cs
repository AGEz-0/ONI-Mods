...
public class Moppable : Workable, ISim1000ms, ISim200ms
{
  ...
  {
    Game.Instance.userMenu.AddButton(this.gameObject, new KIconButtonMenu.ButtonInfo("icon_cancel", (string) UI.USERMENUACTIONS.CANCELMOP.NAME, new System.Action(this.OnCancel), tooltipText: (string) UI.USERMENUACTIONS.CANCELMOP.TOOLTIP));
  }
