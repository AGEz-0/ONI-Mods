...
public class LightMonitor : GameStateMachine<LightMonitor, LightMonitor.Instance>
{
  ...
  public override void InitializeStates(out StateMachine.BaseState default_state)
  {
    ...
    double num1;
    this.unburnt.safe.DefaultState(this.unburnt.safe.unlit).Update((System.Action<LightMonitor.Instance, float>) ((smi, dt) => num1 = (double) smi.sm.burnResistance.DeltaClamp(dt * 0.25f, 0.0f, DUPLICANTSTATS.STANDARD.Light.SUNBURN_DELAY_TIME, smi)));
    ...
    this.unburnt.safe.normal_light.ParamTransition<float>((StateMachine<LightMonitor, LightMonitor.Instance, IStateMachineTarget, object>.Parameter<float>) this.lightLevel, this.unburnt.safe.unlit, GameStateMachine<LightMonitor, LightMonitor.Instance, IStateMachineTarget, object>.IsLTEZero).ParamTransition<float>((StateMachine<LightMonitor, LightMonitor.Instance, IStateMachineTarget, object>.Parameter<float>) this.lightLevel, this.unburnt.safe.sunlight, (StateMachine<LightMonitor, LightMonitor.Instance, IStateMachineTarget, object>.Parameter<float>.Callback) ((smi, p) => (double) p >= (double) DUPLICANTSTATS.STANDARD.Light.LUX_PLEASANT_LIGHT));
    this.unburnt.safe.sunlight.ParamTransition<float>((StateMachine<LightMonitor, LightMonitor.Instance, IStateMachineTarget, object>.Parameter<float>) this.lightLevel, this.unburnt.safe.normal_light, (StateMachine<LightMonitor, LightMonitor.Instance, IStateMachineTarget, object>.Parameter<float>.Callback) ((smi, p) => (double) p < (double) DUPLICANTSTATS.STANDARD.Light.LUX_PLEASANT_LIGHT)).ParamTransition<float>((StateMachine<LightMonitor, LightMonitor.Instance, IStateMachineTarget, object>.Parameter<float>) this.lightLevel, this.unburnt.burning, (StateMachine<LightMonitor, LightMonitor.Instance, IStateMachineTarget, object>.Parameter<float>.Callback) ((smi, p) => (double) p >= (double) DUPLICANTSTATS.STANDARD.Light.LUX_SUNBURN)).ToggleEffect("Sunlight_Pleasant");
    double num2;
    this.unburnt.burning.ParamTransition<float>((StateMachine<LightMonitor, LightMonitor.Instance, IStateMachineTarget, object>.Parameter<float>) this.lightLevel, this.unburnt.safe.sunlight, (StateMachine<LightMonitor, LightMonitor.Instance, IStateMachineTarget, object>.Parameter<float>.Callback) ((smi, p) => (double) p < (double) DUPLICANTSTATS.STANDARD.Light.LUX_SUNBURN)).Update((System.Action<LightMonitor.Instance, float>) ((smi, dt) => num2 = (double) smi.sm.burnResistance.DeltaClamp(-dt, 0.0f, DUPLICANTSTATS.STANDARD.Light.SUNBURN_DELAY_TIME, smi))).ToggleEffect("Sunlight_Burning");
