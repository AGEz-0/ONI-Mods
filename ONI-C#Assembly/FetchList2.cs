...
public class FetchList2 : IFetchList
{
    ...
    Operational.State operationalRequirementDEPRECATED = Operational.State.None)
  {
    ...
    this.FetchOrders.Add(new FetchOrder2(this.choreType, tags, FetchChore.MatchCriteria.MatchID, requiredTag, forbidden_tags, this.Destination, amount, operationalRequirementDEPRECATED, this.PriorityMod));
  }
      ...
      if ((UnityEngine.Object) gameObject != (UnityEngine.Object) null)
      {
        ...
        if ((UnityEngine.Object) component != (UnityEngine.Object) null)
        {
          ...
          if (remainingMinimum.ContainsKey(kprefabId.PrefabTag))
            remainingMinimum[kprefabId.PrefabTag] = Math.Max(remainingMinimum[kprefabId.PrefabTag] - component.FetchTotalAmount, 0.0f);
          foreach (Tag tag in kprefabId.Tags)
          {
            if (remainingMinimum.ContainsKey(tag))
              remainingMinimum[tag] = Math.Max(remainingMinimum[tag] - component.FetchTotalAmount, 0.0f);
          }
        }
      }
    }
