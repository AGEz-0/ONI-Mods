...
public class DevLightGeneratorConfig : IBuildingConfig
{
  ...
  public override BuildingDef CreateBuildingDef()
  {
    ...
    BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef("DevLightGenerator", 1, 1, "dev_generator_kanim", 100, 3f, tieR0, allMetals, 2400f, BuildLocationRule.Anywhere, tieR2, noise);
  ...
  public override void DoPostConfigureComplete(GameObject go)
  {
    ...
    devLightGenerator.Offset = new Vector2(0.0f, 0.5f);
