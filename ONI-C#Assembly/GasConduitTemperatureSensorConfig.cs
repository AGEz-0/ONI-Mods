...
public class GasConduitTemperatureSensorConfig : ConduitSensorConfig
{
  ...
  {
    BuildingDef buildingDef = this.CreateBuildingDef(GasConduitTemperatureSensorConfig.ID, "gas_temperature_sensor_kanim", TUNING.BUILDINGS.CONSTRUCTION_MASS_KG.TIER0, TUNING.MATERIALS.REFINED_METALS, new List<LogicPorts.Port>()
    {
