...
public abstract class OverlayModes
{
  ...
  public abstract class ConduitMode : OverlayModes.Mode
  {
    ...
    public override void Disable()
    {
      foreach (SaveLoadRoot layerTarget in this.layerTargets)
      {
        ...
        Vector3 position = layerTarget.transform.GetPosition() with
        {
          z = defaultDepth
        };
    ...
    public override void Update()
    {
      ...
      OverlayModes.Mode.RemoveOffscreenTargets<SaveLoadRoot>((ICollection<SaveLoadRoot>) this.layerTargets, min, max, (Action<SaveLoadRoot>) (root =>
      {
        ...
        Vector3 position = root.transform.GetPosition() with
        {
          z = defaultDepth
        };
  ...
  public class Crop : OverlayModes.BasePlantMode
  {
    ...
    public GameObject GetFreeCropUI()
    {
      ...
      {
        freeCropUi = Util.KInstantiateUI(this.harvestableNotificationPrefab.gameObject, this.uiRoot.transform.gameObject);
    ...
    private void AddCropUI(HarvestDesignatable harvestable)
    {
      ...
      Vector3 vector3 = Grid.CellToPos(Grid.PosToCell((KMonoBehaviour) harvestable), 0.5f, -1.25f, 0.0f) + (Vector3) harvestable.iconOffset;
      freeCropUi.GetComponent<RectTransform>().SetPosition(Vector3.up + vector3);
      this.updateCropInfo.Add(updateCropInfo);
    }

    private struct UpdateCropInfo(HarvestDesignatable harvestable, GameObject harvestableUI)
    {
      public HarvestDesignatable harvestable = harvestable;
      public GameObject harvestableUI = harvestableUI;
    }
  }
  ...
  public class Disease : OverlayModes.Mode
  {
    ...
    public override List<LegendEntry> GetCustomLegendData()
    {
      ...
      foreach (OverlayModes.Disease.DiseaseSortInfo diseaseSortInfo in diseaseSortInfoList)
        customLegendData.Add(new LegendEntry(diseaseSortInfo.disease.Name, diseaseSortInfo.disease.overlayLegendHovertext.ToString(), (Color) GlobalAssets.Instance.colorSet.GetColorByName(diseaseSortInfo.disease.overlayColourName)));
    ...
    public GameObject GetFreeDiseaseUI()
    {
      ...
      {
        freeDiseaseUi = Util.KInstantiateUI(this.diseaseOverlayPrefab, this.diseaseUIParent.transform.gameObject);
    ...
    private struct UpdateDiseaseInfo(AmountInstance amount_inst, DiseaseOverlayWidget ui)
    {
      public DiseaseOverlayWidget ui = ui;
      public AmountInstance valueSrc = amount_inst;
    }
  }
  ...
  public class Logic : OverlayModes.Mode
  {
    ...
    public override void Disable()
    {
      ...
      foreach (SaveLoadRoot gameObjTarget in this.gameObjTargets)
      {
        ...
        Vector3 position = gameObjTarget.transform.GetPosition() with
        {
          z = defaultDepth
        };
    ...
    public override void Update()
    {
      ...
      using (new KProfiler.Region("UpdateLogicOverlay"))
      {
            ...
            if (component1.PrefabTag == wire_id || component1.PrefabTag == bridge_id || component1.PrefabTag == ribbon_id || component1.PrefabTag == ribbon_bridge_id)
              this.AddTargetIfVisible<SaveLoadRoot>(instance, min, max, (ICollection<SaveLoadRoot>) this.gameObjTargets, this.conduitTargetLayer, (Action<SaveLoadRoot>) (root =>
              {
                ...
                if (!OverlayModes.Logic.HighlightItemIDs.Contains(component2.PrefabTag))
                  return;
                if (component2.PrefabTag == wire_id)
                  this.wireControllers.Add(root.GetComponent<KBatchedAnimController>());
                else if (component2.PrefabTag == ribbon_id)
                  this.ribbonControllers.Add(root.GetComponent<KBatchedAnimController>());
                else if (component2.PrefabTag == bridge_id)
                {
                  KBatchedAnimController component3 = root.GetComponent<KBatchedAnimController>();
                  int networkCell = root.GetComponent<LogicUtilityNetworkLink>().GetNetworkCell();
                ...
                {
                  if (!(component2.PrefabTag == ribbon_bridge_id))
                    return;
        ...
        {
          if (instance != null)
            this.AddTargetIfVisible<ILogicUIElement>(instance, min, max, (ICollection<ILogicUIElement>) this.ioTargets, this.objectTargetLayer, new Action<ILogicUIElement>(this.AddUI), (Func<KMonoBehaviour, bool>) (kcmp => (UnityEngine.Object) kcmp != (UnityEngine.Object) null && OverlayModes.Logic.HighlightItemIDs.Contains(kcmp.GetComponent<KPrefabID>().PrefabTag)));
        }
        this.connectedNetworks.Clear();
        float num1 = 1f;
        GameObject gameObject = (GameObject) null;
        ...
        Color32 logicOff = GlobalAssets.Instance.colorSet.logicOff with
        {
          a = logicOn.a = (byte) 0
        };
        ...
        foreach (OverlayModes.Logic.BridgeInfo bridgeController in this.ribbonBridgeControllers)
        {
          if (!((UnityEngine.Object) bridgeController.controller == (UnityEngine.Object) null))
          {
            ...
            bridgeController.controller.SetSymbolTint(OverlayModes.Logic.RIBBON_WIRE_1_SYMBOL_NAME, (Color) color32_5);
            bridgeController.controller.SetSymbolTint(OverlayModes.Logic.RIBBON_WIRE_2_SYMBOL_NAME, (Color) color32_6);
            bridgeController.controller.SetSymbolTint(OverlayModes.Logic.RIBBON_WIRE_3_SYMBOL_NAME, (Color) color32_7);
            bridgeController.controller.SetSymbolTint(OverlayModes.Logic.RIBBON_WIRE_4_SYMBOL_NAME, (Color) color32_8);
          }
        }
      }
      this.UpdateUI();
  ...
  public abstract class Mode
  {
      ...
      where T : KMonoBehaviour
    {
      ...
      foreach (T target in (IEnumerable<T>) targets)
      {
        ...
        {
          Vector2I xy = Grid.PosToXY(target.transform.GetPosition());
          if (!(vis_min <= xy) || !(xy <= vis_max) || target.gameObject.GetMyWorldId() != ClusterManager.Instance.activeWorldId)
          {
  ...
  public class Power : OverlayModes.Mode
  {
    ...
    public override void Update()
    {
        ...
        foreach (SaveLoadRoot layerTarget in this.layerTargets)
        {
          if (!((UnityEngine.Object) layerTarget == (UnityEngine.Object) null))
          {
            ...
            if (component1 != null)
            {
              ...
              float num3 = circuitManager.GetMaxSafeWattageForCircuit(num2) + TUNING.POWER.FLOAT_FUDGE_FACTOR;
              float neededWhenActive = circuitManager.GetWattsNeededWhenActive(num2);
              Color32 color32_1 = (double) wattsUsedByCircuit > 0.0 ? ((double) wattsUsedByCircuit <= (double) num3 ? ((double) neededWhenActive <= (double) num3 || (double) num3 <= 0.0 || (double) wattsUsedByCircuit / (double) num3 < 0.75 ? GlobalAssets.Instance.colorSet.powerCircuitSafe : GlobalAssets.Instance.colorSet.powerCircuitStraining) : GlobalAssets.Instance.colorSet.powerCircuitOverloading) : GlobalAssets.Instance.colorSet.powerCircuitUnpowered;
      ...
      try
      {
        ...
        {
          Vector2I xy = Grid.PosToXY(battery.transform.GetPosition());
          if (min <= xy && xy <= max && battery.GetMyWorldId() == ClusterManager.Instance.activeWorldId)
          {
            SaveLoadRoot component = battery.GetComponent<SaveLoadRoot>();
        ...
        {
          Vector2I xy = Grid.PosToXY(component3.transform.GetPosition());
          if (min <= xy && xy <= max && component3.GetMyWorldId() == ClusterManager.Instance.activeWorldId)
          {
            SaveLoadRoot component4 = component3.GetComponent<SaveLoadRoot>();
            if (!this.privateTargets.Contains(component4))
            {
              this.privateTargets.Add(component4);
              if ((UnityEngine.Object) component3.GetComponent<PowerTransformer>() == (UnityEngine.Object) null)
        ...
        {
          Vector2I xy = Grid.PosToXY(component5.transform.GetPosition());
          if (min <= xy && xy <= max && component5.GetMyWorldId() == ClusterManager.Instance.activeWorldId)
          {
            SaveLoadRoot component6 = component5.GetComponent<SaveLoadRoot>();
    ...
    private LocText GetFreePowerLabel()
    {
      ...
      {
        freePowerLabel = Util.KInstantiateUI<LocText>(this.powerLabelPrefab.gameObject, this.powerLabelParent.transform.gameObject);
    ...
    private void UpdatePowerLabels()
    {
      foreach (OverlayModes.Power.UpdatePowerInfo updatePowerInfo in this.updatePowerInfo)
      {
        ...
        if ((UnityEngine.Object) updatePowerInfo.item == (UnityEngine.Object) null || updatePowerInfo.item.gameObject.GetMyWorldId() != ClusterManager.Instance.activeWorldId)
        {
        ...
        else
        {
          ...
          if ((UnityEngine.Object) generator != (UnityEngine.Object) null && consumer == null)
          {
            ...
            BuildingEnabledButton component1 = kmonoBehaviour.GetComponent<BuildingEnabledButton>();
            Color color = (Color) (!((UnityEngine.Object) component1 != (UnityEngine.Object) null) || component1.IsEnabled ? GlobalAssets.Instance.colorSet.powerGenerator : GlobalAssets.Instance.colorSet.powerBuildingDisabled);
            ...
            if ((UnityEngine.Object) component2 != (UnityEngine.Object) null)
            {
              ...
              if ((UnityEngine.Object) powerOutputIcon != (UnityEngine.Object) null)
          ...
          if (consumer != null)
          {
            ...
            powerLabel.color = color;
            unitLabel.color = color;
            Image powerInputIcon = kmonoBehaviour.GetComponentInChildren<BuildingCellVisualizer>().GetPowerInputIcon();
            if ((UnityEngine.Object) powerInputIcon != (UnityEngine.Object) null)
              powerInputIcon.color = color;
          }
        }
      }
    ...
    private BatteryUI GetFreeBatteryUI()
    {
      ...
      if (this.freeBatteryUIIdx < this.batteryUIList.Count)
      {
        ...
        freeBatteryUi.gameObject.SetActive(true);
        ++this.freeBatteryUIIdx;
      }
      else
      {
        freeBatteryUi = Util.KInstantiateUI<BatteryUI>(this.batteryUIPrefab.gameObject, this.powerLabelParent.transform.gameObject);
    ...
    private struct UpdatePowerInfo(
      ...
      IEnergyConsumer c)
    {
      public KMonoBehaviour item = item;
      public LocText powerLabel = power_label;
      public LocText unitLabel = unit_label;
      public Generator generator = g;
      public IEnergyConsumer consumer = c;
    }

    private struct UpdateBatteryInfo(Battery battery, BatteryUI ui)
    {
      public Battery battery = battery;
      public BatteryUI ui = ui;
    }
  }
  ...
  public class Sound : OverlayModes.Mode
  {
    ...
    private OverlayModes.ColorHighlightCondition[] highlightConditions = new OverlayModes.ColorHighlightCondition[1]
    {
      new OverlayModes.ColorHighlightCondition((Func<KMonoBehaviour, Color>) (np =>
      {
        ...
        Color b = color;
        double t = (double) num;
        return Color.Lerp(black, b, (float) t);
  ...
  public class Suit : OverlayModes.Mode
  {
    ...
    private GameObject GetFreeUI()
    {
      ...
      {
        freeUi = Util.KInstantiateUI(this.overlayPrefab, this.uiParent.transform.gameObject);
  ...
  public class Temperature : OverlayModes.Mode
  {
    ...
    public List<LegendEntry> temperatureLegend = new List<LegendEntry>()
    {
      ...
      new LegendEntry((string) STRINGS.UI.OVERLAYS.TEMPERATURE.HEATSOURCES, (string) STRINGS.UI.OVERLAYS.TEMPERATURE.TOOLTIPS.HEATSOURCES, Color.white, sprite: Assets.GetSprite((HashedString) "heat_source")),
      new LegendEntry((string) STRINGS.UI.OVERLAYS.TEMPERATURE.HEATSINK, (string) STRINGS.UI.OVERLAYS.TEMPERATURE.TOOLTIPS.HEATSINK, Color.white, sprite: Assets.GetSprite((HashedString) "heat_sink"))
    };
    ...
    public override void OnFiltersChanged()
    {
      ...
      if (this.InFilter(ToolParameterMenu.FILTERLAYERS.RELATIVETEMPERATURE, this.legendFilters))
  ...
  public class TileMode : OverlayModes.Mode
  {
    ...
    public override void OnFiltersChanged()
    {
      ...
      if (this.InFilter(ToolParameterMenu.FILTERLAYERS.MISC, this.legendFilters))
