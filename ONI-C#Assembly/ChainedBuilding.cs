  ...
  GameStateMachine<ChainedBuilding, ChainedBuilding.StatesInstance, IStateMachineTarget, ChainedBuilding.Def>
{
  ...
  public override void InitializeStates(out StateMachine.BaseState defaultState)
  {
    ...
    status_item.resolveTooltipCallback = (Func<string, object, string>) ((tooltip, obj) =>
    {
      ...
      return tooltip.Replace("{headBuilding}", (string) Strings.Get($"STRINGS.BUILDINGS.PREFABS.{statesInstance.def.headBuildingTag.Name.ToUpper()}.NAME")).Replace("{linkBuilding}", (string) Strings.Get($"STRINGS.BUILDINGS.PREFABS.{statesInstance.def.linkBuildingTag.Name.ToUpper()}.NAME"));
    });
