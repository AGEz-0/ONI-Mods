...
public class OilWellCap : RemoteWorkable, ISingleSliderControl, ISliderControl, IElementEmitter
{
  ...
  public override Chore RemoteDockChore => (Chore) this.DepressurizeChore;
  ...
  public void ReleaseGasPressure(float dt)
  {
    ...
    if ((UnityEngine.Object) primaryElement != (UnityEngine.Object) null && (double) primaryElement.Mass > 0.0)
    {
      ...
      SimMessages.AddRemoveSubstance(Grid.PosToCell((KMonoBehaviour) this), ElementLoader.GetElementIndex(this.gasElement), (CellAddRemoveSubstanceEvent) null, num, primaryElement.Temperature, percentOfDisease.idx, percentOfDisease.count);
    }
    this.UpdatePressurePercent();
  }
  ...
  {
    this.DepressurizeChore = new WorkChore<OilWellCap>(Db.Get().ChoreTypes.Depressurize, (IStateMachineTarget) this);
    this.DepressurizeChore.AddPrecondition(OilWellCap.AllowedToDepressurize, (object) this);
  ...
  protected override void OnStopWork(WorkerBase worker)
  {
    ...
    this.DepressurizeChore = (WorkChore<OilWellCap>) null;
  }
  ...
  public class StatesInstance(OilWellCap master) : 
    GameStateMachine<OilWellCap.States, OilWellCap.StatesInstance, OilWellCap, object>.GameInstance(master)
  {
  ...
  public class States : GameStateMachine<OilWellCap.States, OilWellCap.StatesInstance, OilWellCap>
  {
    ...
    public override void InitializeStates(out StateMachine.BaseState default_state)
    {
      ...
      this.operational.DefaultState(this.operational.idle).ToggleRecurringChore((Func<OilWellCap.StatesInstance, Chore>) (smi => (Chore) smi.master.CreateWorkChore())).EventHandler(GameHashes.WorkChoreDisabled, (StateMachine<OilWellCap.States, OilWellCap.StatesInstance, OilWellCap, object>.State.Callback) (smi => smi.master.CancelChore("WorkChoreDisabled")));
