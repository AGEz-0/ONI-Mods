...
public class UIGameObjectPool
{
  ...
  {
    this.activeElements.ForEach((Action<GameObject>) (ae => UnityEngine.Object.Destroy((UnityEngine.Object) ae)));
    this.activeElements.Clear();
  }

  public void DestroyAllFree()
  {
    this.freeElements.ForEach((Action<GameObject>) (ae => UnityEngine.Object.Destroy((UnityEngine.Object) ae)));
