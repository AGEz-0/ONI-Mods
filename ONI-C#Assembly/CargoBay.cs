...
public class CargoBay : KMonoBehaviour
{
  ...
  public void SpawnResources(object data)
  {
    if (DlcManager.FeatureClusterSpaceEnabled())
      return;
    ILaunchableRocket component1 = this.GetComponent<RocketModule>().conditionManager.GetComponent<ILaunchableRocket>();
  ...
  private void ReserveResources()
  {
    if (DlcManager.FeatureClusterSpaceEnabled())
      return;
    ILaunchableRocket component = this.GetComponent<RocketModule>().conditionManager.GetComponent<ILaunchableRocket>();
