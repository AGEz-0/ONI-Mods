...
public class RequireInputs : KMonoBehaviour, ISim200ms
{
  ...
  private void CheckRequirements(bool forceEvent)
  {
    ...
    if (this.requirePower)
    {
      ...
      bool show1 = this.VisualizeRequirement(RequireInputs.Requirements.NeedPower) & isConnected && !isPowered && ((UnityEngine.Object) this.button == (UnityEngine.Object) null || this.button.IsEnabled);
