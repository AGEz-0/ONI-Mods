...
public class Turbine : KMonoBehaviour
{
  ...
  public class States : GameStateMachine<Turbine.States, Turbine.Instance, Turbine>
  {
    ...
    public override void InitializeStates(out StateMachine.BaseState default_state)
    {
      ...
      this.operational.DefaultState(this.operational.spinningUp).EventTransition(GameHashes.OperationalChanged, this.inoperational, (StateMachine<Turbine.States, Turbine.Instance, Turbine, object>.Transition.ConditionCallback) (smi => !smi.master.GetComponent<Operational>().IsOperational)).Update("UpdateOperational", (Action<Turbine.Instance, float>) ((smi, dt) => smi.UpdateState(dt))).Exit((StateMachine<Turbine.States, Turbine.Instance, Turbine, object>.State.Callback) (smi => smi.DisableStatusItems()));
  ...
  public class Instance(Turbine master) : 
    GameStateMachine<Turbine.States, Turbine.Instance, Turbine, object>.GameInstance(master)
  {
