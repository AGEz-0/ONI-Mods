...
public class CREATURES
{
  ...
  public class SPECIES
  {
    public class CRAB
    {
      ...
      public class VARIANT_FRESH_WATER
      {
        ...
        public static LocString DESC = (LocString) $"Sanishells are nonhostile critters unless their eggs are nearby.\n\nThey thrive in {UI.FormatAsLink("Water", "WATER")} and eliminate {UI.FormatAsLink("Germs", "DISEASE")} from any liquid it inhabits.\n\nThey eat {UI.FormatAsLink("Polluted Dirt", "TOXICSAND")}, {UI.FormatAsLink("Slime", "SLIMEMOLD")} and {UI.FormatAsLink("Rot Piles", "COMPOST")}.";
    ...
    public class GEYSER
    {
      ...
      {
        public static LocString NAME = (LocString) UI.FormatAsLink("Cool Chlorine Gas Vent", "GeyserGeneric_CHLORINE_GAS_COOL");
    ...
    public class GASGRASS
    {
      ...
      public static LocString DESC = (LocString) $"Gas Grass is an alien lifeform tentatively categorized as a \"plant,\" which makes up the entirety of the {UI.FormatAsLink("Gassy Moo's", "MOO")} diet.";
    ...
    {
      public static LocString NAME = (LocString) "Lumen Quartz";
    ...
    {
      public static LocString NAME = (LocString) "Carved Lumen Quartz";
    ...
    public class DINOFERN
    {
      ...
      public static LocString DOMESTICATEDDESC = (LocString) $"This plant produces edible {(string) ITEMS.FOOD.FERNFOOD.NAME}.";
    }
    ...
    public class VINEBRANCH
    {
      ...
      public static LocString DESC = (LocString) $"Ovagro Vines are invasive plants that produce edible {UI.FormatAsLink("Ovagro Fig", "VINEFRUIT")}.\n\nIf a vine is cut off from its {UI.FormatAsLink("Ovagro Node", "VINEMOTHER")}, it will perish.";
    }
    ...
    public class BUTTERFLYPLANT
    {
      ...
      public static LocString DESC = (LocString) $"Mimika Buds are self-harvesting plants that produce airborne {UI.FormatAsLink("Mimikas", "BUTTERFLY")}.\n\n{UI.FormatAsLink("Mimikas", "BUTTERFLY")} boost growth for nearby {UI.FormatAsLink("Plants", "PLANTS")} before hardening into {UI.FormatAsLink("Mimillet", nameof (BUTTERFLYPLANT))}.";
    ...
    public class SEEDS
    {
      public class VINEMOTHER
      {
        ...
        public static LocString DESC = (LocString) $"The {UI.FormatAsLink("Seed", "PLANTS")} of a {UI.FormatAsLink("Ovagro Node", nameof (VINEMOTHER))}.\n\nDigging up Buried Objects may uncover an Ovagro Node Seed.";
      }
  ...
  public class STATUSITEMS
  {
    ...
    public class UNDERWATERCRITTERCONDO
    {
      public class MOVINGTO
      {
        public static LocString NAME = (LocString) "Heading for Water Fort";
        public static LocString TOOLTIP = (LocString) "This critter is making its way to an unoccupied water fort";
      }

      public class INTERACTING
      {
        public static LocString NAME = (LocString) "Getting Cozy";
        public static LocString TOOLTIP = (LocString) "This critter is relaxing in a water fort\n\nIt's like a mini vacation!";
      }
    }
    ...
    public class POLLINATING
    {
      public class MOVINGTO
      {
        public static LocString NAME = (LocString) "Going to Tend";
  ...
  public class STATS
  {
    ...
    public class BECKONING
    {
      ...
      public static LocString TOOLTIP = (LocString) $"At 100% {UI.PRE_KEYWORD}Accu-moo-lation{UI.PST_KEYWORD}, a Gassy Moo calls a friend to join them on this asteroid\n\nAfter the new Gassy Moo has landed, {UI.PRE_KEYWORD}Accu-moo-lation{UI.PST_KEYWORD} is rolled back to 0%";
    }
    ...
    public class MILKPRODUCTION
    {
      ...
      public static LocString TOOLTIP = (LocString) $"The amount of time required for this critter to replenish its natural reserves of {UI.PRE_KEYWORD}Brackene{UI.PST_KEYWORD}";
    }
  ...
  public class MODIFIERS
  {
    ...
    {
      public static LocString NAME = (LocString) "Hydrated";
      public static LocString TOOLTIP = (LocString) $"This critter recently drank {UI.PRE_KEYWORD}Brackene{UI.PST_KEYWORD}\n\nIt doesn't mind overcrowding quite as much right now";
    }
