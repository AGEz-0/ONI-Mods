...
public static class WORLDS
{
  ...
  {
    public static LocString NAME = (LocString) "Big Empty FOR DEVS";
    public static LocString DESCRIPTION = (LocString) "A big ol' biome-free spacerock for claustrophobic devs.";
  }
  ...
  {
    public static LocString NAME = (LocString) "Ceres Mantle Asteroid";
    public static LocString DESCRIPTION = (LocString) "A battered chunk of a smaller frosty starting world with sub-zero temperatures throughout.\n\n<smallcaps>Surviving Ceres Mantle's frigid landscape is no easy task, but natural fuel sources provide a valuable payoff.</smallcaps>";
  }

  public class MINISHATTEREDWARP
  {
    public static LocString NAME = (LocString) "Sweet Ceres Asteroid";
    public static LocString DESCRIPTION = (LocString) "A small, snow-laden world rich with oil and nectar resources.\n\n<smallcaps>Sub-zero temperatures pose unique challenges but the potential for power production is very valuable.</smallcaps>";
  }

  public class MINISHATTEREDGEO
  {
    public static LocString NAME = (LocString) "Ceres Core Asteroid";
    public static LocString DESCRIPTION = (LocString) "A molten mini asteroid with a failed experiment buried inside.\n\n<smallcaps>Extremely high temperatures threaten colony safety but could yield an unimaginably powerful payoff.</smallcaps>";
  }

  public class CERESSPACEDOUT
  {
    public static LocString NAME = (LocString) "Ceres Minor";
    public static LocString DESCRIPTION = (LocString) "A smaller frosty starting world with sub-zero temperatures throughout.\n\n<smallcaps>Duplicants who work in Ceres's sub-zero temperatures will need to wear or build warming equipment. Abundant natural fuel sources could lead to a well-powered colony.</smallcaps>";
  }

  public class CERESCLASSIC
  {
    public static LocString NAME = (LocString) "Ceres Asteroid";
    public static LocString DESCRIPTION = (LocString) "A frosty starting world with sub-zero temperatures throughout.\n\n<smallcaps>Duplicants who work in Ceres's sub-zero temperatures will need to wear or build warming equipment. Abundant natural fuel sources could lead to a well-powered colony.</smallcaps>";
  }

  public class CERESMIXING
  {
    public static LocString NAME = (LocString) "Ceres Fragment";
    public static LocString DESCRIPTION = (LocString) "A fragment of a frosty starting world with sub-zero temperatures throughout.\n\n<smallcaps>Duplicants who work in sub-zero temperatures will need to wear or build warming equipment. Abundant natural fuel sources could lead to a well-powered colony.</smallcaps>";
  }

  public class PREHISTORICBASEGAME
  {
    public static LocString NAME = (LocString) "Relica";
    public static LocString DESCRIPTION = (LocString) "An endangered location with abundant food resources.\n\n<smallcaps>Relica's biodiversity makes reliable food production more attainable for new colonies. Construction materials and fuels are also ample. Surface defence must be prioritized to minimize damage from an incoming impactor asteroid.</smallcaps>";
  }

  public class PREHISTORICSHATTERED
  {
    public static LocString NAME = (LocString) "RelicAAAA<sup>AAAGHH</sup>";
    public static LocString DESCRIPTION = (LocString) "A geyser-rich location that will be struck by an impactor asteroid almost immediately.\n\n<smallcaps>Impact-related damage will trigger the eruption of this world's unusually high number of geyers. Colonies that survive the volatile aftermath will reap the benefits of the abundant natural resources released into the environment.</smallcaps>";
  }

  public class PREHISTORICCLASSIC
  {
    public static LocString NAME = (LocString) "Relica Asteroid";
    public static LocString DESCRIPTION = (LocString) "An endangered starting world with abundant food resources.\n\n<smallcaps>Relica's biodiversity makes reliable food production more attainable for new colonies. Construction materials and fuels are also ample. Surface defence must be prioritized to minimize damage from an incoming impactor asteroid.</smallcaps>";
  }

  public class PREHISTORICSPACEDOUT
  {
    public static LocString NAME = (LocString) "Relica Minor";
    public static LocString DESCRIPTION = (LocString) "A smaller endangered starting world with abundant food resources.\n\n<smallcaps>Relica's biodiversity makes reliable food production more attainable for new colonies. Construction materials and fuels are also ample. Surface defence must be prioritized to minimize damage from an incoming impactor asteroid.</smallcaps>";
  }

  public class PREHISTORICMIXING
  {
    public static LocString NAME = (LocString) "Relica Fragment";
    public static LocString DESCRIPTION = (LocString) "A fragment of a prehistoric starting world.\n\n<smallcaps>Its biodiversity makes reliable food production more attainable for new colonies. Construction materials and fuels are also ample. </smallcaps>";
  }
}
