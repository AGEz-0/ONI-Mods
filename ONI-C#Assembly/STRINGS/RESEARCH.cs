...
public class RESEARCH
{
  public class MESSAGING
  {
    ...
    public static class DLC
    {
      ...
      public static LocString DLC_CONTENT = (LocString) "\n<i>{0}</i> DLC Content";
    }
  }
  ...
  public class OTHER_TECH_ITEMS
  {
    ...
    {
      public static LocString NAME = (LocString) $"{UI.PRE_KEYWORD}Advanced Chemical Production{UI.PST_KEYWORD}";
      public static LocString DESC = (LocString) $"Enables production of {(string) ELEMENTS.VISCOGEL.NAME} and {(string) ELEMENTS.SUPERCOOLANT.NAME} at the {(string) BUILDINGS.PREFABS.CHEMICALREFINERY.NAME}.";
    }

    public class LUBRICATION_STICK
    {
      public static LocString NAME = (LocString) $"{UI.PRE_KEYWORD}Gear Balm{UI.PST_KEYWORD} Pattern";
      public static LocString DESC = (LocString) $"Enables fabrication of {UI.PRE_KEYWORD}Gear Balm{UI.PST_KEYWORD} at the {(string) BUILDINGS.PREFABS.APOTHECARY.NAME}";
    }

    public class DISPOSABLE_ELECTROBANK_METAL_ORE
    {
      public static LocString NAME = (LocString) $"{UI.PRE_KEYWORD}Metal Power Bank{UI.PST_KEYWORD} Pattern";
      public static LocString DESC = (LocString) $"Enables fabrication of {UI.PRE_KEYWORD}Metal Power Banks{UI.PST_KEYWORD} at the {(string) BUILDINGS.PREFABS.CRAFTINGTABLE.NAME}";
    }

    public class DISPOSABLE_ELECTROBANK_URANIUM_ORE
    {
      public static LocString NAME = (LocString) $"{UI.PRE_KEYWORD}Uranium Ore Power Bank{UI.PST_KEYWORD} Pattern";
      public static LocString DESC = (LocString) $"Enables fabrication of {UI.PRE_KEYWORD}Uranium Ore Power Banks{UI.PST_KEYWORD} at the {(string) BUILDINGS.PREFABS.CRAFTINGTABLE.NAME}";
    }

    public class ELECTROBANK
    {
      public static LocString NAME = (LocString) $"{UI.PRE_KEYWORD}Eco Power Bank{UI.PST_KEYWORD} Pattern";
      public static LocString DESC = (LocString) $"Enables fabrication of {UI.PRE_KEYWORD}Eco Power Banks{UI.PST_KEYWORD} at the {(string) BUILDINGS.PREFABS.ADVANCEDCRAFTINGTABLE.NAME}";
    }

    public class SELFCHARGINGELECTROBANK
    {
      public static LocString NAME = (LocString) $"{UI.PRE_KEYWORD}Atomic Power Bank{UI.PST_KEYWORD} Pattern";
      public static LocString DESC = (LocString) $"Enables fabrication of {UI.PRE_KEYWORD}Atomic Power Bank{UI.PST_KEYWORD} at the {(string) BUILDINGS.PREFABS.SUPERMATERIALREFINERY.NAME}";
    }

    public class FETCHDRONE
    {
      public static LocString NAME = (LocString) $"{UI.PRE_KEYWORD}Flydo{UI.PST_KEYWORD} Pattern";
      public static LocString DESC = (LocString) $"Enables fabrication of {UI.PRE_KEYWORD}Flydo{UI.PST_KEYWORD} at the {(string) BUILDINGS.PREFABS.ADVANCEDCRAFTINGTABLE.NAME}";
    }

    public class PILOTINGBOOSTER
    {
      public static LocString NAME = (LocString) $"{UI.PRE_KEYWORD}Rocketry Booster{UI.PST_KEYWORD} Pattern";
      public static LocString DESC = (LocString) $"Enables fabrication of {UI.PRE_KEYWORD}Rocketry Boosters{UI.PST_KEYWORD} for Bionic Duplicants at the {(string) BUILDINGS.PREFABS.ADVANCEDCRAFTINGTABLE.NAME}";
    }

    public class CONSTRUCTIONBOOSTER
    {
      public static LocString NAME = (LocString) $"{UI.PRE_KEYWORD}Building Booster{UI.PST_KEYWORD} Pattern";
      public static LocString DESC = (LocString) $"Enables fabrication of {UI.PRE_KEYWORD}Building Boosters{UI.PST_KEYWORD} for Bionic Duplicants at the {(string) BUILDINGS.PREFABS.ADVANCEDCRAFTINGTABLE.NAME}";
    }

    public class EXCAVATIONBOOSTER
    {
      public static LocString NAME = (LocString) $"{UI.PRE_KEYWORD}Digging Booster{UI.PST_KEYWORD} Pattern";
      public static LocString DESC = (LocString) $"Enables fabrication of {UI.PRE_KEYWORD}Digging Boosters{UI.PST_KEYWORD} for Bionic Duplicants at the {(string) BUILDINGS.PREFABS.ADVANCEDCRAFTINGTABLE.NAME}";
    }

    public class EXPLORERBOOSTER
    {
      public static LocString NAME = (LocString) $"{UI.PRE_KEYWORD}Dowsing Booster{UI.PST_KEYWORD} Pattern";
      public static LocString DESC = (LocString) $"Enables fabrication of {UI.PRE_KEYWORD}Dowsing Boosters{UI.PST_KEYWORD} for Bionic Duplicants at the {(string) BUILDINGS.PREFABS.ADVANCEDCRAFTINGTABLE.NAME}";
    }

    public class MACHINERYBOOSTER
    {
      public static LocString NAME = (LocString) $"{UI.PRE_KEYWORD}Operating Booster{UI.PST_KEYWORD} Pattern";
      public static LocString DESC = (LocString) $"Enables fabrication of {UI.PRE_KEYWORD}Operating Boosters{UI.PST_KEYWORD} for Bionic Duplicants at the {(string) BUILDINGS.PREFABS.ADVANCEDCRAFTINGTABLE.NAME}";
    }

    public class ATHLETICSBOOSTER
    {
      public static LocString NAME = (LocString) $"{UI.PRE_KEYWORD}Athletics Booster{UI.PST_KEYWORD} Pattern";
      public static LocString DESC = (LocString) $"Enables fabrication of {UI.PRE_KEYWORD}Athletics Boosters{UI.PST_KEYWORD} for Bionic Duplicants at the {(string) BUILDINGS.PREFABS.ADVANCEDCRAFTINGTABLE.NAME}";
    }

    public class SCIENCEBOOSTER
    {
      public static LocString NAME = (LocString) $"{UI.PRE_KEYWORD}Researching Booster{UI.PST_KEYWORD} Pattern";
      public static LocString DESC = (LocString) $"Enables fabrication of {UI.PRE_KEYWORD}Researching Boosters{UI.PST_KEYWORD} for Bionic Duplicants at the {(string) BUILDINGS.PREFABS.ADVANCEDCRAFTINGTABLE.NAME}";
    }

    public class COOKINGBOOSTER
    {
      public static LocString NAME = (LocString) $"{UI.PRE_KEYWORD}Cooking Booster{UI.PST_KEYWORD} Pattern";
      public static LocString DESC = (LocString) $"Enables fabrication of {UI.PRE_KEYWORD}Cooking Boosters{UI.PST_KEYWORD} for Bionic Duplicants at the {(string) BUILDINGS.PREFABS.ADVANCEDCRAFTINGTABLE.NAME}";
    }

    public class MEDICINEBOOSTER
    {
      public static LocString NAME = (LocString) $"{UI.PRE_KEYWORD}Doctoring Booster{UI.PST_KEYWORD} Pattern";
      public static LocString DESC = (LocString) $"Enables fabrication of {UI.PRE_KEYWORD}Doctoring Boosters{UI.PST_KEYWORD} for Bionic Duplicants at the {(string) BUILDINGS.PREFABS.ADVANCEDCRAFTINGTABLE.NAME}";
    }

    public class STRENGTHBOOSTER
    {
      public static LocString NAME = (LocString) $"{UI.PRE_KEYWORD}Strength Booster{UI.PST_KEYWORD} Pattern";
      public static LocString DESC = (LocString) $"Enables fabrication of {UI.PRE_KEYWORD}Strength Boosters{UI.PST_KEYWORD} for Bionic Duplicants at the {(string) BUILDINGS.PREFABS.ADVANCEDCRAFTINGTABLE.NAME}";
    }

    public class CREATIVITYBOOSTER
    {
      public static LocString NAME = (LocString) $"{UI.PRE_KEYWORD}Decorating Booster{UI.PST_KEYWORD} Pattern";
      public static LocString DESC = (LocString) $"Enables fabrication of {UI.PRE_KEYWORD}Decorating Boosters{UI.PST_KEYWORD} for Bionic Duplicants at the {(string) BUILDINGS.PREFABS.ADVANCEDCRAFTINGTABLE.NAME}";
    }

    public class AGRICULTUREBOOSTER
    {
      public static LocString NAME = (LocString) $"{UI.PRE_KEYWORD}Farming Booster{UI.PST_KEYWORD} Pattern";
      public static LocString DESC = (LocString) $"Enables fabrication of {UI.PRE_KEYWORD}Farming Boosters{UI.PST_KEYWORD} for Bionic Duplicants at the {(string) BUILDINGS.PREFABS.ADVANCEDCRAFTINGTABLE.NAME}";
    }

    public class HUSBANDRYBOOSTER
    {
      public static LocString NAME = (LocString) $"{UI.PRE_KEYWORD}Ranching Booster{UI.PST_KEYWORD} Pattern";
      public static LocString DESC = (LocString) $"Enables fabrication of {UI.PRE_KEYWORD}Ranching Boosters{UI.PST_KEYWORD} for Bionic Duplicants at the {(string) BUILDINGS.PREFABS.ADVANCEDCRAFTINGTABLE.NAME}";
    }
  }
  ...
  public class TECHS
  {
    ...
    {
      public static LocString NAME = (LocString) UI.FormatAsLink("Creature Comforts", nameof (ANIMALCOMFORT));
      public static LocString DESC = (LocString) "Strategies for maximizing critters' quality of life.";
    }

    public class DAIRYOPERATION
    {
      public static LocString NAME = (LocString) UI.FormatAsLink("Brackene Flow", nameof (DAIRYOPERATION));
      public static LocString DESC = (LocString) "Advanced production, processing and distribution of this fluid resource.";
    }
    ...
    public class FLOWREDIRECTION
    {
      ...
      public static LocString DESC = (LocString) $"{UI.FormatAsLink("Liquid", "ELEMENTS_LIQUID")} management for {UI.FormatAsLink("Morale", "MORALE")} and industry.";
    }
    ...
    public class LIQUIDDISTRIBUTION
    {
      ...
      public static LocString DESC = (LocString) $"Advanced fittings ensure that {UI.FormatAsLink("Liquid", "ELEMENTS_LIQUID")} resources get where they need to go.";
    }
    ...
    public class GASDISTRIBUTION
    {
      ...
      public static LocString DESC = (LocString) $"Design building hookups to get {UI.FormatAsLink("Gas", "ELEMENTS_GAS")} resources circulating properly.";
    }
    ...
    {
      public static LocString NAME = (LocString) UI.FormatAsLink("Emulsification", nameof (ADVANCEDDISTILLATION));
      public static LocString DESC = (LocString) $"Specialized production of {UI.FormatAsLink("Liquid", "ELEMENTS_LIQUID")} compounds.";
    }
    ...
    {
      public static LocString NAME = (LocString) UI.FormatAsLink("Projectiles", nameof (JETPACKS));
      public static LocString DESC = (LocString) "Things that get Duplicants and explosives off the ground.";
    }
    ...
    {
      public static LocString NAME = (LocString) UI.FormatAsLink("Materials Science Research", nameof (NUCLEARRESEARCH));
    ...
    {
      public static LocString NAME = (LocString) UI.FormatAsLink("More Materials Science Research", nameof (ADVANCEDNUCLEARRESEARCH));
    ...
    {
      public static LocString NAME = (LocString) UI.FormatAsLink("Radbolt Containment", nameof (NUCLEARSTORAGE));
    ...
    public class SPACEGAS
    {
      ...
      public static LocString DESC = (LocString) (UI.FormatAsLink("Gas", "ELEMENTS_GAS") + " engines and transportation for rockets.");
    }

    public class DATASCIENCE
    {
      public static LocString NAME = (LocString) UI.FormatAsLink("Data Science", nameof (DATASCIENCE));
      public static LocString DESC = (LocString) "The science of making the data work for my Duplicants, instead of the other way around.";
    }

    public class DATASCIENCEBASEGAME
    {
      public static LocString NAME = (LocString) UI.FormatAsLink("Data Science", nameof (DATASCIENCEBASEGAME));
      public static LocString DESC = (LocString) "The science of making the data work for my Duplicants, instead of the other way around.";
    }
  }
}
