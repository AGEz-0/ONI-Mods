...
public class DUPLICANTS
{
  ...
  public static LocString MODELTITLE = (LocString) "Species: ";
  ...
  public class MODEL
  {
    ...
    {
      public static LocString NAME = (LocString) "Standard Duplicant";
      public static LocString DESC = (LocString) $"Standard Duplicants are hard workers who enjoy good {UI.FormatAsLink("Food", "FOOD")}, fresh {UI.FormatAsLink("Oxygen", "OXYGEN")} and creative colony-building.\n\nThey will complete errands in order of {UI.FormatAsLink("Priority", "PRIORITY")}.";
    }

    public class BIONIC
    {
      public static LocString NAME = (LocString) "Bionic Duplicant";
      public static LocString NAME_TOOLTIP = (LocString) "This Duplicant is a curious combination of organic and inorganic parts";
      public static LocString DESC = (LocString) $"Bionic Duplicants run on {UI.FormatAsLink("Power Banks", "ELECTROBANK")}, {UI.FormatAsLink("Gear Oil", "LUBRICATINGOIL")} and unbridled enthusiasm.\n\nThey should not be permitted to use standard {UI.FormatAsLink("Toilets", "MISCELLANEOUSTIPS")}.";
    }

    public class REMOTEWORKER
    {
      public static LocString NAME = (LocString) "Remote Worker";
      public static LocString DESC = (LocString) $"A remotely operated work robot.\n\nIt performs chores as instructed by a {UI.FormatAsLink("Remote Controller", "REMOTEWORKTERMINAL")} on the same planetoid.";
    }
  }
  ...
  public class STATS
  {
    ...
    {
      public static LocString NAME = (LocString) "Power Banks";
      public static LocString TOOLTIP = (LocString) $"A Bionic Duplicant with zero remaining {UI.PRE_KEYWORD}Power{UI.PST_KEYWORD} will become incapacitated until replacement {UI.PRE_KEYWORD}Power Banks{UI.PST_KEYWORD} are installed";
    }

    public class BIONICOXYGENTANK
    {
      public static LocString NAME = (LocString) "Oxygen Tank";
      public static LocString TOOLTIP = (LocString) $"Bionic Duplicants have internal {UI.PRE_KEYWORD}Oxygen{UI.PST_KEYWORD} tanks that enable them to work in low breathability areas\n\nThey will prioritize {UI.PRE_KEYWORD}Oxygen{UI.PST_KEYWORD} intake from equipped {UI.PRE_KEYWORD}Exosuits{UI.PST_KEYWORD} to conserve their internal tanks";
      public static LocString TOOLTIP_MASS_LINE = (LocString) "Current mass: {0} / {1}";
      public static LocString TOOLTIP_MASS_ROW_DETAIL = (LocString) "    • {0}: {1}{2}";
      public static LocString TOOLTIP_GERM_DETAIL = (LocString) " - {0}";
    }

    public class BIONICOIL
    {
      public static LocString NAME = (LocString) "Gear Oil";
      public static LocString TOOLTIP = (LocString) $"Bionic Duplicants will slow down significantly when {UI.PRE_KEYWORD}Gear Oil{UI.PST_KEYWORD} levels reach zero\n\nThey can oil their joints by visiting a {UI.PRE_KEYWORD}Lubrication Station{UI.PST_KEYWORD} or using {UI.PRE_KEYWORD}Gear Balm{UI.PST_KEYWORD} ";
    }

    public class BIONICGUNK
    {
      public static LocString NAME = (LocString) "Gunk";
      public static LocString TOOLTIP = (LocString) $"Bionic Duplicants become {UI.PRE_KEYWORD}Stressed{UI.PST_KEYWORD} when too much {UI.PRE_KEYWORD}Gunk{UI.PST_KEYWORD} builds up in their bionic parts\n\nRegular visits to the {UI.PRE_KEYWORD}Gunk Extractor{UI.PST_KEYWORD} are required";
    }

    public class BREATH
    {
      public static LocString NAME = (LocString) "Breath";
      public static LocString TOOLTIP = (LocString) $"A Duplicant with zero remaining {UI.PRE_KEYWORD}Breath{UI.PST_KEYWORD} will die immediately";
    }
    ...
    {
      public static LocString NAME = (LocString) "Node Health";
      public static LocString TOOLTIP = (LocString) "Vines cannot grow if they do not have a healthy node to grow from";
    }
  }
  ...
  public class CHORES
  {
    ...
    {
      public static LocString NAME = (LocString) "Powerless";
      public static LocString STATUS = (LocString) "Powerless";
      public static LocString TOOLTIP = (LocString) $"This Duplicant does not have enough {UI.PRE_KEYWORD}Power{UI.PST_KEYWORD} to function";
    }

    public class BIONICBEDTIMEMODE
    {
      public static LocString NAME = (LocString) "Defragment";
      public static LocString STATUS = (LocString) "Defragmenting";
      public static LocString TOOLTIP = (LocString) "This Duplicant is reorganizing their data cache during bedtime";
    }
    ...
    {
      public static LocString NAME = (LocString) "Expel Gunk";
      public static LocString STATUS = (LocString) "Expelling gunk";
      public static LocString TOOLTIP = (LocString) $"This Duplicant didn't get to a {UI.PRE_KEYWORD}Gunk Extractor{UI.PST_KEYWORD} in time. Urgh";
    }

    public class OILCHANGE
    {
      public static LocString NAME = (LocString) "Refill Oil";
      public static LocString STATUS = (LocString) "Refilling oil";
      public static LocString TOOLTIP = (LocString) "This Duplicant is making sure their internal mechanisms stay lubricated";
    }
    ...
    {
      public static LocString NAME = (LocString) "Shock";
      public static LocString STATUS = (LocString) "Shocking";
      public static LocString TOOLTIP = (LocString) $"This Duplicant's inability to handle {UI.PRE_KEYWORD}Stress{UI.PST_KEYWORD} is pretty shocking";
    }
    ...
    {
      public static LocString NAME = (LocString) "Recover from Heat";
      public static LocString STATUS = (LocString) "Recovering from heat";
      public static LocString TOOLTIP = (LocString) "This Duplicant's trying to cool down";
    }

    public class RECOVERWARMTH
    {
      public static LocString NAME = (LocString) "Recover from Cold";
      public static LocString STATUS = (LocString) "Recovering from cold";
      public static LocString TOOLTIP = (LocString) "This Duplicant's trying to warm up";
    }
    ...
    public class SLIP
    {
      public static LocString NAME = (LocString) "Slip";
      public static LocString STATUS = (LocString) "Slipping";
      public static LocString TOOLTIP = (LocString) "Slippery surfaces can cause Duplicants to fall \"seat over tea kettle\"";
    }
    ...
    {
      public static LocString NAME = (LocString) "Power Up";
      public static LocString STATUS = (LocString) "Looking for power banks";
      public static LocString TOOLTIP = (LocString) $"Bionic Duplicants need {UI.PRE_KEYWORD}Power Banks{UI.PST_KEYWORD} to function";
    }

    public class FINDOXYGENSOURCEITEM
    {
      public static LocString NAME = (LocString) "Seek Oxygen Refill";
      public static LocString STATUS = (LocString) "Looking for oxygen refills";
      public static LocString TOOLTIP = (LocString) $"Bionic Duplicants are fitted with internal {UI.PRE_KEYWORD}Oxygen{UI.PST_KEYWORD} tanks that must be refilled";
    }

    public class BIONICABSORBOXYGEN
    {
      public static LocString NAME = (LocString) "Refill Oxygen Tank";
      public static LocString STATUS = (LocString) "Refilling oxygen tank";
      public static LocString TOOLTIP = (LocString) $"This Duplicant is refilling their internal {UI.PRE_KEYWORD}Oxygen{UI.PST_KEYWORD} tank: {{0}} O<sub>2</sub>\n\nBionic Duplicants automatically refill their internal tanks in highly breathable areas during scheduled {UI.PRE_KEYWORD}Downtime{UI.PST_KEYWORD}";
    }

    public class BIONICABSORBOXYGENCRITICAL
    {
      public static LocString NAME = (LocString) "Urgent Oxygen Refill";
      public static LocString STATUS = (LocString) "Urgently refilling oxygen tank";
      public static LocString TOOLTIP = (LocString) $"This Duplicant is refilling their depleted {UI.PRE_KEYWORD}Oxygen{UI.PST_KEYWORD} tank in the nearest breathable area: {{0}} O<sub>2</sub>\n\nImproving colony breathability and scheduling regular {UI.PRE_KEYWORD}Downtime{UI.PST_KEYWORD} will prevent future emergencies";
    }

    public class UNLOADELECTROBANK
    {
      public static LocString NAME = (LocString) "Offload";
      public static LocString STATUS = (LocString) "Offloading empty power banks";
      public static LocString TOOLTIP = (LocString) $"Bionic Duplicants automatically offload depleted {UI.PRE_KEYWORD}Power Banks{UI.PST_KEYWORD}";
    }

    public class SEEKANDINSTALLUPGRADE
    {
      public static LocString NAME = (LocString) "Retrieve Booster";
      public static LocString STATUS = (LocString) "Retrieving booster";
      public static LocString TOOLTIP = (LocString) "This Duplicant is on its way to retrieve a booster that was assigned to them";
    }
    ...
    {
      public static LocString NAME = (LocString) "Glitch";
      public static LocString STATUS = (LocString) "Glitching";
      public static LocString TOOLTIP = (LocString) $"Glitching is a symptom of Bionic Duplicant systems malfunctioning due to contact with incompatible {UI.PRE_KEYWORD}Liquids{UI.PST_KEYWORD}";
    }
    ...
    {
      public static LocString NAME = (LocString) "Process Critter";
      public static LocString STATUS = (LocString) "Going to process critter";
      public static LocString TOOLTIP = (LocString) $"This Duplicant is processing {UI.PRE_KEYWORD}Critters{UI.PST_KEYWORD}";
    }
    ...
    {
      public static LocString NAME = (LocString) "Construction Uproot";
      public static LocString STATUS = (LocString) "Going to construction uproot";
      public static LocString TOOLTIP = (LocString) "This Duplicant is making room for a planned construction task by uprooting a plant";
    }
    ...
    {
      public static LocString NAME = (LocString) "Excavate Fossil";
      public static LocString STATUS = (LocString) "Excavating a fossil";
      public static LocString TOOLTIP = (LocString) $"This Duplicant is excavating a {UI.PRE_KEYWORD}Fossil{UI.PST_KEYWORD} site";
    }

    public class ARMTRAP
    {
      public static LocString NAME = (LocString) "Arm Trap";
      public static LocString STATUS = (LocString) "Arming a trap";
      public static LocString TOOLTIP = (LocString) "This Duplicant is arming a trap";
    }
    ...
    {
      public static LocString NAME = (LocString) "Remote Work";
      public static LocString STATUS = (LocString) "Working remotely";
      public static LocString TOOLTIP = (LocString) "This Duplicant's body is here, but their work is elsewhere";
    }
    ...
    public class PRECONDITIONS
    {
      ...
      public static LocString IS_A_BIONIC = (LocString) "Must be a Bionic Duplicant";
      public static LocString NOT_A_BIONIC = (LocString) "Unavailable to Bionic Duplicants";
      ...
      public static LocString CANPICKUPANYASSIGNEDUPGRADE = (LocString) "Cannot pick up any assigned boosters";
      ...
      public static LocString REMOTE_CHORE_SUBCHORE_PRECONDITIONS = (LocString) "No Eligible Remote Chores";
      public static LocString REMOTE_CHORE_NO_REMOTE_DOCK = (LocString) "No Dock Assigned";
      public static LocString REMOTE_CHORE_DOCK_INOPERABLE = (LocString) "Remote Worker Dock Unusable";
      public static LocString REMOTE_CHORE_NO_REMOTE_WORKER = (LocString) "No Remote Worker at Dock";
      public static LocString REMOTE_CHORE_DOCK_UNAVAILABLE = (LocString) "Remote Worker Already Busy";
      public static LocString CAN_FETCH_DRONE_COMPLETE_FETCH = (LocString) "Flydo cannot complete chore";
    }
  }
  ...
  public class STATUSITEMS
  {
    ...
    {
      public static LocString NAME = (LocString) "Slipping";
      public static LocString TOOLTIP = (LocString) "This Duplicant is losing their balance on a slippery surface\n\nIt's not fun";
    }

    public class WAXEDFORTRANSITTUBE
    {
      public static LocString NAME = (LocString) "Smooth Rider";
      public static LocString TOOLTIP = (LocString) $"This Duplicant slapped on some {(string) ELEMENTS.MILKFAT.NAME} before starting their commute\n\nThis boosts their {(string) BUILDINGS.PREFABS.TRAVELTUBE.NAME} travel speed by {{0}}";
    }

    public class ARMINGTRAP
    {
      public static LocString NAME = (LocString) "Arming trap";
      public static LocString TOOLTIP = (LocString) "This Duplicant is arming a trap";
    }
    ...
    public class FOSSILHUNT
    {
      ...
      {
        public static LocString NAME = (LocString) "Excavating Fossil";
        public static LocString TOOLTIP = (LocString) ("This Duplicant is carefully uncovering a " + UI.FormatAsLink("Fossil", "FOSSIL"));
      }
    }
    ...
    {
      public static LocString NAME = (LocString) "Unscheduled Nap";
      public static LocString TOOLTIP = (LocString) $"Cold {UI.PRE_KEYWORD}Temperatures{UI.PST_KEYWORD} or lack of rest depleted this Duplicant's {UI.PRE_KEYWORD}Stamina{UI.PST_KEYWORD}\n\nThey didn't have enough energy to make it to bedtime";
    }
    ...
    {
      public static LocString NAME = (LocString) "Interrupted Sleep: Cold Room";
      public static LocString TOOLTIP = (LocString) "This Duplicant is having trouble sleeping because this room is too cold";
    }
    ...
    {
      public static LocString NAME = (LocString) "Incapacitated: Powerless";
      public static LocString TOOLTIP = (LocString) $"This Duplicant is non-functional!\n\nDeliver a charged {UI.PRE_KEYWORD}Power Bank{UI.PST_KEYWORD} and reboot their systems to revive them";
      public static LocString NOTIFICATION_NAME = (LocString) "Bionic Duplicant Incapacitated";
      public static LocString NOTIFICATION_TOOLTIP = (LocString) $"These Bionic Duplicants are non-functional.\n\nA charged {UI.PRE_KEYWORD}Power Bank{UI.PST_KEYWORD} and full reboot by a skilled Duplicant are required for rescue:";
    }

    public class BIONICMICROCHIPGENERATION
    {
      public static LocString NAME = (LocString) "Programming Microchip: {0}";
      public static LocString TOOLTIP = (LocString) $"This Duplicant is programming a microchip for use in {UI.PRE_KEYWORD}Booster{UI.PST_KEYWORD} production\n\nBionic Duplicants will program microchips while defragmenting\n\nThey will produce 1 microchip every {{0}}";
    }

    public class BIONICWANTSOILCHANGE
    {
      public static LocString NAME = (LocString) "Low Gear Oil";
      public static LocString TOOLTIP = (LocString) $"This Duplicant is almost out of {UI.PRE_KEYWORD}Gear Oil{UI.PST_KEYWORD}\n\nThey need to find {UI.PRE_KEYWORD}Gear Balm{UI.PST_KEYWORD} or visit a {UI.PRE_KEYWORD}Lubrication Station{UI.PST_KEYWORD}";
    }

    public class BIONICWAITINGFORREBOOT
    {
      public static LocString NAME = (LocString) "Awaiting Reboot";
      public static LocString TOOLTIP = (LocString) "This Duplicant needs someone to reboot their bionic systems so they can get back to work";
    }

    public class BIONICBEINGREBOOTED
    {
      public static LocString NAME = (LocString) "Reboot in progress";
      public static LocString TOOLTIP = (LocString) "This Duplicant's bionic systems are being rebooted";
    }

    public class BIONICREQUIRESSKILLPERK
    {
      public static LocString NAME = (LocString) "Skill-Required Operation";
      public static LocString TOOLTIP = (LocString) $"Only Duplicants with the following {UI.PRE_KEYWORD}Skills{UI.PST_KEYWORD} can reboot this Duplicant's bionic systems:\n\n{{Skills}}";
    }

    public class CLOGGINGTOILET
    {
      public static LocString NAME = (LocString) "Clogging a toilet";
      public static LocString TOOLTIP = (LocString) $"This Duplicant is clogging a toilet with {UI.PRE_KEYWORD}Gunk{UI.PST_KEYWORD}\n\nThey couldn't get to a {UI.PRE_KEYWORD}Gunk Extractor{UI.PST_KEYWORD} in time";
    }
    ...
    {
      public static LocString NAME = (LocString) "Shivering";
      public static LocString TOOLTIP = (LocString) $"This Duplicant was recently exposed to cold {UI.PRE_KEYWORD}Temperatures{UI.PST_KEYWORD} and wants to warm up\n\nWithout a warming station, it will take {{0}} for them to recover\n\nStress: <b>{{StressModification}}</b>\nStamina: <b>{{StaminaModification}}</b>\nAthletics: <b>{{AthleticsModification}}</b>";
    }
    ...
    {
      public static LocString NAME = (LocString) "Sweaty";
      public static LocString TOOLTIP = (LocString) $"This Duplicant was recently exposed to hot {UI.PRE_KEYWORD}Temperatures{UI.PST_KEYWORD} and wants to cool down\n\nWithout a cooling station, it will take {{0}} for them to recover\n\nStress: <b>{{StressModification}}</b>\nStamina: <b>{{StaminaModification}}</b>\nAthletics: <b>{{AthleticsModification}}</b>";
    }
    ...
    {
      public static LocString NAME = (LocString) "Dangerously Frayed";
      public static LocString TOOLTIP = (LocString) $"This Duplicant's hanging by a thread...except the thread is a live wire\n\nImprove this Duplicant's {UI.PRE_KEYWORD}Morale{UI.PST_KEYWORD} before they zap someone";
    }
    ...
    {
      public static LocString NAME = (LocString) "Rock Fan";
      public static LocString TOOLTIP = (LocString) $"This Duplicant is <i>really</i> into meteor showers\n• All {UI.PRE_KEYWORD}Attributes{UI.PST_KEYWORD} <b>+3</b> during meteor showers";
    }
    ...
    public class NOTOILETS
    {
      ...
      public static LocString NOTIFICATION_TOOLTIP = (LocString) $"{UI.FormatAsLink("Outhouses", "OUTHOUSE")} can be built from the {UI.FormatAsBuildMenuTab("Plumbing Tab", Action.Plan5)}.\n\nThese Duplicants are in need of an {UI.FormatAsLink("Outhouse", "OUTHOUSE")}:";
    }
    ...
    {
      public static LocString NAME = (LocString) "Expelling gunk";
      public static LocString TOOLTIP = (LocString) $"This Bionic Duplicant couldn't get to a {UI.FormatAsLink("Gunk Extractor", "GUNKEMPTIER")} in time and got desperate\n\n{UI.FormatAsLink("Gunk Extractors", "GUNKEMPTIER")} can be built from the {UI.FormatAsBuildMenuTab("Plumbing Tab", Action.Plan5)}";
      public static LocString NOTIFICATION_NAME = (LocString) "Expelled gunk";
      public static LocString NOTIFICATION_TOOLTIP = (LocString) $"The {UI.FormatAsTool("Mop Tool", Action.Mop)} can be used to clean up Duplicant-related \"spills\"\n\nThese Duplicants made messes that require cleaning up:\n";
    }
    ...
    public class STRESSVOMITING
    {
      ...
      public static LocString NOTIFICATION_TOOLTIP = (LocString) $"The {UI.FormatAsTool("Mop Tool", Action.Mop)} can used to clean up Duplicant-related \"spills\"\n\nThese Duplicants became so {UI.PRE_KEYWORD}Stressed{UI.PST_KEYWORD} they threw up:";
    }
    ...
    public class RADIATIONVOMITING
    {
      ...
      public static LocString NOTIFICATION_TOOLTIP = (LocString) $"The {UI.FormatAsTool("Mop Tool", Action.Mop)} can clean up Duplicant-related \"spills\"\n\nRadiation Sickness caused these Duplicants to throw up:";
    }
    ...
    {
      public static LocString NAME = (LocString) "Oxygen Tank: {ConsumptionRate} O<sub>2</sub>";
      public static LocString TOOLTIP = (LocString) $"Bionic Duplicants consume {UI.FormatAsLink("Oxygen", "OXYGEN")} from their internal tanks";
    }
    ...
    {
      public static LocString NAME = (LocString) "Watching Flash Mobber";
      public static LocString STATUS = (LocString) "Watching Flash Mobber";
      public static LocString TOOLTIP = (LocString) "This Duplicant is blown away by their friend's dance moves!";
    }
    ...
    {
      public static LocString NAME = (LocString) "Unlocking Research";
      public static LocString TOOLTIP = (LocString) "This Duplicant is unlocking crucial technology";
    }
    ...
    public class SPICING
    {
      ...
      public static LocString TOOLTIP = (LocString) "This Duplicant is making a tasty meal even tastier";
    }
    ...
    {
      public static LocString NAME = (LocString) "Rescuing Bionic Friend";
      public static LocString TOOLTIP = (LocString) "This Duplicant is rebooting a powerless Bionic Duplicant";
    }
    ...
    {
      public static LocString NOTIFICATION_NAME = (LocString) "Dowsing Complete: Geyser Discovered";
      public static LocString NOTIFICATION_TOOLTIP = (LocString) "Click to see the geyser recently discovered by a Bionic Duplicant";
      public static LocString NAME = (LocString) "Dowsing {0}";
      public static LocString TOOLTIP = (LocString) "This Duplicant's always gathering geodata\n\nWhen dowsing is complete, a new geyser will be revealed in the world";
    }
    ...
    {
      public static LocString NAME = (LocString) "Carving {Target}";
      public static LocString TOOLTIP = (LocString) "This Duplicant is carving away at a <b>{Target}</b>";
    }

    public class DATARAINERPLANNING
    {
      public static LocString NAME = (LocString) "Rainmaker";
      public static LocString TOOLTIP = (LocString) "This Duplicant is planning to dish out microchips in their downtime";
    }

    public class DATARAINERRAINING
    {
      public static LocString NAME = (LocString) "Rainmaker";
      public static LocString TOOLTIP = (LocString) "This Duplicant is making it \"rain\" microchips";
    }

    public class ROBODANCERPLANNING
    {
      public static LocString NAME = (LocString) "Flash Mobber";
      public static LocString TOOLTIP = (LocString) "This Duplicant is planning to show off their dance moves in their downtime";
    }

    public class ROBODANCERDANCING
    {
      public static LocString NAME = (LocString) "Flash Mobber";
      public static LocString TOOLTIP = (LocString) "This Duplicant is showing off their dance moves to other Duplicants";
    }

    public class BIONICCRITICALBATTERY
    {
      public static LocString NAME = (LocString) "Critical Power Level";
      public static LocString TOOLTIP = (LocString) $"This Duplicant's {UI.PRE_KEYWORD}Power{UI.PST_KEYWORD} is dangerously low\n\nThey will become incapacitated unless new {UI.PRE_KEYWORD}Power Banks{UI.PST_KEYWORD} are delivered";
      public static LocString NOTIFICATION_NAME = (LocString) "Critical Power Level";
      public static LocString NOTIFICATION_TOOLTIP = (LocString) $"These Duplicants will become incapacitated if they can't find {UI.PRE_KEYWORD}Power Banks{UI.PST_KEYWORD}:";
    }
    ...
    public class REMOTEWORKER
    {
      ...
      {
        public static LocString NAME = (LocString) "Docking";
        public static LocString TOOLTIP = (LocString) "This remote worker is entering its dock";
      }

      public class UNREACHABLEDOCK
      {
        public static LocString NAME = (LocString) "Unreachable Dock";
        public static LocString TOOLTIP = (LocString) "This remote worker cannot reach its dock";
      }

      public class NOHOMEDOCK
      {
        public static LocString NAME = (LocString) "No Dock";
        public static LocString TOOLTIP = (LocString) "This remote worker has no home dock and will self-destruct";
      }

      public class POWERSTATUS
      {
        public static LocString NAME = (LocString) "Power Remaining: {CHARGE} ({RATIO})";
        public static LocString TOOLTIP = (LocString) $"This remote worker has {{CHARGE}} remaining power\n\nWhen {UI.PRE_KEYWORD}Power{UI.PST_KEYWORD} gets low, the remote worker will return to its dock to recharge";
      }

      public class LOWPOWER
      {
        public static LocString NAME = (LocString) "Low Power";
        public static LocString TOOLTIP = (LocString) $"This remote worker has low {UI.PRE_KEYWORD}Power{UI.PST_KEYWORD}\n\nIt will recharge at its dock before accepting new chores";
      }

      public class OUTOFPOWER
      {
        public static LocString NAME = (LocString) "No Power";
        public static LocString TOOLTIP = (LocString) $"This remote worker cannot function without {UI.PRE_KEYWORD}Power{UI.PST_KEYWORD}\n\nIt must be returned to its dock";
      }

      public class HIGHGUNK
      {
        public static LocString NAME = (LocString) "Gunk Buildup";
        public static LocString TOOLTIP = (LocString) $"This remote worker will return to its dock to remove {UI.PRE_KEYWORD}Gunk{UI.PST_KEYWORD} buildup before accepting new chores";
      }

      public class FULLGUNK
      {
        public static LocString NAME = (LocString) "Gunk Clogged";
        public static LocString TOOLTIP = (LocString) $"This remote worker cannot function due to excessive {UI.PRE_KEYWORD}Gunk{UI.PST_KEYWORD} buildup\n\nIt must be returned to its dock";
      }

      public class LOWOIL
      {
        public static LocString NAME = (LocString) "Low Gear Oil";
        public static LocString TOOLTIP = (LocString) "This remote worker is low on gear oil\n\nIt will dock to replenish its stores before accepting new chores";
      }

      public class OUTOFOIL
      {
        public static LocString NAME = (LocString) "No Gear Oil";
        public static LocString TOOLTIP = (LocString) $"This remote worker cannot function without {UI.PRE_KEYWORD}Gear Oil{UI.PST_KEYWORD}\n\nIt must be returned to its dock";
      }

      public class RECHARGING
      {
        public static LocString NAME = (LocString) "Recharging";
        public static LocString TOOLTIP = (LocString) "This remote worker is recharging its capacitor";
      }

      public class OILING
      {
        public static LocString NAME = (LocString) "Refilling Gear Oil";
        public static LocString TOOLTIP = (LocString) "This remote worker is lubricating its joints";
      }

      public class DRAINING
      {
        public static LocString NAME = (LocString) "Draining Gunk";
        public static LocString TOOLTIP = (LocString) "This remote worker is unclogging its gears";
      }
    }
  }
  ...
  public class DISEASES
  {
    ...
    public static LocString ATTRIBUTE_BY_MODEL_MODIFIER_SYMPTOMS = (LocString) "({0}) {1}: {2}";
  ...
  public class MODIFIERS
  {
    ...
    public static LocString IMMUNITY_FORMAT = (LocString) $"{UI.PRE_KEYWORD}{{0}}{UI.PST_KEYWORD}";
    public static LocString TIME_REMAINING = (LocString) "Time Remaining: {0}";
    public static LocString TIME_TOTAL = (LocString) "\nDuration: {0}";
    public static LocString EFFECT_IMMUNITIES_HEADER = (LocString) $"{UI.PRE_POS_MODIFIER}Immune to:{UI.PST_POS_MODIFIER}";
    public static LocString EFFECT_HEADER = (LocString) $"{UI.PRE_POS_MODIFIER}Effects:{UI.PST_POS_MODIFIER}";

    public class BREAK_BONUS
    {
      public static LocString NAME = (LocString) "Downtime Bonus";
      public static LocString MAX_NAME = (LocString) "Max Downtime Bonus";
    }
    ...
    {
      public static LocString NAME = (LocString) "Fresh Oil";
      public static LocString TOOLTIP = (LocString) $"This Duplicant recently used a {(string) BUILDINGS.PREFABS.OILCHANGER.NAME} and feels pretty slick";
    }
    ...
    {
      public static LocString NAME = (LocString) "Luxury Barracks";
      public static LocString TOOLTIP = (LocString) $"This Duplicant slept in a {UI.PRE_KEYWORD}Luxury Barracks{UI.PST_KEYWORD} last night and feels extra refreshed";
    }

    public class ROOMPRIVATEBEDROOM
    {
      public static LocString NAME = (LocString) "Private Bedroom";
      public static LocString TOOLTIP = (LocString) $"This Duplicant slept in a {UI.PRE_KEYWORD}Private Bedroom{UI.PST_KEYWORD} last night and feels super refreshed";
    }
    ...
    {
      public static LocString NAME = (LocString) "Chilly Surroundings";
      public static LocString CAUSE = (LocString) "Duplicants tire quickly and lose body heat in cold environments";
    }
    ...
    {
      public static LocString NAME = (LocString) "Frost Resistant";
      public static LocString TOOLTIP = (LocString) $"This Duplicant recently visited a warming station, sauna, or hot tub\n\nThey are impervious to {UI.PRE_KEYWORD}Chilly Surroundings{UI.PST_KEYWORD} and {UI.PRE_KEYWORD}Soggy Feet{UI.PST_KEYWORD} as a result";
      public static LocString PROVIDERS_NAME = (LocString) "Frost Resistance";
      public static LocString PROVIDERS_TOOLTIP = (LocString) $"Using this building provides temporary immunity to {UI.PRE_KEYWORD}Chilly Surroundings{UI.PST_KEYWORD} and {UI.PRE_KEYWORD}Soggy Feet{UI.PST_KEYWORD}";
    }

    public class REFRESHINGTOUCH
    {
      public static LocString NAME = (LocString) "Heat Resistant";
      public static LocString TOOLTIP = (LocString) $"This Duplicant recently visited a cooling station and is impervious to {UI.PRE_KEYWORD}Toasty Surroundings{UI.PST_KEYWORD} as a result";
    }

    public class GUNKSICK
    {
      public static LocString NAME = (LocString) "Gunk Extraction Required";
      public static LocString TOOLTIP = (LocString) $"This Duplicant needs to visit a {UI.PRE_KEYWORD}Gunk Extractor{UI.PST_KEYWORD} as soon as possible\n\nThey will use a toilet as a last resort";
    }

    public class EXPELLINGGUNK
    {
      public static LocString NAME = (LocString) "Making a mess";
      public static LocString TOOLTIP = (LocString) "This Duplicant just couldn't hold it all in anymore";
    }

    public class GUNKHUNGOVER
    {
      public static LocString NAME = (LocString) "Gunk Mouth";
      public static LocString TOOLTIP = (LocString) $"This Duplicant recently expelled built-up {UI.PRE_KEYWORD}Gunk{UI.PST_KEYWORD} and can still taste it";
    }

    public class NOLUBRICATIONMINOR
    {
      public static LocString NAME = (LocString) "Grinding Gears (Reduced)";
      public static LocString TOOLTIP = (LocString) $"This Duplicant's out of {UI.PRE_KEYWORD}Gear Oil{UI.PST_KEYWORD} and cannot function properly\n\nThey need to find {UI.PRE_KEYWORD}Gear Balm{UI.PST_KEYWORD} or visit a {UI.PRE_KEYWORD}Lubrication Station{UI.PST_KEYWORD} as soon as possible";
    }

    public class NOLUBRICATIONMAJOR
    {
      public static LocString NAME = (LocString) "Grinding Gears";
      public static LocString TOOLTIP = (LocString) $"This Duplicant's out of {UI.PRE_KEYWORD}Gear Oil{UI.PST_KEYWORD} and cannot function properly\n\nThey need to find {UI.PRE_KEYWORD}Gear Balm{UI.PST_KEYWORD} or visit a {UI.PRE_KEYWORD}Lubrication Station{UI.PST_KEYWORD} as soon as possible";
    }
    ...
    {
      public static LocString NAME = (LocString) "Liquid Exposure";
      public static LocString TOOLTIP = (LocString) $"This Duplicant's bionic parts are currently in contact with incompatible {UI.PRE_KEYWORD}Liquids{UI.PST_KEYWORD}\n\nProlonged exposure could have serious {UI.PRE_KEYWORD}Stress{UI.PST_KEYWORD} consequences";
    }

    public class SLIPPED
    {
      public static LocString NAME = (LocString) "Slipped";
      public static LocString TOOLTIP = (LocString) "This Duplicant recently lost their footing on a slippery floor and feels embarrassed";
    }

    public class BIONICBEDTIMEEFFECT
    {
      public static LocString NAME = (LocString) "Defragmenting";
      public static LocString TOOLTIP = (LocString) "This Duplicant is decluttering their internal data cache\n\nIt's helping them relax";
    }

    public class DUPLICANTGOTMILK
    {
      public static LocString NAME = (LocString) "Extra Hydrated";
      public static LocString TOOLTIP = (LocString) $"This Duplicant recently drank {UI.PRE_KEYWORD}Brackene{UI.PST_KEYWORD}. It's helping them relax";
    }
    ...
    {
      public static LocString NAME = (LocString) "Frost Resistant: Spicy Diet";
      public static LocString TOOLTIP = (LocString) "This Duplicant ate spicy food and feels so warm inside that they don't even notice the cold right now";
      public static LocString CAUSE = (LocString) "Obtained by eating a very spicy meal";
      public static LocString DESCRIPTION = (LocString) $"Eating this provides temporary immunity to {UI.PRE_KEYWORD}Chilly Surroundings{UI.PST_KEYWORD} and {UI.PRE_KEYWORD}Soggy Feet{UI.PST_KEYWORD}";
    }
    ...
    {
      public static LocString NAME = (LocString) "Shocking Temper";
      public static LocString TOOLTIP = (LocString) $"This Duplicant is short-circuiting as a result of {UI.PRE_KEYWORD}Stress{UI.PST_KEYWORD}";
      public static LocString NOTIFICATION_NAME = (LocString) "Stress Zapping";
      public static LocString NOTIFICATION_TOOLTIP = (LocString) $"These Duplicants became so {UI.FormatAsLink("Stressed", "STRESS")} they began emitting electrical zaps:";
    }
    ...
    {
      public static LocString NAME = (LocString) "Wattage";
      public static LocString BASE_NAME = (LocString) "Base";
      public static LocString SAVING_MODE_NAME = (LocString) "Standby Mode";

      public class TOOLTIP
      {
        public static LocString ESTIMATED_LIFE_TIME_REMAINING = (LocString) $"Estimated {UI.PRE_KEYWORD}Power{UI.PST_KEYWORD} supply remaining: {{0}}";
        public static LocString ELECTROBANK_DETAILS_LABEL = (LocString) "Total Electrobanks {0} / {1}";
        public static LocString ELECTROBANK_ROW = (LocString) "{0} {1}: {2}";
        public static LocString ELECTROBANK_EMPTY_ROW = (LocString) "{0} Empty";
        public static LocString CURRENT_WATTAGE_LABEL = (LocString) "Current Wattage: {0}";
        public static LocString POTENTIAL_EXTRA_WATTAGE_LABEL = (LocString) "Potential Wattage: {0}";
        public static LocString STANDARD_ACTIVE_TEMPLATE = (LocString) "{0}: {1}";
        public static LocString STANDARD_INACTIVE_TEMPLATE = (LocString) "{0}: {1}";
      }
    }
    ...
    {
      public static LocString NAME = (LocString) "Low Oxygen Tank";
      public static LocString TOOLTIP = (LocString) $"This Duplicant's internal {UI.PRE_KEYWORD}Oxygen{UI.PST_KEYWORD} tank is dangerously low";
    }
    ...
    {
      public static LocString NAME = (LocString) "Unrested: Cold Bedroom";
      public static LocString TOOLTIP = (LocString) "This Duplicant was shivering instead of sleeping";
    }

    public class BADSLEEPDEFRAGMENTING
    {
      public static LocString NAME = (LocString) "Unrested: Too Bright";
      public static LocString TOOLTIP = (LocString) $"This Duplicant kept waking up because of the {UI.PRE_KEYWORD}Light{UI.PST_KEYWORD} produced by a Bionic Duplicant defragmenting nearby";
    }
    ...
    {
      public static LocString NAME = (LocString) "Light Wounds";
      public static LocString TOOLTIP = (LocString) "This Critter sustained injuries that are a bit uncomfortable";
    }

    public class MODERATEWOUNDSCRITTER
    {
      public static LocString NAME = (LocString) "Moderate Wounds";
      public static LocString TOOLTIP = (LocString) "This Critter sustained injuries that are really affecting their health";
    }

    public class SEVEREWOUNDSCRITTER
    {
      public static LocString NAME = (LocString) "Severe Wounds";
      public static LocString TOOLTIP = (LocString) "This Critter sustained serious injuries that could prove life-threatening";
    }
    ...
    {
      public static LocString NAME = (LocString) "Ate frozen food";
      public static LocString TOOLTIP = (LocString) $"This Duplicant is in a bad mood from having to eat deep-frozen {UI.PRE_KEYWORD}Food{UI.PST_KEYWORD}";
    }
    ...
    {
      public static LocString NAME = (LocString) "Sticker Bombing";
      public static LocString TOOLTIP = (LocString) "This Duplicant is slapping stickers onto everything!\n\nEveryone's gonna love these";
    }
    ...
    {
      public static LocString NAME = (LocString) "Doing the Robot";
      public static LocString TOOLTIP = (LocString) "This Duplicant is dancing like everybody's watching\n\nThey're a flash mob of one!";
    }

    public class SAWROBODANCER
    {
      public static LocString NAME = (LocString) "Hyped";
      public static LocString TOOLTIP = (LocString) "A Flash Mobber's dance moves wowed this Duplicant\n\nThis Duplicant feels amped up now!";
    }
    ...
    public class BREAKX
    {
      public static LocString NAME = (LocString) "{0} Shift Break";
    }

    public class BREAKX_BIONIC
    {
      public static LocString NAME = (LocString) "{0} Shift Break (Bionic)";
    }
    ...
    public class LONER
    {
      ...
      public static LocString TOOLTIP = (LocString) "This Duplicant is feeling more focused now that they're alone";
    }
  ...
  public class TRAITS
  {
    ...
    public static LocString STARTING_BIONIC_BOOSTER_SHARED_DESC_TOOLTIP = (LocString) $"Bionic Duplicants use boosters to increase their skills and attributes\n\nBoosters can be crafted at the {(string) BUILDINGS.PREFABS.CRAFTINGTABLE.NAME} and {(string) BUILDINGS.PREFABS.ADVANCEDCRAFTINGTABLE.NAME}\n\nPreinstalled booster effects:";
    ...
    public class STRESSSHOCKER
    {
      public static LocString NAME = (LocString) "Stunner";
      public static LocString DESC = (LocString) $"This Duplicant emits electrical shocks when {UI.PRE_KEYWORD}Stressed{UI.PST_KEYWORD}";
      public static LocString DRAIN_ATTRIBUTE = (LocString) "Stress Zapping";
    }
    ...
    {
      public static LocString NAME = (LocString) "Rainmaker";
      public static LocString DESC = (LocString) $"This Duplicant distributes microchips when they are {UI.PRE_KEYWORD}Overjoyed{UI.PST_KEYWORD}";
    }

    public class ROBODANCER
    {
      public static LocString NAME = (LocString) "Flash Mobber";
      public static LocString DESC = (LocString) $"This Duplicant breaks into dance when they are {UI.PRE_KEYWORD}Overjoyed{UI.PST_KEYWORD}";
    }
    ...
    {
      public static LocString NAME = (LocString) "Rock Fan";
      public static LocString DESC = (LocString) "Meteor showers get this Duplicant really, really hyped";
      public static LocString EXTENDED_DESC = (LocString) $"• During meteor showers: <b>{{0}}</b> bonus to all {UI.PRE_KEYWORD}Attributes{UI.PST_KEYWORD}";
      public static LocString SHORT_DESC = (LocString) "Gains Attribute bonuses during meteor showers.";
      public static LocString SHORT_DESC_TOOLTIP = (LocString) $"During meteor showers: <b>+3</b> bonus to all {UI.PRE_KEYWORD}Attributes{UI.PST_KEYWORD}";
    }
    ...
    {
      public static LocString NAME = (LocString) "Frost Proof";
      public static LocString DESC = (LocString) "This Duplicant is too cool to be bothered by the cold";
    }
    ...
    {
      public static LocString NAME = (LocString) ((string) DUPLICANTS.TRAITS.GRANTED_SKILL_SHARED_NAME + (string) DUPLICANTS.ROLES.PYROTECHNIC.NAME);
    ...
    public class STARTWITHBOOSTER_DIG1
    {
      ...
      public static LocString SHORT_DESC = (LocString) $"Starts with a preinstalled <b>{(string) ITEMS.BIONIC_BOOSTERS.BOOSTER_DIG1.NAME}</b>";
    ...
    public class STARTWITHBOOSTER_CONSTRUCT1
    {
      ...
      public static LocString SHORT_DESC = (LocString) $"Starts with a preinstalled <b>{(string) ITEMS.BIONIC_BOOSTERS.BOOSTER_CONSTRUCT1.NAME}</b>";
      public static LocString SHORT_DESC_TOOLTIP = DUPLICANTS.TRAITS.STARTING_BIONIC_BOOSTER_SHARED_DESC_TOOLTIP;
    }
    ...
    public class STARTWITHBOOSTER_CARRY1
    {
      ...
      public static LocString SHORT_DESC = (LocString) $"Starts with a preinstalled <b>{(string) ITEMS.BIONIC_BOOSTERS.BOOSTER_CARRY1.NAME}</b>";
      public static LocString SHORT_DESC_TOOLTIP = DUPLICANTS.TRAITS.STARTING_BIONIC_BOOSTER_SHARED_DESC_TOOLTIP;
    }
    ...
    public class STARTWITHBOOSTER_MEDICINE1
    {
      ...
      public static LocString SHORT_DESC = (LocString) $"Starts with a preinstalled <b>{(string) ITEMS.BIONIC_BOOSTERS.BOOSTER_MEDICINE1.NAME}</b>";
      public static LocString SHORT_DESC_TOOLTIP = DUPLICANTS.TRAITS.STARTING_BIONIC_BOOSTER_SHARED_DESC_TOOLTIP;
    }
    ...
    public class STARTWITHBOOSTER_DIG2
    {
      ...
      public static LocString SHORT_DESC = (LocString) $"Starts with a preinstalled <b>{(string) ITEMS.BIONIC_BOOSTERS.BOOSTER_DIG2.NAME}</b>";
      public static LocString SHORT_DESC_TOOLTIP = DUPLICANTS.TRAITS.STARTING_BIONIC_BOOSTER_SHARED_DESC_TOOLTIP;
    }
    ...
    public class STARTWITHBOOSTER_FARM1
    {
      ...
      public static LocString SHORT_DESC = (LocString) $"Starts with a preinstalled <b>{(string) ITEMS.BIONIC_BOOSTERS.BOOSTER_FARM1.NAME}</b>";
      public static LocString SHORT_DESC_TOOLTIP = DUPLICANTS.TRAITS.STARTING_BIONIC_BOOSTER_SHARED_DESC_TOOLTIP;
    }
    ...
    public class STARTWITHBOOSTER_RANCH1
    {
      ...
      public static LocString SHORT_DESC = (LocString) $"Starts with a preinstalled <b>{(string) ITEMS.BIONIC_BOOSTERS.BOOSTER_RANCH1.NAME}</b>";
      public static LocString SHORT_DESC_TOOLTIP = DUPLICANTS.TRAITS.STARTING_BIONIC_BOOSTER_SHARED_DESC_TOOLTIP;
    }
    ...
    public class STARTWITHBOOSTER_COOK1
    {
      ...
      public static LocString SHORT_DESC = (LocString) $"Starts with a preinstalled <b>{(string) ITEMS.BIONIC_BOOSTERS.BOOSTER_COOK1.NAME}</b>";
      public static LocString SHORT_DESC_TOOLTIP = DUPLICANTS.TRAITS.STARTING_BIONIC_BOOSTER_SHARED_DESC_TOOLTIP;
    }
    ...
    public class STARTWITHBOOSTER_OP1
    {
      ...
      public static LocString SHORT_DESC = (LocString) $"Starts with a preinstalled <b>{(string) ITEMS.BIONIC_BOOSTERS.BOOSTER_OP1.NAME}</b>";
      public static LocString SHORT_DESC_TOOLTIP = DUPLICANTS.TRAITS.STARTING_BIONIC_BOOSTER_SHARED_DESC_TOOLTIP;
    }
    ...
    public class STARTWITHBOOSTER_ART1
    {
      ...
      public static LocString SHORT_DESC = (LocString) $"Starts with a preinstalled <b>{(string) ITEMS.BIONIC_BOOSTERS.BOOSTER_ART1.NAME}</b>";
      public static LocString SHORT_DESC_TOOLTIP = DUPLICANTS.TRAITS.STARTING_BIONIC_BOOSTER_SHARED_DESC_TOOLTIP;
    }
    ...
    public class STARTWITHBOOSTER_SUITS1
    {
      ...
      public static LocString SHORT_DESC = (LocString) $"Starts with a preinstalled <b>{(string) ITEMS.BIONIC_BOOSTERS.BOOSTER_SUITS1.NAME}</b>";
      public static LocString SHORT_DESC_TOOLTIP = DUPLICANTS.TRAITS.STARTING_BIONIC_BOOSTER_SHARED_DESC_TOOLTIP;
    }

    public class BIONICBUG1
    {
      public static LocString NAME = (LocString) "Bionic Bug: Rigid Thinking";
      public static LocString DESC = (LocString) "This Duplicant's bionic systems are quite inflexible";
      public static LocString SHORT_DESC = (LocString) "No passive attribute leveling";
      public static LocString SHORT_DESC_TOOLTIP = (LocString) "Does not level up attributes while performing errands\n\nRequires boosters to improve skills";
    }

    public class BIONICBUG2
    {
      public static LocString NAME = (LocString) "Bionic Bug: Dissociative";
      public static LocString DESC = (LocString) "This Duplicant's bionic systems are built without \"connector\" parts";
      public static LocString SHORT_DESC = (LocString) "No passive attribute leveling";
      public static LocString SHORT_DESC_TOOLTIP = (LocString) "Does not level up attributes while performing errands\n\nRequires boosters to improve skills";
    }
    ...
    {
      public static LocString NAME = (LocString) "Bionic Bug: All Thumbs";
      public static LocString DESC = (LocString) "This Duplicant's bionic systems aren't designed to operate other systems";
      public static LocString SHORT_DESC = (LocString) "No passive attribute leveling";
      public static LocString SHORT_DESC_TOOLTIP = (LocString) "Does not level up attributes while performing errands\n\nRequires boosters to improve skills";
    }
    ...
    {
      public static LocString NAME = (LocString) "Bionic Bug: Overengineered";
      public static LocString DESC = (LocString) "This Duplicant's bionic systems rarely get past the processing stage";
      public static LocString SHORT_DESC = (LocString) "No passive attribute leveling";
      public static LocString SHORT_DESC_TOOLTIP = (LocString) "Does not level up attributes while performing errands\n\nRequires boosters to improve skills";
    }
    ...
    {
      public static LocString NAME = (LocString) "Bionic Bug: Late Bloomer";
      public static LocString DESC = (LocString) "This Duplicant's bionic systems weren't built for speed";
      public static LocString SHORT_DESC = (LocString) "No passive attribute leveling";
      public static LocString SHORT_DESC_TOOLTIP = (LocString) "Does not level up attributes while performing errands\n\nRequires boosters to improve skills";
    }
    ...
    {
      public static LocString NAME = (LocString) "Bionic Bug: Urbanite";
      public static LocString DESC = (LocString) "This Duplicant's bionic systems were designed by someone who'd never seen a plant in real life";
      public static LocString SHORT_DESC = (LocString) "No passive attribute leveling";
      public static LocString SHORT_DESC_TOOLTIP = (LocString) "Does not level up attributes while performing errands\n\nRequires boosters to improve skills";
    }
    ...
    {
      public static LocString NAME = (LocString) "Bionic Bug: Error Prone";
      public static LocString DESC = (LocString) "This Duplicant's bionic systems err on the side of erring";
      public static LocString SHORT_DESC = (LocString) "No passive attribute leveling";
      public static LocString SHORT_DESC_TOOLTIP = (LocString) "Does not level up attributes while performing errands\n\nRequires boosters to improve skills";
    }
  }
  ...
  public class PERSONALITIES
  {
    ...
    public class JORGE
    {
      ...
      public static LocString DESC = (LocString) "{0} loves his new colony, even if their collective body odor makes his eyes water.";
    }

    public class FREYJA
    {
      public static LocString NAME = (LocString) "Freyja";
      public static LocString DESC = (LocString) "This {0} has never stopped anyone from eating yellow snow.";
    }

    public class CHIP
    {
      public static LocString NAME = (LocString) "Chip";
      public static LocString DESC = (LocString) "This {0} is extremely good at guessing their friends' passwords.";
    }

    public class EDWIREDO
    {
      public static LocString NAME = (LocString) "Edwiredo";
      public static LocString DESC = (LocString) "This {0} once rolled his eye so hard that he powered himself off and on again.";
    }

    public class GIZMO
    {
      public static LocString NAME = (LocString) "Gizmo";
      public static LocString DESC = (LocString) "{0}s love nothing more than a big juicy info dump.";
    }

    public class STEELA
    {
      public static LocString NAME = (LocString) "Steela";
      public static LocString DESC = (LocString) "{0}s aren't programmed to put up with nonsense, but they do enjoy the occasional shenanigan.";
    }

    public class SONYAR
    {
      public static LocString NAME = (LocString) "Sonyar";
      public static LocString DESC = (LocString) "{0}s would sooner burn down the colony than read an instruction manual.";
    }

    public class ULTI
    {
      public static LocString NAME = (LocString) "Ulti";
      public static LocString DESC = (LocString) "This {0}'s favorite dance move is The Robot. They don't get why others think that's funny.";
    }

    public class HIGBY
    {
      public static LocString NAME = (LocString) "Higby";
      public static LocString DESC = (LocString) "This {0}'s got a song in his heart. Now if only he could remember how it goes.";
    }

    public class MAYA
    {
      public static LocString NAME = (LocString) "Maya";
      public static LocString DESC = (LocString) "This {0} got her hand crushed in a pneumatic door once. It was the most alive she's ever felt.";
    }
  }
  ...
  public class ATTRIBUTES
  {
    ...
    {
      public static LocString NAME = (LocString) "Frostbite Threshold";
      public static LocString DESC = (LocString) $"Determines the {UI.PRE_KEYWORD}Temperature{UI.PST_KEYWORD} at which a Duplicant will get frostbitten.";
    }
    ...
    {
      public static LocString NAME = (LocString) "Luminescence";
      public static LocString DESC = (LocString) "Determines how much light a Duplicant emits.";
    }

    public class TRANSITTUBETRAVELSPEED
    {
      public static LocString NAME = (LocString) "Transit Speed";
      public static LocString DESC = (LocString) $"Determines a Duplicant's default {(string) BUILDINGS.PREFABS.TRAVELTUBE.NAME} travel speed.";
      public static LocString SPEEDMODIFIER = (LocString) "{0} Transit Tube Travel Speed";
    }
    ...
    {
      public static LocString NAME = (LocString) "Gear Oil";
      public static LocString DESC = (LocString) $"Determines how quickly a Duplicant's bionic parts lose {UI.PRE_KEYWORD}Gear Oil{UI.PST_KEYWORD}";
    }
    ...
    public class METABOLISM
    {
      ...
      public static LocString DESC = (LocString) $"Affects the rate at which a critter burns {UI.PRE_KEYWORD}Calories{UI.PST_KEYWORD} and produces materials";
    }
    ...
    {
      public static LocString NAME = (LocString) "Booster Slots";
      public static LocString DESC = (LocString) "The number of boosters this Bionic Duplicant can install at once";
    }

    public class BIONICBATTERYCOUNTCAPACITY
    {
      public static LocString NAME = (LocString) "Power Banks";
      public static LocString DESC = (LocString) "The number of power banks this Bionic Duplicant can store";
    }
  }
  ...
  public class ROLES
  {
    ...
    public class JUNIOR_COOK
    {
      ...
      public static LocString DESCRIPTION = (LocString) $"Allows Duplicants to cook using the {(string) BUILDINGS.PREFABS.COOKINGSTATION.NAME}, {(string) BUILDINGS.PREFABS.GOURMETCOOKINGSTATION.NAME}, and {(string) BUILDINGS.PREFABS.DEEPFRYER.NAME}";
    }
    ...
    {
      public static LocString NAME = (LocString) UI.FormatAsLink("Pyrotechnics", "PYROTECHNICS");
      public static LocString DESCRIPTION = (LocString) $"Allows a Duplicant to make {UI.PRE_KEYWORD}Blastshot{UI.PST_KEYWORD} for the {UI.PRE_KEYWORD}Meteor Blaster{UI.PST_KEYWORD}";
    }
    ...
    {
      public static LocString NAME = (LocString) UI.FormatAsLink("Booster Processing I", nameof (BIONICS_A1));
      public static LocString DESCRIPTION = (LocString) "Allows Bionic Duplicants to install an additional booster.";
    }

    public class BIONICS_A2
    {
      public static LocString NAME = (LocString) UI.FormatAsLink("Booster Processing II", nameof (BIONICS_A2));
      public static LocString DESCRIPTION = (LocString) "Allows Bionic Duplicants to install an additional booster, and increases runspeed.";
    }

    public class BIONICS_A3
    {
      public static LocString NAME = (LocString) UI.FormatAsLink("Complex Processing", nameof (BIONICS_A3));
      public static LocString DESCRIPTION = (LocString) "Allows Bionic Duplicants to install an additional booster, and reduces the runspeed loss experienced while wearing exosuits.";
    }

    public class BIONICS_B1
    {
      public static LocString NAME = (LocString) UI.FormatAsLink("Improved Gears I", nameof (BIONICS_B1));
      public static LocString DESCRIPTION = (LocString) $"Significantly reduces the negative impacts of low {UI.FormatAsLink("Gear Oil", "LUBRICATINGOIL")}.";
    }

    public class BIONICS_B2
    {
      public static LocString NAME = (LocString) UI.FormatAsLink("Improved Gears II", nameof (BIONICS_B2));
      public static LocString DESCRIPTION = (LocString) "Allows Bionic Duplicants to install an additional booster.";
    }

    public class BIONICS_B3
    {
      public static LocString NAME = (LocString) UI.FormatAsLink("Top Gear", nameof (BIONICS_B3));
      public static LocString DESCRIPTION = (LocString) "Allows Bionic Duplicants to install an additional booster, and eliminates the runspeed loss experienced while wearing exosuits.";
    }

    public class BIONICS_C1
    {
      public static LocString NAME = (LocString) UI.FormatAsLink("Schematics", nameof (BIONICS_C1));
      public static LocString DESCRIPTION = (LocString) $"Allows Bionic Duplicants to perform research using a {(string) BUILDINGS.PREFABS.ADVANCEDRESEARCHCENTER.NAME}, and craft items at the {(string) BUILDINGS.PREFABS.ADVANCEDCRAFTINGTABLE.NAME}.";
    }

    public class BIONICS_C2
    {
      public static LocString NAME = (LocString) UI.FormatAsLink("Advanced Schematics", nameof (BIONICS_C2));
      public static LocString DESCRIPTION = (LocString) "Allows Bionic Duplicants to install an additional booster and increase their runspeed.";
    }

    public class BIONICS_C3
    {
      public static LocString NAME = (LocString) UI.FormatAsLink("Power Banking", nameof (BIONICS_C3));
      public static LocString DESCRIPTION = (LocString) $"Increases {UI.FormatAsLink("Power Bank", "ELECTROBANK")} storage capacity to maximize work time between replacements.";
    }
  }
  ...
  public class THOUGHTS
  {
    ...
    {
      public static LocString TOOLTIP = (LocString) "Expel Gunk";
    }

    public class REFILLOILDESIRE
    {
      public static LocString TOOLTIP = (LocString) "Low Gear Oil";
    }

    public class EXPELLINGSPOILEDOIL
    {
      public static LocString TOOLTIP = (LocString) "Spilling Oil";
    }
