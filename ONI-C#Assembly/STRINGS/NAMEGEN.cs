...
public class NAMEGEN
{
  public class COLONY
  {
    ...
    public class NOUN
    {
      ...
      public static LocString COMET = (LocString) "Meteor";
  ...
  public class WORLD
  {
    public static LocString UNKNOWN_WORLD = (LocString) "Unknown";
    ...
    public class ROOTS
    {
      ...
      public static LocString CERES = (LocString) "Wintr\nPolar\nSubzer\nImpass\nGlac\nBlust\nGelid\nCryo\nIcicl\nSlush\nSleet\nHail\nShivrr\n";
      public static LocString PREHISTORIC = (LocString) "Primor\nPaleo\nDino\nCret\nFoss\nFern\nClaw\nSaur\nBront\nCamb\n";
