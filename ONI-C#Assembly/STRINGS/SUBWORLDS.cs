...
public class SUBWORLDS
{
  ...
  {
    public static LocString NAME = (LocString) "Barren Biome";
  ...
  {
    public static LocString NAME = (LocString) "Forest Biome";
  ...
  {
    public static LocString NAME = (LocString) "Tundra Biome";
  ...
  {
    public static LocString NAME = (LocString) "Jungle Biome";
    public static LocString DESC = (LocString) $"Initial investigations of the Jungle Biome reveal an ecosystem filled with unique flora but centered around {UI.FormatAsLink("Liquid Chlorine", "CHLORINE")} and {UI.FormatAsLink("Hydrogen Gas", "HYDROGEN")} gas, toxic to Duplicants. When exploring here, it is worth setting up a good system.";
  ...
  {
    public static LocString NAME = (LocString) "Magma Biome";
  ...
  {
    public static LocString NAME = (LocString) "Marsh Biome";
    public static LocString DESC = (LocString) $"{UI.FormatAsLink("Polluted Oxygen", "CONTAMINATEDOXYGEN")} dominates the atmosphere of the Marsh Biome as it escapes from the {UI.FormatAsLink("Slime", "SLIMEMOLD")} this biome is known for.";
  ...
  {
    public static LocString NAME = (LocString) "Metallic Biome";
  ...
  {
    public static LocString NAME = (LocString) "Oily Biome";
  ...
  {
    public static LocString NAME = (LocString) "Sandstone Biome";
  ...
  {
    public static LocString NAME = (LocString) "Wasteland Biome";
  ...
  {
    public static LocString NAME = (LocString) "Space Biome";
  ...
  {
    public static LocString NAME = (LocString) "Niobium Biome";
  ...
  {
    public static LocString NAME = (LocString) "Moo Biome";
  ...
  {
    public static LocString NAME = (LocString) "Regolith Biome";
