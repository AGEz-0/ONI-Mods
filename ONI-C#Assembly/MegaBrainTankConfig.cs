...
public class MegaBrainTankConfig : IBuildingConfig
{
  ...
  public override void DoPostConfigureComplete(GameObject go)
  {
    ...
    component1.AddTag(RoomConstraints.ConstraintTags.IndustrialMachinery);
    component1.AddTag(GameTags.Gravitas);
  ...
  private void ConfigureJournalShelf(KPrefabID parentId)
  {
    ...
    component.SetSymbolVisiblity((KAnimHashedString) MegaBrainTankConfig.JOURNAL_SHELF, false);
    for (int index = 0; index < MegaBrainTankConfig.JOURNAL_SYMBOLS.Length; ++index)
    {
      component.SetSymbolVisiblity((KAnimHashedString) MegaBrainTankConfig.JOURNAL_SYMBOLS[index], false);
      controller.SetSymbolVisiblity((KAnimHashedString) MegaBrainTankConfig.JOURNAL_SYMBOLS[index], false);
    }
  }
}
