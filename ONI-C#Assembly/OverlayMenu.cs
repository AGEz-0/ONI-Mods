...
public class OverlayMenu : KIconToggleMenu
{
  ...
  private void InitializeToggles()
  {
    ...
    if (!Sim.IsRadiationEnabled())
      return;
    this.overlayToggleInfos.Add((KIconToggleMenu.ToggleInfo) new OverlayMenu.OverlayToggleInfo((string) UI.OVERLAYS.RADIATION.BUTTON, "overlay_radiation", OverlayModes.Radiation.ID, hotKey: Action.Overlay15, tooltip: (string) UI.TOOLTIPS.RADIATIONOVERLAYSTRING, tooltip_header: (string) UI.OVERLAYS.RADIATION.BUTTON));
  }
