...
label_7:
  ...
  {
    return circuitID == ushort.MaxValue || !(Game.Instance.electricalConduitSystem.GetNetworkByID((int) circuitID) is ElectricalUtilityNetwork networkById) ? 0.0f : networkById.GetMaxSafeWattage();
  }
