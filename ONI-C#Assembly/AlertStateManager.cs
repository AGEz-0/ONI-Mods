  ...
  GameStateMachine<AlertStateManager, AlertStateManager.Instance, IStateMachineTarget, AlertStateManager.Def>
{
  ...
  public new class Instance(IStateMachineTarget master, AlertStateManager.Def def) : 
    GameStateMachine<AlertStateManager, AlertStateManager.Instance, IStateMachineTarget, AlertStateManager.Def>.GameInstance(master, def)
  {
