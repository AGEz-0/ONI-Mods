...
public class PropFacilityHangingLightConfig : IEntityConfig
{
  public GameObject CreatePrefab()
  {
    ...
    GameObject placedEntity = EntityTemplates.CreatePlacedEntity("PropFacilityHangingLight", name, desc, 50f, anim, "off", Grid.SceneLayer.Building, 1, 4, decor, PermittedRotations.R90, noise: noise, additionalTags: new List<Tag>()
    {
      GameTags.Gravitas
    });
