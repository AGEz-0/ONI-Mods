...
public class FilteredStorage
{
  ...
  private void CreateLogicMeter()
  {
    if (!this.hasMeter)
      return;
    this.logicMeter = new MeterController((KAnimControllerBase) this.root.GetComponent<KBatchedAnimController>(), "logicmeter_target", "logicmeter", Meter.Offset.Infront, Grid.SceneLayer.NoLayer, Array.Empty<string>());
  }
  ...
  private bool IsFunctional()
  {
    ...
    return (UnityEngine.Object) component == (UnityEngine.Object) null || component.IsFunctional;
  }
  ...
  private void OnFilterChanged(HashSet<Tag> tags)
  {
    ...
    this.fetchList.Add(tags, this.requiredTag, this.forbiddenTags, amount, Operational.State.Functional);
  ...
  public void AddForbiddenTag(Tag forbidden_tag)
  {
    ...
    if (((IEnumerable<Tag>) this.forbiddenTags).Contains<Tag>(forbidden_tag))
      return;
    this.forbiddenTags = this.forbiddenTags.Append<Tag>(forbidden_tag);
    this.OnFilterChanged(this.filterable.GetTags());
  }
