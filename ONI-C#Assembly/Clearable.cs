...
public class Clearable : Workable, ISaveLoadable, IRender1000ms
{
  ...
  public void MarkForClear(bool restoringFromSave = false, bool allowWhenStored = false)
  {
    ...
    this.pickupable.KPrefabID.AddTag(GameTags.Garbage);
  ...
  {
    if (!this.isClearable || (UnityEngine.Object) this.GetComponent<Health>() != (UnityEngine.Object) null || this.pickupable.KPrefabID.HasTag(GameTags.Stored) || this.pickupable.KPrefabID.HasTag(GameTags.MarkedForMove))
      return;
