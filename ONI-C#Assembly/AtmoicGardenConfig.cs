...
public class AtmoicGardenConfig : IBuildingConfig
{
  ...
  public override BuildingDef CreateBuildingDef()
  {
    ...
    BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef("AtomicGarden", 4, 3, "fertilizer_maker_kanim", 30, 30f, tieR3, allMetals, 800f, BuildLocationRule.OnFloor, tieR2, noise);
