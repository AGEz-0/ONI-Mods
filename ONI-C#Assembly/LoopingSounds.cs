...
public class LoopingSounds : KMonoBehaviour
{
  ...
  {
    return this.StartSound(KFMOD.GetEventReferencePath(event_ref));
  }
  ...
  {
    this.StopSound(KFMOD.GetEventReferencePath(event_ref));
  }
  ...
  {
    this.SetParameter(KFMOD.GetEventReferencePath(event_ref), parameter, value);
  }
