  ...
  ISim200ms
{
  ...
  private static readonly EventSystem.IntraObjectHandler<TravelTubeEntrance> OnRefreshUserMenuDelegate = new EventSystem.IntraObjectHandler<TravelTubeEntrance>((Action<TravelTubeEntrance, object>) ((component, data) => component.OnRefreshUserMenu(data)));
  ...
  public bool HasWaxForGreasyLaunch
  {
    get
    {
      return (double) this.storage.GetAmountAvailable(SimHashes.MilkFat.CreateTag()) >= (double) this.waxPerLaunch;
    }
  }
  ...
  private bool ShouldUseWaxLaunchAnimation => this.deliverAndUseWax && this.HasWaxForGreasyLaunch;
  ...
  public static void SetTravelerGleamEffect(TravelTubeEntrance.SMInstance smi)
  {
    ...
    if (!((UnityEngine.Object) component.worker != (UnityEngine.Object) null))
      return;
    component.worker.GetComponent<KBatchedAnimController>().SetSymbolVisiblity((KAnimHashedString) "gleam", smi.master.ShouldUseWaxLaunchAnimation);
  }

  public static string GetLaunchAnimName(TravelTubeEntrance.SMInstance smi)
  {
    return !smi.master.ShouldUseWaxLaunchAnimation ? "working_pre" : "wax";
  }
  ...
  protected override void OnSpawn()
  {
    ...
    this.tubeChangedEntry = GameScenePartitioner.Instance.Add("TravelTubeEntrance.TubeListener", (object) this.gameObject, extents, GameScenePartitioner.Instance.objectLayers[35], new Action<object>(this.TubeChanged));
    ...
    this.waxMeter = new MeterController((KAnimControllerBase) this.GetComponent<KBatchedAnimController>(), "wax_meter_target", "wax_meter", Meter.Offset.Infront, Grid.SceneLayer.NoLayer, Array.Empty<string>());
    ...
    this.UpdateCharge();
    this.Subscribe<TravelTubeEntrance>(493375141, TravelTubeEntrance.OnRefreshUserMenuDelegate);
  }

  private void OnStorageChanged(object obj) => this.UpdateWaxCharge();
  ...
  private void OnRefreshUserMenu(object data)
  {
    if (!this.deliverAndUseWax)
      Game.Instance.userMenu.AddButton(this.gameObject, new KIconButtonMenu.ButtonInfo("action_speed_up", (string) UI.USERMENUACTIONS.TRANSITTUBEWAX.NAME, (System.Action) (() => this.SetWaxUse(true)), tooltipText: (string) UI.USERMENUACTIONS.TRANSITTUBEWAX.TOOLTIP));
    else
      Game.Instance.userMenu.AddButton(this.gameObject, new KIconButtonMenu.ButtonInfo("action_speed_up", (string) UI.USERMENUACTIONS.CANCELTRANSITTUBEWAX.NAME, (System.Action) (() => this.SetWaxUse(false)), tooltipText: (string) UI.USERMENUACTIONS.CANCELTRANSITTUBEWAX.TOOLTIP));
    KSelectable component = this.GetComponent<KSelectable>();
    bool flag = this.deliverAndUseWax && this.WaxLaunchesAvailable > 0;
    if (!((UnityEngine.Object) component != (UnityEngine.Object) null))
      return;
    if (flag)
      component.AddStatusItem(Db.Get().BuildingStatusItems.TransitTubeEntranceWaxReady, (object) this);
    else
  ...
  public void SetWaxUse(bool usingWax)
  {
    ...
    this.manualDelivery.capacity = usingWax ? this.storage.capacityKg : 0.0f;
    this.manualDelivery.refillMass = usingWax ? this.waxPerLaunch : 0.0f;
    this.manualDelivery.MinimumMass = usingWax ? this.waxPerLaunch : 0.0f;
    if (!usingWax)
  ...
  {
    return this.operational.IsOperational && ((UnityEngine.Object) this.button == (UnityEngine.Object) null || this.button.IsEnabled) && this.energyConsumer.IsExternallyPowered && (double) this.availableJoules < (double) this.jouleCapacity;
  }
  ...
  {
    return this.operational.IsOperational && this.HasLaunchPower && !((UnityEngine.Object) this.launch_workable.worker == (UnityEngine.Object) null) && this.HasChargeSlotReserved(reactor.GetSMI<TubeTraveller.Instance>(), reactor.GetComponent<KPrefabID>().InstanceID);
  }
  ...
  public void ConsumeCharge(GameObject reactor)
  {
    ...
    if (this.deliverAndUseWax && this.HasWaxForGreasyLaunch)
    {
      ...
      if (smi != null)
      {
        ...
        this.storage.ConsumeAndGetDisease(tag, this.waxPerLaunch, out float _, out disease_info, out float _);
        reactor.GetSMI<GermExposureMonitor.Instance>()?.TryInjectDisease(disease_info.idx, disease_info.count, tag, Sickness.InfectionVector.Contact);
  ...
  {
    this.waxMeter.SetPositionPercent(Mathf.Clamp01(this.storage.MassStored() / this.storage.capacityKg));
  }
  ...
  public class SMInstance(TravelTubeEntrance master) : 
    GameStateMachine<TravelTubeEntrance.States, TravelTubeEntrance.SMInstance, TravelTubeEntrance, object>.GameInstance(master)
  {
  }
    ...
    GameStateMachine<TravelTubeEntrance.States, TravelTubeEntrance.SMInstance, TravelTubeEntrance>
  {
    ...
    public override void InitializeStates(out StateMachine.BaseState default_state)
    {
      ...
      this.ready.occupied.PlayAnim(new Func<TravelTubeEntrance.SMInstance, string>(TravelTubeEntrance.GetLaunchAnimName)).QueueAnim("working_loop", true).Enter(new StateMachine<TravelTubeEntrance.States, TravelTubeEntrance.SMInstance, TravelTubeEntrance, object>.State.Callback(TravelTubeEntrance.SetTravelerGleamEffect)).WorkableStopTransition((Func<TravelTubeEntrance.SMInstance, Workable>) (smi => (Workable) smi.GetComponent<TravelTubeEntrance.Work>()), this.ready.post);
  ...
  public class Work : Workable, IGameObjectEffectDescriptor
  {
    ...
    protected override void OnStartWork(WorkerBase worker) => this.SetWorkTime(1f);
  }
}
