...
public class Research : KMonoBehaviour, ISaveLoadable
{
  ...
  {
    return this.techs.Find((Predicate<TechInstance>) (match => match.tech.Id == techID));
  }
  ...
  protected override void OnSpawn()
  {
    ...
    this.OnRolesUpdated((object) null);
  ...
  {
    return this.queuedTech != null && this.queuedTech.Count > 0 ? this.queuedTech[this.queuedTech.Count - 1] : (TechInstance) null;
  }
  ...
  private void UpdateResearcherRoleNotification()
  {
    if (this.NoResearcherRoleNotification != null)
    {
      ...
      this.NoResearcherRoleNotification = (Notification) null;
    }
    ...
    if (tooltip_data == null)
      return;
    this.NoResearcherRoleNotification = new Notification((string) RESEARCH.MESSAGING.NO_RESEARCHER_SKILL, NotificationType.Bad, new Func<List<Notification>, object, string>(this.NoResearcherRoleTooltip), (object) tooltip_data, false, 12f);
  ...
  {
    if ((UnityEngine.Object) Game.Instance != (UnityEngine.Object) null && this.skillsUpdateHandle != -1)
  ...
  private void OnRolesUpdated(object data) => this.UpdateResearcherRoleNotification();
