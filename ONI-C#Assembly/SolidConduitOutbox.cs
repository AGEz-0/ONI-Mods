...
public class SolidConduitOutbox : StateMachineComponent<SolidConduitOutbox.SMInstance>
{
  ...
  public class SMInstance(SolidConduitOutbox master) : 
    GameStateMachine<SolidConduitOutbox.States, SolidConduitOutbox.SMInstance, SolidConduitOutbox, object>.GameInstance(master)
  {
  }
    ...
    GameStateMachine<SolidConduitOutbox.States, SolidConduitOutbox.SMInstance, SolidConduitOutbox>
  {
    ...
    public override void InitializeStates(out StateMachine.BaseState default_state)
    {
      ...
      this.root.Update("RefreshConsuming", (Action<SolidConduitOutbox.SMInstance, float>) ((smi, dt) => smi.master.UpdateConsuming()), UpdateRate.SIM_1000ms);
