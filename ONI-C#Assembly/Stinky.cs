...
public class Stinky : StateMachineComponent<Stinky.StatesInstance>
{
  ...
  private void Emit(object data)
  {
    ...
    float num = Db.Get().Amounts.Temperature.Lookup((Component) this).value;
    ...
    Vector3 vector3 = go.transform.GetPosition();
    float volume = 1f;
  ...
  public class StatesInstance(Stinky master) : 
    GameStateMachine<Stinky.States, Stinky.StatesInstance, Stinky, object>.GameInstance(master)
  {
  }
