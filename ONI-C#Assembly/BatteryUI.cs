...
public class BatteryUI : KMonoBehaviour
{
  ...
  {
    if ((Object) bat == (Object) null || bat.GetMyWorldId() != ClusterManager.Instance.activeWorldId)
    {
    ...
    else
    {
      ...
      Color color = !((Object) component2 != (Object) null) || component2.IsEnabled ? ((double) bat.PercentFull >= (double) bat.PreviousPercentFull ? this.energyIncreaseColor : this.energyDecreaseColor) : Color.gray;
