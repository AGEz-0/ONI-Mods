...
public class PartyChore : Chore<PartyChore.StatesInstance>, IWorkerPrioritizable
{
  ...
  {
    if ((UnityEngine.Object) this.smi.sm.partyer.Get(this.smi) != (UnityEngine.Object) null)
  ...
  public class StatesInstance(PartyChore master) : 
    GameStateMachine<PartyChore.States, PartyChore.StatesInstance, PartyChore, object>.GameInstance(master)
  {
  }
}
