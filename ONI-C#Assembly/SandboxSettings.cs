...
public class SandboxSettings
{
  ...
  {
    this.SetIntSetting(prefsKey, this.intSettings.Find((Predicate<SandboxSettings.Setting<int>>) (match => match.PrefsKey == prefsKey)).defaultValue);
  }
  ...
  {
    this.SetFloatSetting(prefsKey, this.floatSettings.Find((Predicate<SandboxSettings.Setting<float>>) (match => match.PrefsKey == prefsKey)).defaultValue);
  }
  ...
  {
    this.SetStringSetting(prefsKey, this.stringSettings.Find((Predicate<SandboxSettings.Setting<string>>) (match => match.PrefsKey == prefsKey)).defaultValue);
  }
  ...
  public SandboxSettings()
  {
    ...
    this.AddStringSetting("SandboxTools.SelectedStory", (Action<string>) (data =>
    {
