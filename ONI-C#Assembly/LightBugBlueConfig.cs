...
public class LightBugBlueConfig : IEntityConfig
{
    ...
    bool is_baby)
  {
    ...
    go.AddOrGetDef<LureableMonitor.Def>().lures = new Tag[3]
    {
      SimHashes.Phosphorite.CreateTag(),
      SimHashes.Phosphorus.CreateTag(),
  ...
  public GameObject CreatePrefab()
  {
    ...
    EntityTemplates.ExtendEntityToFertileCreature(lightBug, this as IHasDlcRestrictions, "LightBugBlueEgg", (string) STRINGS.CREATURES.SPECIES.LIGHTBUG.VARIANT_BLUE.EGG_NAME, (string) STRINGS.CREATURES.SPECIES.LIGHTBUG.VARIANT_BLUE.DESC, "egg_lightbug_kanim", LightBugTuning.EGG_MASS, "LightBugBlueBaby", 15.000001f, 5f, LightBugTuning.EGG_CHANCES_BLUE, LightBugBlueConfig.EGG_SORT_ORDER);
    return lightBug;
  }
