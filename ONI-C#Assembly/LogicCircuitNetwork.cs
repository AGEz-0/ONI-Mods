...
public class LogicCircuitNetwork : UtilityNetwork
{
  ...
  private void TriggerAudio(int old_value, int id)
  {
    ...
    if (!((UnityEngine.Object) logicWireList[index] != (UnityEngine.Object) null))
      return;
    Vector3 position = logicWireList[index].transform.GetPosition() with
    {
      z = 0.0f
    };
    ...
    int num3 = (int) instance2.setParameterByName("logic_volumeModifer", num2);
    int num4 = (int) instance2.setParameterByName("wireCount", (float) (num1 % 24));
    int num5 = (int) instance2.setParameterByName("enabled", (float) this.outputValue);
  ...
  public List<ILogicEventSender> Senders => this.senders;

  public List<ILogicEventReceiver> Receivers => this.receivers;
