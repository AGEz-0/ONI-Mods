...
public class AccessControlSideScreen : SideScreenContent
{
  ...
  {
    this.ExecuteSort<int>(this.sortByPermissionToggle, state, (Func<MinionAssignablesProxy, int>) (identity => !this.target.IsDefaultPermission(identity) ? (int) this.target.GetSetPermission(identity) : -1));
  }
  ...
  private static class MinionIdentitySort
  {
    ...
    public static int CompareByRole(MinionAssignablesProxy a, MinionAssignablesProxy b)
    {
      ...
      MinionResume component1 = (bool) (UnityEngine.Object) targetGameObject1 ? targetGameObject1.GetComponent<MinionResume>() : (MinionResume) null;
      MinionResume component2 = (bool) (UnityEngine.Object) targetGameObject2 ? targetGameObject2.GetComponent<MinionResume>() : (MinionResume) null;
      if ((UnityEngine.Object) component2 == (UnityEngine.Object) null)
        return 1;
      if ((UnityEngine.Object) component1 == (UnityEngine.Object) null)
        return -1;
      int num = component1.CurrentRole.CompareTo(component2.CurrentRole);
