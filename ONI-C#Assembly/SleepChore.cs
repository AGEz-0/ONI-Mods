...
public class SleepChore : Chore<SleepChore.StatesInstance>
{
  public static readonly Chore.Precondition IsOkayTimeToSleep = new Chore.Precondition()
  {
    ...
    fn = (Chore.PreconditionFn) ((ref Chore.Precondition.Context context, object data) =>
    {
      ...
      int num1 = (UnityEngine.Object) component != (UnityEngine.Object) null ? (component.IsNarcolepsing() ? 1 : 0) : 0;
  ...
  public static void DisplayCustomStatusItemsWhenAsleep(SleepChore.StatesInstance smi)
  {
    ...
    for (int index = 0; index < smi.optional_StatusItemsDisplayedWhileAsleep.Length; ++index)
    {
      StatusItem status_item = smi.optional_StatusItemsDisplayedWhileAsleep[index];
      component.AddStatusItem(status_item);
    }
  }
  ...
  public static void RemoveCustomStatusItemsWhenAsleep(SleepChore.StatesInstance smi)
  {
    ...
    {
      StatusItem status_item = smi.optional_StatusItemsDisplayedWhileAsleep[index];
      component.RemoveStatusItem(status_item);
    }
  }
  ...
  public SleepChore(
    ...
    : this(choreType, target, bed, bedIsLocator, isInterruptable, (StatusItem[]) null)
  {
  }
  ...
  public SleepChore(
    ...
    bool bedIsLocator,
    bool isInterruptable,
    StatusItem[] optional_StatusItemsDisplayedWhileAsleep)
    : base(choreType, target, target.GetComponent<ChoreProvider>(), false, master_priority_class: PriorityScreen.PriorityClass.personalNeeds, report_type: ReportManager.ReportType.PersonalTime)
  {
    ...
    this.smi.optional_StatusItemsDisplayedWhileAsleep = optional_StatusItemsDisplayedWhileAsleep;
    if (isInterruptable)
    ...
    GameStateMachine<SleepChore.States, SleepChore.StatesInstance, SleepChore, object>.GameInstance
  {
    ...
    {
      return (UnityEngine.Object) this.sm.sleeper.Get(this.smi).GetComponent<GlowStick>() != (UnityEngine.Object) null;
    }
    ...
    public void SetAnim()
    {
      ...
      {
        case NavType.Ladder:
          name = "anim_sleep_ladder_kanim";
          break;
        case NavType.Pole:
          name = "anim_sleep_pole_kanim";
          break;
        default:
          name = "anim_sleep_floor_kanim";
          break;
      }
      sleepable.overrideAnims = new KAnimFile[1]
      {
        Assets.GetAnim((HashedString) name)
      };
    }
  }
  ...
  public class States : GameStateMachine<SleepChore.States, SleepChore.StatesInstance, SleepChore>
  {
    ...
    public override void InitializeStates(out StateMachine.BaseState default_state)
    {
      ...
      this.sleep.Enter("SetAnims", (StateMachine<SleepChore.States, SleepChore.StatesInstance, SleepChore, object>.State.Callback) (smi => smi.SetAnim())).DefaultState(this.sleep.normal).ToggleTag(GameTags.Asleep).DoSleep(this.sleeper, this.bed, this.success, (GameStateMachine<SleepChore.States, SleepChore.StatesInstance, SleepChore, object>.State) null).Toggle("Custom Status Items", new StateMachine<SleepChore.States, SleepChore.StatesInstance, SleepChore, object>.State.Callback(SleepChore.DisplayCustomStatusItemsWhenAsleep), new StateMachine<SleepChore.States, SleepChore.StatesInstance, SleepChore, object>.State.Callback(SleepChore.RemoveCustomStatusItemsWhenAsleep)).TriggerOnExit(GameHashes.SleepFinished).EventHandler(GameHashes.SleepDisturbedByLight, (StateMachine<SleepChore.States, SleepChore.StatesInstance, SleepChore, object>.State.Callback) (smi => this.isDisturbedByLight.Set(true, smi))).EventHandler(GameHashes.SleepDisturbedByNoise, (StateMachine<SleepChore.States, SleepChore.StatesInstance, SleepChore, object>.State.Callback) (smi => this.isDisturbedByNoise.Set(true, smi))).EventHandler(GameHashes.SleepDisturbedByFearOfDark, (StateMachine<SleepChore.States, SleepChore.StatesInstance, SleepChore, object>.State.Callback) (smi => this.isScaredOfDark.Set(true, smi))).EventHandler(GameHashes.SleepDisturbedByMovement, (StateMachine<SleepChore.States, SleepChore.StatesInstance, SleepChore, object>.State.Callback) (smi => this.isDisturbedByMovement.Set(true, smi))).EventHandler(GameHashes.SleepDisturbedByCold, (StateMachine<SleepChore.States, SleepChore.StatesInstance, SleepChore, object>.State.Callback) (smi => this.isDisturbedByCold.Set(true, smi)));
      this.sleep.uninterruptable.DoNothing();
      this.sleep.normal.ParamTransition<bool>((StateMachine<SleepChore.States, SleepChore.StatesInstance, SleepChore, object>.Parameter<bool>) this.isInterruptable, this.sleep.uninterruptable, GameStateMachine<SleepChore.States, SleepChore.StatesInstance, SleepChore, object>.IsFalse).ToggleCategoryStatusItem(Db.Get().StatusItemCategories.Main, Db.Get().DuplicantStatusItems.Sleeping).QueueAnim("working_loop", true).ParamTransition<bool>((StateMachine<SleepChore.States, SleepChore.StatesInstance, SleepChore, object>.Parameter<bool>) this.isDisturbedByNoise, this.sleep.interrupt_noise, GameStateMachine<SleepChore.States, SleepChore.StatesInstance, SleepChore, object>.IsTrue).ParamTransition<bool>((StateMachine<SleepChore.States, SleepChore.StatesInstance, SleepChore, object>.Parameter<bool>) this.isDisturbedByLight, this.sleep.interrupt_light, GameStateMachine<SleepChore.States, SleepChore.StatesInstance, SleepChore, object>.IsTrue).ParamTransition<bool>((StateMachine<SleepChore.States, SleepChore.StatesInstance, SleepChore, object>.Parameter<bool>) this.isScaredOfDark, this.sleep.interrupt_scared, GameStateMachine<SleepChore.States, SleepChore.StatesInstance, SleepChore, object>.IsTrue).ParamTransition<bool>((StateMachine<SleepChore.States, SleepChore.StatesInstance, SleepChore, object>.Parameter<bool>) this.isDisturbedByMovement, this.sleep.interrupt_movement, GameStateMachine<SleepChore.States, SleepChore.StatesInstance, SleepChore, object>.IsTrue).ParamTransition<bool>((StateMachine<SleepChore.States, SleepChore.StatesInstance, SleepChore, object>.Parameter<bool>) this.isDisturbedByCold, this.sleep.interrupt_cold, GameStateMachine<SleepChore.States, SleepChore.StatesInstance, SleepChore, object>.IsTrue).Update((Action<SleepChore.StatesInstance, float>) ((smi, dt) =>
      {
        smi.CheckLightLevel();
      ...
      {
        GameObject go = smi.sm.bed.Get(smi);
        if (!((UnityEngine.Object) go != (UnityEngine.Object) null))
          return;
        go.Trigger(-717201811);
      }));
      this.sleep.interrupt_movement_transition.Enter((StateMachine<SleepChore.States, SleepChore.StatesInstance, SleepChore, object>.State.Callback) (smi =>
      {
        if (!smi.master.GetComponent<Effects>().HasEffect(Db.Get().effects.Get("TerribleSleep")))
      ...
      this.sleep.interrupt_cold.ToggleCategoryStatusItem(Db.Get().StatusItemCategories.Main, Db.Get().DuplicantStatusItems.SleepingInterruptedByCold).PlayAnim("interrupt_cold").ToggleThought(Db.Get().Thoughts.Cold).OnAnimQueueComplete(this.sleep.interrupt_cold_transition).Enter((StateMachine<SleepChore.States, SleepChore.StatesInstance, SleepChore, object>.State.Callback) (smi =>
      {
        GameObject go = smi.sm.bed.Get(smi);
        if (!((UnityEngine.Object) go != (UnityEngine.Object) null))
          return;
      ...
      this.sleep.interrupt_cold_transition.Enter((StateMachine<SleepChore.States, SleepChore.StatesInstance, SleepChore, object>.State.Callback) (smi =>
      {
        if (!smi.master.GetComponent<Effects>().HasEffect(Db.Get().effects.Get("TerribleSleep")))
          smi.master.GetComponent<Effects>().Add(Db.Get().effects.Get("BadSleepCold"), true);
        GameStateMachine<SleepChore.States, SleepChore.StatesInstance, SleepChore, object>.State state = smi.master.GetComponent<Schedulable>().IsAllowed(Db.Get().ScheduleBlockTypes.Sleep) ? this.sleep.normal : this.success;
        this.isDisturbedByCold.Set(false, smi);
        smi.GoTo((StateMachine.BaseState) state);
      }));
