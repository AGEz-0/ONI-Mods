...
public class SaltPlantConfig : IEntityConfig
{
  ...
  public GameObject CreatePrefab()
  {
    ...
    EntityTemplates.MakeHangingOffsets(EntityTemplates.CreateAndRegisterPreviewForPlant(EntityTemplates.CreateAndRegisterSeedForPlant(plant, dlcRestrictions, SeedProducer.ProductionType.Harvest, "SaltPlantSeed", name3, desc2, anim2, additionalTags: additionalTags2, planterDirection: SingleEntityReceptacle.ReceptacleDirection.Bottom, replantGroundTag: replantGroundTag, sortOrder: 5, domesticatedDescription: domesticatedDescription, width: 0.35f, height: 0.35f), "SaltPlant_preview", Assets.GetAnim((HashedString) "saltplant_kanim"), "place", 1, 2), 1, 2);
    return placedEntity;
  }
