...
public class DevToolStateMachineDebug : DevTool
{
  ...
  private void Update()
  {
    ...
    if (this.lockSelection || !((UnityEngine.Object) this.selectedGameObject != (UnityEngine.Object) gameObject) || !((UnityEngine.Object) gameObject != (UnityEngine.Object) null) || gameObject.GetComponentsInChildren<StateMachineController>().Length == 0)
      return;
  ...
  {
    this.Update();
    ImGui.InputText("Filter:", ref this.stateMachineFilter, 256U /*0x0100*/);
    ...
    if (!Application.isPlaying || !((UnityEngine.Object) this.selectedGameObject != (UnityEngine.Object) null))
      return;
    ...
    foreach (StateMachineController machineController in componentsInChildren)
    {
      ...
      {
        string str = $"{machineController.name}.{instance.ToString()}";
  ...
  private void ShowStates(StateMachine.Instance state_machine_instance)
  {
    ...
    string[] array = stateMachine.GetStateNames().Append<string>("None");
    array[0] = array[0];
    int num = Array.IndexOf<string>(array, str);
    int v = num;
    for (int v_button = 0; v_button < array.Length; ++v_button)
      ImGui.RadioButton(array[v_button], ref v, v_button);
    if (v == num)
      return;
    if (array[v] == "None")
  ...
  {
    int num = (UnityEngine.Object) this.selectedGameObject.GetComponentInChildren<KAnimControllerBase>() == (UnityEngine.Object) null ? 1 : 0;
  }
