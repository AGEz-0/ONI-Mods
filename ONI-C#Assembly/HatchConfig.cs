...
public class HatchConfig : IEntityConfig
{
  ...
  {
    return EntityTemplates.ExtendEntityToFertileCreature(HatchConfig.CreateHatch("Hatch", (string) STRINGS.CREATURES.SPECIES.HATCH.NAME, (string) STRINGS.CREATURES.SPECIES.HATCH.DESC, "hatch_kanim", false), this as IHasDlcRestrictions, "HatchEgg", (string) STRINGS.CREATURES.SPECIES.HATCH.EGG_NAME, (string) STRINGS.CREATURES.SPECIES.HATCH.DESC, "egg_hatch_kanim", HatchTuning.EGG_MASS, "HatchBaby", 60.0000038f, 20f, HatchTuning.EGG_CHANCES_BASE, HatchConfig.EGG_SORT_ORDER);
  }
