  ...
  where MasterType : IStateMachineTarget
{
  ...
  protected static StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.Parameter<GameObject>.Callback IsNotNull = (StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.Parameter<GameObject>.Callback) ((smi, p) => (UnityEngine.Object) p != (UnityEngine.Object) null);
  protected static StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.Parameter<GameObject>.Callback IsNull = (StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.Parameter<GameObject>.Callback) ((smi, p) => (UnityEngine.Object) p == (UnityEngine.Object) null);
  protected static StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.Parameter<int>.Callback IsZero_Int = (StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.Parameter<int>.Callback) ((smi, p) => p == 0);
  protected static StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.Parameter<int>.Callback IsLTEOne_Int = (StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.Parameter<int>.Callback) ((smi, p) => p <= 1);
  protected static StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.Parameter<int>.Callback IsGTOne_Int = (StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.Parameter<int>.Callback) ((smi, p) => p > 1);
  protected static StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.Parameter<int>.Callback IsGTZero_Int = (StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.Parameter<int>.Callback) ((smi, p) => p > 0);
  ...
  public static StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.Transition.ConditionCallback And(
    StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.Transition.ConditionCallback first_condition,
    StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.Transition.ConditionCallback second_condition)
  {
    return (StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.Transition.ConditionCallback) (smi => first_condition(smi) && second_condition(smi));
  }

  public static StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.Transition.ConditionCallback Or(
    StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.Transition.ConditionCallback first_condition,
    StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.Transition.ConditionCallback second_condition)
  {
    return (StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.Transition.ConditionCallback) (smi => first_condition(smi) || second_condition(smi));
    ...
    StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.GenericInstance
  {
    ...
    {
      this.smi.GetComponent<KBatchedAnimController>().Queue((HashedString) anim, mode);
    }

    public void Play(string anim, KAnim.PlayMode mode = KAnim.PlayMode.Once)
    {
      this.smi.GetComponent<KBatchedAnimController>().Play((HashedString) anim, mode);
    }
    ...
    StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.Transition
  {
    ...
    {
      if ((UnityEngine.Object) this.target.Get(smi) == (UnityEngine.Object) null)
        return;
      if (!this.onRemove)
      {
    ...
    public override StateMachine.BaseTransition.Context Register(StateMachine.Instance smi)
    {
      ...
      {
        handlerId = this.target.Get(smi_internal).Subscribe(-1582839653, (System.Action<object>) (data => this.OnCallback(smi_internal)))
      };
    }
      ...
      StateMachine.BaseTransition.Context context)
    {
      ...
      if (!((UnityEngine.Object) this.target.Get(smi1) != (UnityEngine.Object) null))
        return;
      this.target.Get(smi1).Unsubscribe(context.handlerId);
    }
  }
    ...
    StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.Transition
  {
    ...
    public override StateMachine.BaseTransition.Context Register(StateMachine.Instance smi)
    {
      ...
      System.Action<object> handler = (System.Action<object>) (d => this.OnCallback(smi_internal));
    ...
    StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State
  {
    ...
    {
      return ((__Boxed<StateMachineType>) (object) this.sm).dataTableSize++;
    }

    public int CreateUpdateTableEntry()
    {
      return ((__Boxed<StateMachineType>) (object) this.sm).updateTableSize++;
    }
      ...
      UpdateBucketWithUpdater<StateMachineInstanceType>.BatchUpdateDelegate batch_update = null)
    {
      ...
      {
        UpdateBucketWithUpdater<StateMachineInstanceType> bucket = new UpdateBucketWithUpdater<StateMachineInstanceType>(name);
        bucket.batch_update_delegate = batch_update;
        Singleton<StateMachineUpdater>.Instance.AddBucket(update_rate, (StateMachineUpdater.BaseUpdateBucket) bucket);
        updateAction.buckets[index] = (StateMachineUpdater.BaseUpdateBucket) bucket;
      }
      ...
      Func<StateMachineInstanceType, HashedString> chooser_callback)
    {
      ...
      this.Enter("EnableAnims()", (StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State.Callback) (smi =>
      {
        ...
        if (name == (HashedString) (string) null || !name.IsValid)
          return;
      ...
      GameStateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State target_state)
    {
      ...
      this.Enter($"Enter WorkableStartTransition({target_state.longName})", (StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State.Callback) (smi =>
      {
        ...
        if (!((UnityEngine.Object) workable1 != (UnityEngine.Object) null))
          return;
    ...
    public GameStateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State ToggleCreatureThought(
      Func<StateMachineInstanceType, Thought> chooser_callback)
    {
      StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.TargetParameter state_target = this.GetStateTarget();
      this.Enter("EnableCreatureThought()", (StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State.Callback) (smi =>
      {
        Thought thought = chooser_callback(smi);
        state_target.Get(smi).GetSMI<CreatureThoughtGraph.Instance>().AddThought(thought);
      }));
      this.Exit("DisableCreatureThought()", (StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State.Callback) (smi =>
      {
        Thought thought = chooser_callback(smi);
    ...
    {
      StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.TargetParameter state_target = this.GetStateTarget();
      this.Enter($"AddCreatureThought({thought.Id})", (StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State.Callback) (smi =>
      {
        if (condition_callback != null && !condition_callback(smi))
          return;
        state_target.Get(smi).GetSMI<CreatureThoughtGraph.Instance>().AddThought(thought);
      ...
      if (condition_callback != null)
        this.Update($"ValidateCreatureThought({thought.Id})", (System.Action<StateMachineInstanceType, float>) ((smi, dt) =>
        {
          if (condition_callback(smi))
            state_target.Get(smi).GetSMI<CreatureThoughtGraph.Instance>().AddThought(thought);
          else
      ...
      this.Exit($"RemoveCreatureThought({thought.Id})", (StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State.Callback) (smi => state_target.Get(smi).GetSMI<CreatureThoughtGraph.Instance>()?.RemoveThought(thought)));
      return this;
    }
    ...
    {
      StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.TargetParameter state_target = this.GetStateTarget();
      this.Enter($"AddTag({tag.Name})", (StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State.Callback) (smi => state_target.Get<KPrefabID>(smi).AddTag(tag)));
    ...
    {
      StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.TargetParameter state_target = this.GetStateTarget();
      this.Enter("AddTag(DynamicallyConstructed)", (StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State.Callback) (smi => state_target.Get<KPrefabID>(smi).AddTag(behaviour_tag_cb(smi))));
    ...
    public GameStateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State ToggleRecurringChore(
      Func<StateMachineInstanceType, Chore> callback,
      System.Action<StateMachineInstanceType, Chore> processChore,
      Func<StateMachineInstanceType, bool> condition = null)
    {
      int data_idx = this.CreateDataTableEntry();
      int callback_data_idx = this.CreateDataTableEntry();
      ...
      this.Exit("ToggleRecurringChoreExit()", (StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State.Callback) (smi =>
      {
        this.ClearChore(smi, data_idx, callback_data_idx);
        processChore(smi, (Chore) null);
      }));
      return this;
    }
      ...
      GameStateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State target_state)
    {
      int data_idx = this.CreateDataTableEntry();
      int callback_data_idx = this.CreateDataTableEntry();
      this.Enter("ToggleChoreEnter()", (StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State.Callback) (smi =>
      {
        Chore chore = this.SetupChore(callback, target_state, target_state, smi, data_idx, callback_data_idx, false, false);
        processChore(smi, chore);
      }));
      this.Exit("ToggleChoreExit()", (StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State.Callback) (smi =>
      {
        this.ClearChore(smi, data_idx, callback_data_idx);
        processChore(smi, (Chore) null);
      }));
    ...
    public GameStateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State PreBrainUpdate(
      System.Action<StateMachineInstanceType> callback)
    {
      StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.TargetParameter state_target = this.GetStateTarget();
      int data_idx = this.CreateDataTableEntry();
      this.Enter("EnablePreBrainUpdate", (StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State.Callback) (smi =>
      {
        System.Action action = (System.Action) (() => callback(smi));
        smi.dataTable[data_idx] = (object) action;
        Brain brain = state_target.Get<Brain>(smi);
        DebugUtil.AssertArgs(((UnityEngine.Object) brain != (UnityEngine.Object) null ? 1 : 0) != 0, (object) "PreBrainUpdate cannot find a brain");
        brain.onPreUpdate += action;
      }));
      this.Exit("DisablePreBrainUpdate", (StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State.Callback) (smi =>
      {
        System.Action action = (System.Action) smi.dataTable[data_idx];
        state_target.Get<Brain>(smi).onPreUpdate -= action;
        smi.dataTable[data_idx] = (object) null;
      }));
      return this;
    }
    ...
    public GameStateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State ToggleStateMachineList(
      Func<StateMachineInstanceType, Func<StateMachineInstanceType, StateMachine.Instance>[]> getListCallback)
    {
      int data_idx = this.CreateDataTableEntry();
      this.Enter("EnableListOfStateMachines()", (StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State.Callback) (smi =>
      {
        Func<StateMachineInstanceType, StateMachine.Instance>[] funcArray = getListCallback(smi);
        StateMachine.Instance[] instanceArray = new StateMachine.Instance[funcArray.Length];
        for (int index = 0; index < funcArray.Length; ++index)
        {
          StateMachine.Instance instance = funcArray[index](smi);
          instance.StartSM();
          instanceArray[index] = instance;
        }
        smi.dataTable[data_idx] = (object) instanceArray;
      }));
      this.Exit("DisableListOfStateMachines()", (StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State.Callback) (smi =>
      {
        Func<StateMachineInstanceType, StateMachine.Instance>[] funcArray = getListCallback(smi);
        StateMachine.Instance[] instanceArray = (StateMachine.Instance[]) smi.dataTable[data_idx];
        for (int index = funcArray.Length - 1; index >= 0; --index)
          instanceArray[index]?.StopSM("ToggleListOfStateMachines.Exit");
        smi.dataTable[data_idx] = (object) null;
      }));
      return this;
    }
    ...
    public GameStateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State ToggleComponentIfFound<ComponentType>(
      bool disable = false)
      where ComponentType : MonoBehaviour
    {
      StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.TargetParameter state_target = this.GetStateTarget();
      this.Enter($"EnableComponent({typeof (ComponentType).Name})", (StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State.Callback) (smi =>
      {
      ...
      this.Exit($"DisableComponent({typeof (ComponentType).Name})", (StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State.Callback) (smi =>
      {
        GameObject gameObject = state_target.Get(smi);
        if (!((UnityEngine.Object) gameObject != (UnityEngine.Object) null))
          return;
    ...
    {
      StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.TargetParameter state_target = this.GetStateTarget();
      this.Enter($"EnableComponent({typeof (ComponentType).Name})", (StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State.Callback) (smi => state_target.Get<ComponentType>(smi).enabled = !disable));
      this.Exit($"DisableComponent({typeof (ComponentType).Name})", (StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State.Callback) (smi => state_target.Get<ComponentType>(smi).enabled = disable));
      return this;
    }
      ...
      StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.FloatParameter actual_amount)
    {
      ...
      this.Enter($"Reserve({pickup_target.name}, {requested_amount.name})", (StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State.Callback) (smi =>
      {
        ...
        GameObject go = reserver.Get(smi);
        float val1 = requested_amount.Get(smi);
        float val2 = Mathf.Max(1f, Db.Get().Attributes.CarryAmount.Lookup(go).GetTotalValue());
        float amount = Math.Min(Math.Min(val1, val2), pickupable.UnreservedFetchAmount);
        if ((double) amount <= 0.0)
        {
          pickupable.PrintReservations();
          Debug.LogError((object) $"{val2.ToString()}, {val1.ToString()}, {pickupable.UnreservedFetchAmount.ToString()}, {amount.ToString()}");
        }
        double num1 = (double) actual_amount.Set(amount, smi);
        int num2 = pickupable.Reserve(nameof (ToggleReserve), go.GetComponent<KPrefabID>().InstanceID, amount);
      ...
      GameStateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State failure_state)
    {
      ...
      this.Update($"Work({work_type})", (System.Action<StateMachineInstanceType, float>) ((smi, dt) =>
      {
        if (validate_callback(smi))
        {
          switch (state_target.Get<WorkerBase>(smi).Work(dt))
          {
      ...
      this.Exit("StopWork()", (StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State.Callback) (smi => state_target.Get<WorkerBase>(smi).StopWork()));
      return this;
    }
      ...
      GameStateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State failure_state)
    {
      ...
      this.ToggleWork("Eat", (System.Action<StateMachineInstanceType>) (smi =>
      {
        ...
        workerBase.StartWork((WorkerBase.StartWorkInfo) start_work_info);
    ...
    {
      StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.TargetParameter state_target = this.GetStateTarget();
      this.ToggleWork("Sleep", (System.Action<StateMachineInstanceType>) (smi => state_target.Get<WorkerBase>(smi).StartWork(new WorkerBase.StartWorkInfo((Workable) bed.Get<Sleepable>(smi)))), (Func<StateMachineInstanceType, bool>) (smi => (UnityEngine.Object) bed.Get<Sleepable>(smi) != (UnityEngine.Object) null), success_state, failure_state);
      return this;
    }
    ...
    public GameStateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State DoDelivery(
      ...
      GameStateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State failure_state)
    {
      this.ToggleWork("Pickup", (System.Action<StateMachineInstanceType>) (smi => worker_param.Get<WorkerBase>(smi).StartWork(new WorkerBase.StartWorkInfo((Workable) storage_param.Get<Storage>(smi)))), (Func<StateMachineInstanceType, bool>) (smi => (UnityEngine.Object) storage_param.Get<Storage>(smi) != (UnityEngine.Object) null), success_state, failure_state);
      return this;
    }
      ...
      GameStateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State failure_state)
    {
      ...
      this.ToggleWork("Pickup", (System.Action<StateMachineInstanceType>) (smi =>
      {
        ...
        workerBase.StartWork((WorkerBase.StartWorkInfo) start_work_info);
      }), (Func<StateMachineInstanceType, bool>) (smi => (UnityEngine.Object) source_target.Get<Pickupable>(smi) != (UnityEngine.Object) null || (UnityEngine.Object) result_target.Get<Pickupable>(smi) != (UnityEngine.Object) null), success_state, failure_state);
      return this;
    }
    ...
    public GameStateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State EnterGoTo(
      GameStateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State state)
    {
      DebugUtil.DevAssert(state != this, "Can't transition to self");
      string str = "(null)";
      if (state != null)
        str = state.name;
      this.Enter($"GoTo({str})", (StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State.Callback) (smi => smi.GoTo((StateMachine.BaseState) state)));
      return this;
    }
    ...
    public GameStateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State MoveTo<ApproachableType>(
      StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.TargetParameter move_parameter,
      GameStateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State success_state,
      Func<StateMachineInstanceType, CellOffset[]> override_offsets,
      GameStateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State fail_state = null,
      NavTactic tactic = null)
      where ApproachableType : IApproachable
    {
    ...
    public GameStateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State MoveTo<ApproachableType>(
      StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.TargetParameter move_parameter,
      GameStateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State success_state,
      Func<StateMachineInstanceType, NavTactic> nav_tactic,
      GameStateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State fail_state = null,
      CellOffset[] override_offsets = null)
      where ApproachableType : IApproachable
    {
      ...
      this.Enter($"MoveTo({move_parameter.name})", (StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State.Callback) (smi =>
      {
        ...
        else
        {
          ...
          KMonoBehaviour target = kmonoBehaviour;
          CellOffset[] offsets1 = offsets;
          NavTactic tactic = navTactic;
          component.GoTo(target, offsets1, tactic);
        }
      }));
      this.Exit("StopMoving()", (StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State.Callback) (smi => state_target.Get<Navigator>(smi).Stop()));
      return this;
    ...
    public GameStateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State ScheduleChange(
      GameStateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State targetState,
      StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.Transition.ConditionCallback callback)
    {
      ...
      string anim)
    {
      ...
      this.Enter($"PlayAnim({anim}, {mode.ToString()})", (StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State.Callback) (smi =>
      {
        ...
        if (!((UnityEngine.Object) kanimControllerBase != (UnityEngine.Object) null))
          return;
        kanimControllerBase.Play((HashedString) anim, mode);
      }));
      return this;
    }
      ...
      KAnim.PlayMode mode = KAnim.PlayMode.Once)
    {
      ...
      this.Enter($"PlayAnim({mode.ToString()})", (StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State.Callback) (smi =>
      {
        ...
        if (!((UnityEngine.Object) kanimControllerBase != (UnityEngine.Object) null))
          return;
        kanimControllerBase.Play((HashedString) anim_cb(smi), mode);
      }));
      return this;
    }
    ...
    {
      StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.TargetParameter state_target = this.GetStateTarget();
      this.Enter("PlayAnim(Dynamic)", (StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State.Callback) (smi =>
      {
        KAnimControllerBase kanimControllerBase = state_target.Get<KAnimControllerBase>(smi);
        if (!((UnityEngine.Object) kanimControllerBase != (UnityEngine.Object) null))
          return;
        kanimControllerBase.Play((HashedString) anim_cb(smi), mode_cb(smi));
      }));
      return this;
    }
      ...
      Func<StateMachineInstanceType, string> suffix_callback)
    {
      ...
      this.Enter($"PlayAnim({anim}, {mode.ToString()})", (StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State.Callback) (smi =>
      {
        ...
        if (!((UnityEngine.Object) kanimControllerBase != (UnityEngine.Object) null))
          return;
        kanimControllerBase.Play((HashedString) (anim + str), mode);
      }));
      return this;
    }
      ...
      Func<StateMachineInstanceType, string> suffix_callback = null)
    {
      ...
      this.Enter($"QueueAnim({mode.ToString()})", (StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State.Callback) (smi =>
      {
        ...
        if (!((UnityEngine.Object) kanimControllerBase != (UnityEngine.Object) null))
          return;
        kanimControllerBase.Queue((HashedString) (anim_cb(smi) + str), mode);
      }));
      return this;
    }
      ...
      Func<StateMachineInstanceType, string> suffix_callback = null)
    {
      ...
      this.Enter($"QueueAnim({anim}, {mode.ToString()})", (StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State.Callback) (smi =>
      {
        ...
        if (!((UnityEngine.Object) kanimControllerBase != (UnityEngine.Object) null))
          return;
        kanimControllerBase.Queue((HashedString) (anim + str), mode);
      }));
      return this;
    }
    ...
    where ApproachableType : IApproachable
  {
    ...
    public GameStateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State InitializeStates(
      ...
      NavTactic tactic = null)
    {
      this.root.Target(mover).OnTargetLost(move_target, failure_state).MoveTo<ApproachableType>(move_target, success_state, override_offsets, failure_state, tactic == null ? NavigationTactics.ReduceTravelDistance : tactic);
      return (GameStateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State) this;
    }

    public GameStateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State InitializeStates(
      Func<StateMachineInstanceType, NavTactic> navTactic,
      StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.TargetParameter mover,
      StateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.TargetParameter move_target,
      GameStateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State success_state,
      GameStateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State failure_state = null,
      CellOffset[] override_offsets = null)
    {
      this.root.Target(mover).OnTargetLost(move_target, failure_state).MoveTo<ApproachableType>(move_target, success_state, navTactic, failure_state, override_offsets);
      return (GameStateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State) this;
    }
  }
    ...
    GameStateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State
  {
      ...
      GameStateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State failure_state = null)
    {
      ...
      this.pickup.DoPickup(pickup_source, pickup_chunk, actual_amount, success_state, failure_state).EventTransition(GameHashes.AbortWork, failure_state);
      return (GameStateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State) this;
    }
  }
    ...
    GameStateMachine<StateMachineType, StateMachineInstanceType, MasterType, DefType>.State
  {
    ...
    public bool ForceUpdateStatus(GameObject plant)
    {
      ...
      if (!((UnityEngine.Object) component1 == (UnityEngine.Object) null) && component1.IsLethal || !((UnityEngine.Object) component2 == (UnityEngine.Object) null) && component2.GetEntombed)
        return false;
      return (UnityEngine.Object) component3 == (UnityEngine.Object) null || !component3.IsLethal;
    }
