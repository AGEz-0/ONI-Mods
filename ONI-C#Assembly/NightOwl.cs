...
public class NightOwl : StateMachineComponent<NightOwl.StatesInstance>
{
  ...
  public class StatesInstance(NightOwl master) : 
    GameStateMachine<NightOwl.States, NightOwl.StatesInstance, NightOwl, object>.GameInstance(master)
  {
    public bool IsNight()
    {
      return !((Object) GameClock.Instance == (Object) null) && !(this.master.kPrefabID.PrefabTag == GameTags.MinionSelectPreview) && GameClock.Instance.IsNighttime();
    }
  }
