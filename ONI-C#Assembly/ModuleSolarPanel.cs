...
public class ModuleSolarPanel : Generator
{
  ...
  public override void EnergySim200ms(float dt)
  {
    ...
    if (!this.operational.IsOperational)
      return;
    float num1 = 0.0f;
    if (Grid.IsValidCell(Grid.PosToCell((KMonoBehaviour) this)) && Grid.WorldIdx[Grid.PosToCell((KMonoBehaviour) this)] != byte.MaxValue)
    {
  ...
  public class StatesInstance(ModuleSolarPanel master) : 
    GameStateMachine<ModuleSolarPanel.States, ModuleSolarPanel.StatesInstance, ModuleSolarPanel, object>.GameInstance(master)
  {
  }
