...
public class Easing
{
  ...
  public static readonly Easing.EasingFn EaseOutBack = (Easing.EasingFn) (x => (float) (1.0 + 2.7015800476074219 * (double) Mathf.Pow(x - 1f, 3f) + 1.7015800476074219 * (double) Mathf.Pow(x - 1f, 2f)));
