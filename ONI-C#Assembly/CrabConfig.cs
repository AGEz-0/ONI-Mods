...
public class CrabConfig : IEntityConfig
{
  ...
  public static GameObject CreateCrab(
    ...
    bool is_baby,
    string deathDropID,
    float deathDropCount)
  {
    GameObject wildCreature = EntityTemplates.ExtendEntityToWildCreature(BaseCrabConfig.BaseCrab(id, name, desc, anim_file, "CrabBaseTrait", is_baby, onDeathDropID: deathDropID, onDeathDropCount: deathDropCount), CrabTuning.PEN_SIZE_PER_CREATURE);
  ...
  {
    GameObject fertileCreature = EntityTemplates.ExtendEntityToFertileCreature(CrabConfig.CreateCrab("Crab", (string) STRINGS.CREATURES.SPECIES.CRAB.NAME, (string) STRINGS.CREATURES.SPECIES.CRAB.DESC, "pincher_kanim", false, "CrabShell", 10f), this as IHasDlcRestrictions, "CrabEgg", (string) STRINGS.CREATURES.SPECIES.CRAB.EGG_NAME, (string) STRINGS.CREATURES.SPECIES.CRAB.DESC, "egg_pincher_kanim", CrabTuning.EGG_MASS, "CrabBaby", 60.0000038f, 20f, CrabTuning.EGG_CHANCES_BASE, CrabConfig.EGG_SORT_ORDER);
