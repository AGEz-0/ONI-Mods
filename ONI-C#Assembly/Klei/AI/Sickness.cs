...
public abstract class Sickness : Resource
{
  ...
  public List<Descriptor> GetSymptoms() => this.GetSymptoms((GameObject) null);
  ...
  public List<Descriptor> GetQualitativeDescriptors()
  {
    ...
    foreach (int infectionVector in this.infectionVectors)
    {
      ...
      {
        case 0:
          qualitativeDescriptors.Add(new Descriptor((string) DUPLICANTS.DISEASES.DESCRIPTORS.INFO.SKINBORNE, (string) DUPLICANTS.DISEASES.DESCRIPTORS.INFO.SKINBORNE_TOOLTIP, Descriptor.DescriptorType.Information));
          continue;
        case 1:
          qualitativeDescriptors.Add(new Descriptor((string) DUPLICANTS.DISEASES.DESCRIPTORS.INFO.FOODBORNE, (string) DUPLICANTS.DISEASES.DESCRIPTORS.INFO.FOODBORNE_TOOLTIP, Descriptor.DescriptorType.Information));
          continue;
        case 2:
          qualitativeDescriptors.Add(new Descriptor((string) DUPLICANTS.DISEASES.DESCRIPTORS.INFO.AIRBORNE, (string) DUPLICANTS.DISEASES.DESCRIPTORS.INFO.AIRBORNE_TOOLTIP, Descriptor.DescriptorType.Information));
          continue;
        case 3:
          qualitativeDescriptors.Add(new Descriptor((string) DUPLICANTS.DISEASES.DESCRIPTORS.INFO.SUNBORNE, (string) DUPLICANTS.DISEASES.DESCRIPTORS.INFO.SUNBORNE_TOOLTIP, Descriptor.DescriptorType.Information));
          continue;
        default:
          continue;
      }
    }
    qualitativeDescriptors.Add(new Descriptor((string) Strings.Get(this.descriptiveSymptoms), "", Descriptor.DescriptorType.Information));
  ...
  public abstract class SicknessComponent
  {
    ...
    public virtual List<Descriptor> GetSymptoms(GameObject victim) => this.GetSymptoms();
  }
