...
public class SicknessInstance(GameObject game_object, Sickness disease) : 
  ModifierInstance<Sickness>(game_object, disease),
  ISaveLoadable
{
  [Serialize]
  ...
  {
    return this.smi == null ? 0.0f : this.smi.sm.percentRecovered.Get(this.smi);
  }
  ...
  public class StatesInstance(SicknessInstance master) : 
    GameStateMachine<SicknessInstance.States, SicknessInstance.StatesInstance, SicknessInstance, object>.GameInstance(master)
  {
