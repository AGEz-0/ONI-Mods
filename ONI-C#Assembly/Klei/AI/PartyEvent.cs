...
public class PartyEvent : GameplayEvent<PartyEvent.StatesInstance>
{
  ...
  public PartyEvent()
    : base("Party")
  {
    this.animFileName = (HashedString) "event_pop_up_assets_kanim";
  ...
  public class StatesInstance(
    ...
    GameplayEventStateMachine<PartyEvent.States, PartyEvent.StatesInstance, GameplayEventManager, PartyEvent>.GameplayEventStateMachineInstance(master, eventInstance, partyEvent)
  {
    ...
    public void AddNewChore(Room room)
    {
      ...
      if (all.Count == 0)
      {
        DebugUtil.LogWarningArgs((object) "Tried adding a party chore but the room wasn't valid! This probably happened on load? It's because rooms aren't built yet!");
      }
      else
      {
        int num = 0;
        ...
        {
          ++num;
          KPrefabID cmp = all[UnityEngine.Random.Range(0, all.Count)];
        ...
        chat_workable.SetWorkTime((float) UnityEngine.Random.Range(10, 30));
    ...
    GameplayEventStateMachine<PartyEvent.States, PartyEvent.StatesInstance, GameplayEventManager, PartyEvent>
  {
    ...
    public override void InitializeStates(out StateMachine.BaseState default_state)
    {
      ...
      {
        if ((UnityEngine.Object) this.planner.Get(smi) != (UnityEngine.Object) null && (UnityEngine.Object) this.guest.Get(smi) != (UnityEngine.Object) null)
      ...
      {
        if ((UnityEngine.Object) this.planner.Get(smi) != (UnityEngine.Object) null)
          this.planner.Get(smi).GetComponent<Effects>().Add("NoFunAllowed", true);
        if (!((UnityEngine.Object) this.guest.Get(smi) != (UnityEngine.Object) null))
          return;
    ...
    public override EventInfoData GenerateEventPopupData(PartyEvent.StatesInstance smi)
    {
      ...
      option1.AddPositiveIcon(Assets.GetSprite((HashedString) "overlay_materials"), Effect.CreateFullTooltip(effect1, true));
      ...
      option2.AddNegativeIcon(Assets.GetSprite((HashedString) "overlay_decor"), Effect.CreateFullTooltip(effect2, true));
    ...
    {
      if ((UnityEngine.Object) this.roomObject.Get(smi) == (UnityEngine.Object) null)
      ...
      if (Components.LiveMinionIdentities.Count <= 0)
        return;
      if ((UnityEngine.Object) this.planner.Get(smi) == (UnityEngine.Object) null)
        this.planner.Set((KMonoBehaviour) Components.LiveMinionIdentities[UnityEngine.Random.Range(0, Components.LiveMinionIdentities.Count)], smi);
      if (!((UnityEngine.Object) this.guest.Get(smi) == (UnityEngine.Object) null))
        return;
      this.guest.Set((KMonoBehaviour) Components.LiveMinionIdentities[UnityEngine.Random.Range(0, Components.LiveMinionIdentities.Count)], smi);
    }
