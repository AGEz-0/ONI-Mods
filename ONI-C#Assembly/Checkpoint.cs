...
public class Checkpoint : StateMachineComponent<Checkpoint.SMInstance>
{
  ...
  {
    get => this.hasLogicWire && !this.hasInputHigh && this.operational.IsOperational;
  }
  ...
  {
    return (string) (((Checkpoint) data).RedLight ? BUILDING.STATUSITEMS.CHECKPOINT.LOGIC_CONTROLLED_CLOSED : BUILDING.STATUSITEMS.CHECKPOINT.LOGIC_CONTROLLED_OPEN);
  }
  ...
  public class SMInstance(Checkpoint master) : 
    GameStateMachine<Checkpoint.States, Checkpoint.SMInstance, Checkpoint, object>.GameInstance(master)
  {
  }
