...
public class MaskStation : StateMachineComponent<MaskStation.SMInstance>, IBasicBuilding
{
  ...
  {
    ElementConsumer[] components = this.GetComponents<ElementConsumer>();
  ...
  protected override void OnSpawn()
  {
    ...
    this.materialsMeter = new MeterController((KAnimControllerBase) this.GetComponent<KBatchedAnimController>(), "meter_resources_target", "meter_resources", this.materialsMeterOffset, Grid.SceneLayer.BuildingBack, new string[1]
    {
      "meter_resources_target"
    });
    this.oxygenMeter = new MeterController((KAnimControllerBase) this.GetComponent<KBatchedAnimController>(), "meter_oxygen_target", "meter_oxygen", this.oxygenMeterOffset, Grid.SceneLayer.BuildingFront, new string[1]
    {
      "meter_oxygen_target"
    });
  ...
  private void Update()
  {
    Grid.UpdateSuitMarker(this.cell, (int) Mathf.Min(this.GetTotalMaterialAmount() / this.materialConsumedPerMask, this.GetTotalOxygenAmount() / this.oxygenConsumedPerMask), 0, this.gridFlags, this.PathFlag);
  }
  ...
  private class OxygenMaskReactable : Reactable
  {
    ...
    public OxygenMaskReactable(MaskStation mask_station)
      : base(mask_station.gameObject, (HashedString) "OxygenMask", Db.Get().ChoreTypes.SuitMarker, 1, 1)
    {
      ...
      Navigator.ActiveTransition transition)
    {
      if ((UnityEngine.Object) this.reactor != (UnityEngine.Object) null)
        return false;
      if ((UnityEngine.Object) this.maskStation == (UnityEngine.Object) null)
      {
        this.Cleanup();
        return false;
      }
    ...
    protected override void InternalBegin()
    {
      ...
      component.Queue((HashedString) "working_loop");
      component.Queue((HashedString) "working_pst");
    ...
    public override void Update(float dt)
    {
      ...
      if ((bool) (UnityEngine.Object) component && (bool) (UnityEngine.Object) this.maskStation)
        component.SetFacing(this.maskStation.GetComponent<Rotatable>().GetOrientation() == Orientation.FlipH);
    ...
    private void Run()
    {
      ...
      bool flag2 = (UnityEngine.Object) component1 != (UnityEngine.Object) null && (component1.flags & this.maskStation.PathFlag) != 0;
      if (flag1)
      {
  ...
  public class SMInstance(MaskStation master) : 
    GameStateMachine<MaskStation.States, MaskStation.SMInstance, MaskStation, object>.GameInstance(master)
  {
    private bool HasSufficientMaterials()
    {
      return (double) this.master.GetTotalMaterialAmount() >= (double) this.master.materialConsumedPerMask;
    }

    private bool HasSufficientOxygen()
    {
      return (double) this.master.GetTotalOxygenAmount() >= (double) this.master.oxygenConsumedPerMask;
    }

    public bool OxygenIsFull()
    {
      return (double) this.master.GetTotalOxygenAmount() >= (double) this.master.oxygenConsumedPerMask * (double) this.master.maxUses;
    }
  ...
  public class States : GameStateMachine<MaskStation.States, MaskStation.SMInstance, MaskStation>
  {
    ...
    public override void InitializeStates(out StateMachine.BaseState default_state)
    {
      ...
      this.charging.open.PlayAnim("open_charging_loop", KAnim.PlayMode.Loop).EventTransition(GameHashes.OnStorageChange, this.charging.closing, (StateMachine<MaskStation.States, MaskStation.SMInstance, MaskStation, object>.Transition.ConditionCallback) (smi => !smi.IsReady()));
      this.charging.closing.QueueAnim("closing_charging").OnAnimQueueComplete(this.charging.closed);
      this.charging.closed.PlayAnim("closed_charging_loop", KAnim.PlayMode.Loop).EventTransition(GameHashes.OnStorageChange, this.charging.opening, (StateMachine<MaskStation.States, MaskStation.SMInstance, MaskStation, object>.Transition.ConditionCallback) (smi => smi.IsReady()));
