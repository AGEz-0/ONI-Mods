...
public class UIPool<T> where T : MonoBehaviour
{
  ...
  {
    this.activeElements.ForEach((Action<T>) (ae => UnityEngine.Object.Destroy((UnityEngine.Object) ae.gameObject)));
    this.activeElements.Clear();
  }

  public void DestroyAllFree()
  {
    this.freeElements.ForEach((Action<T>) (ae => UnityEngine.Object.Destroy((UnityEngine.Object) ae.gameObject)));
