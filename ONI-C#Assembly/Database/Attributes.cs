...
public class Attributes : ResourceSet<Attribute>
{
  ...
  public Attribute BionicBoosterSlots;
  public Attribute BionicBatteryCountCapacity;
  public Attribute Insulation;
  public Attribute Luminescence;
  ...
  public Attribute ScoldingThreshold;
  ...
  public Attribute TransitTubeTravelSpeed;
    ...
    : base(nameof (Attributes), parent)
  {
    ...
    {
      this.BionicBoosterSlots = this.Add(new Attribute(nameof (BionicBoosterSlots), false, Attribute.Display.Details, false, 2f));
      this.BionicBoosterSlots.SetFormatter((IAttributeFormatter) new StandardAttributeFormatter(GameUtil.UnitClass.SimpleInteger, GameUtil.TimeSlice.None));
      this.BionicBatteryCountCapacity = this.Add(new Attribute(nameof (BionicBatteryCountCapacity), false, Attribute.Display.Details, false, 4f));
      this.BionicBatteryCountCapacity.SetFormatter((IAttributeFormatter) new StandardAttributeFormatter(GameUtil.UnitClass.SimpleInteger, GameUtil.TimeSlice.None));
    }
    ...
    this.Luminescence = this.Add(new Attribute(nameof (Luminescence), false, Attribute.Display.General, false));
    ...
    this.ScoldingThreshold = this.Add(new Attribute(nameof (ScoldingThreshold), false, Attribute.Display.General, false));
    this.ScoldingThreshold.SetFormatter((IAttributeFormatter) new StandardAttributeFormatter(GameUtil.UnitClass.Temperature, GameUtil.TimeSlice.None));
    ...
    this.RadiationResistance = this.Add(new Attribute(nameof (RadiationResistance), false, Attribute.Display.Details, false, overrideDLCIDs: DlcManager.EXPANSION1));
    this.RadiationResistance.SetFormatter((IAttributeFormatter) new PercentAttributeFormatter());
    this.RadiationRecovery = this.Add(new Attribute(nameof (RadiationRecovery), false, Attribute.Display.Details, false, overrideDLCIDs: DlcManager.EXPANSION1));
    ...
    this.TransitTubeTravelSpeed = this.Add(new Attribute(nameof (TransitTubeTravelSpeed), false, Attribute.Display.Never, false));
    this.TransitTubeTravelSpeed.SetFormatter((IAttributeFormatter) new StandardAttributeFormatter(GameUtil.UnitClass.SimpleFloat, GameUtil.TimeSlice.None));
