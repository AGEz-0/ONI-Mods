...
public class ChoreTypes : ResourceSet<ChoreType>
{
    ...
    : base(nameof (ChoreTypes), parent)
  {
    ...
    this.Slip = this.Add(nameof (Slip), new string[0], "", new string[0], (string) DUPLICANTS.CHORES.SLIP.NAME, (string) DUPLICANTS.CHORES.SLIP.STATUS, (string) DUPLICANTS.CHORES.SLIP.TOOLTIP, false);
    ...
    this.WaterDamageZap = this.Add(nameof (WaterDamageZap), new string[0], nameof (EmoteHighPriority), new string[1]
    {
      nameof (MoveTo)
    }, (string) DUPLICANTS.CHORES.WATERDAMAGEZAP.NAME, (string) DUPLICANTS.CHORES.WATERDAMAGEZAP.STATUS, (string) DUPLICANTS.CHORES.WATERDAMAGEZAP.TOOLTIP, false);
    this.BeOffline = this.Add(nameof (BeOffline), new string[0], nameof (BeOffline), new string[0], (string) DUPLICANTS.CHORES.BEOFFLINE.NAME, (string) DUPLICANTS.CHORES.BEOFFLINE.STATUS, (string) DUPLICANTS.CHORES.BEOFFLINE.TOOLTIP, false);
    ...
    this.FindOxygenSourceItem_Critical = this.Add(nameof (FindOxygenSourceItem_Critical), new string[0], "FindOxygenRefill", new string[0], (string) DUPLICANTS.CHORES.FINDOXYGENSOURCEITEM.NAME, (string) DUPLICANTS.CHORES.FINDOXYGENSOURCEITEM.STATUS, (string) DUPLICANTS.CHORES.FINDOXYGENSOURCEITEM.TOOLTIP, false);
    this.BionicAbsorbOxygen_Critical = this.Add(nameof (BionicAbsorbOxygen_Critical), new string[0], "FindOxygenRefill", new string[0], (string) DUPLICANTS.CHORES.BIONICABSORBOXYGENCRITICAL.NAME, (string) DUPLICANTS.CHORES.BIONICABSORBOXYGENCRITICAL.STATUS, (string) DUPLICANTS.CHORES.BIONICABSORBOXYGENCRITICAL.TOOLTIP, false);
    this.ExpellGunk = this.Add(nameof (ExpellGunk), new string[0], "GunkPee", new string[0], (string) DUPLICANTS.CHORES.EXPELLGUNK.NAME, (string) DUPLICANTS.CHORES.EXPELLGUNK.STATUS, (string) DUPLICANTS.CHORES.EXPELLGUNK.TOOLTIP, false);
    ...
    this.RecoverWarmth = this.Add(nameof (RecoverWarmth), new string[0], "", new string[0], (string) DUPLICANTS.CHORES.RECOVERWARMTH.NAME, (string) DUPLICANTS.CHORES.RECOVERWARMTH.STATUS, (string) DUPLICANTS.CHORES.RECOVERWARMTH.TOOLTIP, false);
    this.RecoverFromHeat = this.Add(nameof (RecoverFromHeat), new string[0], "", new string[0], (string) DUPLICANTS.CHORES.RECOVERFROMHEAT.NAME, (string) DUPLICANTS.CHORES.RECOVERFROMHEAT.STATUS, (string) DUPLICANTS.CHORES.RECOVERFROMHEAT.TOOLTIP, false);
    ...
    this.StressShock = this.Add(nameof (StressShock), new string[0], "", new string[1]
    {
      nameof (MoveTo)
    }, (string) DUPLICANTS.CHORES.STRESSSHOCK.NAME, (string) DUPLICANTS.CHORES.STRESSSHOCK.STATUS, (string) DUPLICANTS.CHORES.STRESSSHOCK.TOOLTIP, false);
    ...
    this.ReloadElectrobank = this.Add(nameof (ReloadElectrobank), new string[0], nameof (ReloadElectrobank), new string[0], (string) DUPLICANTS.CHORES.RELOADELECTROBANK.NAME, (string) DUPLICANTS.CHORES.RELOADELECTROBANK.STATUS, (string) DUPLICANTS.CHORES.RELOADELECTROBANK.TOOLTIP, false);
    this.SeekAndInstallUpgrade = this.Add(nameof (SeekAndInstallUpgrade), new string[0], "", new string[0], (string) DUPLICANTS.CHORES.SEEKANDINSTALLUPGRADE.NAME, (string) DUPLICANTS.CHORES.SEEKANDINSTALLUPGRADE.STATUS, (string) DUPLICANTS.CHORES.SEEKANDINSTALLUPGRADE.TOOLTIP, false);
    this.OilChange = this.Add(nameof (OilChange), new string[0], "OilRefill", new string[0], (string) DUPLICANTS.CHORES.OILCHANGE.NAME, (string) DUPLICANTS.CHORES.OILCHANGE.STATUS, (string) DUPLICANTS.CHORES.OILCHANGE.TOOLTIP, false);
    this.SolidOilChange = this.Add(nameof (SolidOilChange), new string[0], "OilRefill", new string[0], (string) DUPLICANTS.CHORES.OILCHANGE.NAME, (string) DUPLICANTS.CHORES.OILCHANGE.STATUS, (string) DUPLICANTS.CHORES.OILCHANGE.TOOLTIP, false);
    this.BionicAbsorbOxygen = this.Add(nameof (BionicAbsorbOxygen), new string[0], "FindOxygenRefill", new string[0], (string) DUPLICANTS.CHORES.BIONICABSORBOXYGEN.NAME, (string) DUPLICANTS.CHORES.BIONICABSORBOXYGEN.STATUS, (string) DUPLICANTS.CHORES.BIONICABSORBOXYGEN.TOOLTIP, false);
    this.FindOxygenSourceItem = this.Add("FindOxygenCanister", new string[0], "FindOxygenRefill", new string[0], (string) DUPLICANTS.CHORES.FINDOXYGENSOURCEITEM.NAME, (string) DUPLICANTS.CHORES.FINDOXYGENSOURCEITEM.STATUS, (string) DUPLICANTS.CHORES.FINDOXYGENSOURCEITEM.TOOLTIP, false);
    ...
    this.BionicRestDueToDisease = this.Add(nameof (BionicRestDueToDisease), new string[0], nameof (Heal), new string[3]
    {
      nameof (Vomit),
      nameof (Cough),
      nameof (EmoteHighPriority)
    ...
    this.BionicBedtimeMode = this.Add(nameof (BionicBedtimeMode), new string[0], "", new string[0], (string) DUPLICANTS.CHORES.BIONICBEDTIMEMODE.NAME, (string) DUPLICANTS.CHORES.BIONICBEDTIMEMODE.STATUS, (string) DUPLICANTS.CHORES.BIONICBEDTIMEMODE.TOOLTIP, false);
    ...
    this.Fart = this.Add(nameof (Fart), new string[0], nameof (Fart), new string[0], (string) DUPLICANTS.CHORES.EMOTEHIGHPRIORITY.NAME, (string) DUPLICANTS.CHORES.EMOTEHIGHPRIORITY.STATUS, (string) DUPLICANTS.CHORES.EMOTEHIGHPRIORITY.TOOLTIP, false);
    ...
    this.ExcavateFossil = this.Add(nameof (ExcavateFossil), new string[3]
    {
      nameof (Research),
      nameof (Art),
      nameof (Dig)
    }, "", new string[0], (string) DUPLICANTS.CHORES.EXCAVATEFOSSIL.NAME, (string) DUPLICANTS.CHORES.EXCAVATEFOSSIL.STATUS, (string) DUPLICANTS.CHORES.EXCAVATEFOSSIL.TOOLTIP, false, 5000);
    ...
    this.RemoteOperate = this.Add(nameof (RemoteOperate), new string[1]
    {
      "MachineOperating"
    }, "", new string[0], (string) DUPLICANTS.CHORES.REMOTEWORK.NAME, (string) DUPLICANTS.CHORES.REMOTEWORK.STATUS, (string) DUPLICANTS.CHORES.REMOTEWORK.TOOLTIP, false, 5000);
    ...
    this.ProcessCritter = this.Add(nameof (ProcessCritter), new string[1]
    {
      "Ranching"
    }, "", new string[0], (string) DUPLICANTS.CHORES.PROCESSCRITTER.NAME, (string) DUPLICANTS.CHORES.PROCESSCRITTER.STATUS, (string) DUPLICANTS.CHORES.PROCESSCRITTER.TOOLTIP, false, 5000);
    ...
    this.BuildUproot = this.Add(nameof (BuildUproot), new string[2]
    {
      nameof (Build),
      "Farming"
    }, "", new string[0], (string) DUPLICANTS.CHORES.BUILDUPROOT.NAME, (string) DUPLICANTS.CHORES.BUILDUPROOT.STATUS, (string) DUPLICANTS.CHORES.BUILDUPROOT.TOOLTIP, true, 5000);
    ...
    this.ArmTrap = this.Add(nameof (ArmTrap), new string[1]
    {
      "Ranching"
    }, "", new string[0], (string) DUPLICANTS.CHORES.ARMTRAP.NAME, (string) DUPLICANTS.CHORES.ARMTRAP.STATUS, (string) DUPLICANTS.CHORES.ARMTRAP.TOOLTIP, false);
    ...
    ChoreType[][] choreTypeArray1 = new ChoreType[37][]
    {
      ...
      new ChoreType[1]{ this.BeOffline },
      ...
      new ChoreType[1]{ this.WaterDamageZap },
      new ChoreType[1]{ this.ExpellGunk },
      new ChoreType[11]
      {
      ...
      new ChoreType[3]{ this.Emote, this.Hug, this.Fart },
      ...
      new ChoreType[2]{ this.RecoverWarmth, this.RecoverFromHeat },
