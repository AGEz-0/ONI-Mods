...
public class SpaceDestinationTypes : ResourceSet<SpaceDestinationType>
{
    ...
    : base("SpaceDestinations", parent)
  {
    ...
    this.Satellite = this.Add(new SpaceDestinationType(nameof (Satellite), parent1, name1, description1, 16 /*0x10*/, "asteroid", elementTable1, artifactDropRate: bad1, cycles: 18));
    ...
    this.MetallicAsteroid = this.Add(new SpaceDestinationType(nameof (MetallicAsteroid), parent2, name2, description2, 32 /*0x20*/, "nebula", elementTable2, recoverableEntities1, mediocre1, 128000000, 127988000, 12));
    ...
    this.RockyAsteroid = this.Add(new SpaceDestinationType(nameof (RockyAsteroid), parent3, name3, description3, 32 /*0x20*/, "new_12", elementTable3, recoverableEntities2, good1, 128000000, 127988000, 18));
    ...
    this.CarbonaceousAsteroid = this.Add(new SpaceDestinationType(nameof (CarbonaceousAsteroid), parent4, name4, description4, 32 /*0x20*/, "new_08", elementTable4, artifactDropRate: mediocre2, max: 128000000, min: 127988000));
    ...
    this.IcyDwarf = this.Add(new SpaceDestinationType(nameof (IcyDwarf), parent5, name5, description5, 64 /*0x40*/, "icyMoon", elementTable5, recoverableEntities3, great1, 256000000, 255982000, 24));
    ...
    recoverableEntities4.Add("Moo", 2);
    recoverableEntities4.Add("GasGrassSeed", 12);
    ArtifactDropRate great2 = Db.Get().ArtifactDropRates.Great;
    this.OrganicDwarf = this.Add(new SpaceDestinationType(nameof (OrganicDwarf), parent6, name6, description6, 64 /*0x40*/, "organicAsteroid", elementTable6, recoverableEntities4, great2, 256000000, 255982000, 30));
    ...
    this.DustyMoon = this.Add(new SpaceDestinationType(nameof (DustyMoon), parent7, name7, description7, 64 /*0x40*/, "new_05", elementTable7, artifactDropRate: amazing1, max: 256000000, min: 255982000, cycles: 42));
    ...
    this.TerraPlanet = this.Add(new SpaceDestinationType(nameof (TerraPlanet), parent8, name8, description8, 96 /*0x60*/, "terra", elementTable8, recoverableEntities5, amazing2, 384000000, 383980000, 54));
    ...
    this.VolcanoPlanet = this.Add(new SpaceDestinationType(nameof (VolcanoPlanet), parent9, name9, description9, 96 /*0x60*/, "planet", elementTable9, artifactDropRate: amazing3, max: 384000000, min: 383980000, cycles: 54));
    ...
    this.GasGiant = this.Add(new SpaceDestinationType(nameof (GasGiant), parent10, name10, description10, 96 /*0x60*/, "gasGiant", elementTable10, artifactDropRate: perfect1, max: 384000000, min: 383980000, cycles: 60));
    ...
    this.IceGiant = this.Add(new SpaceDestinationType(nameof (IceGiant), parent11, name11, description11, 96 /*0x60*/, "icyMoon", elementTable11, artifactDropRate: perfect2, max: 384000000, min: 383980000, cycles: 60));
    ...
    this.SaltDwarf = this.Add(new SpaceDestinationType(nameof (SaltDwarf), parent12, name12, description12, 64 /*0x40*/, "new_01", elementTable12, recoverableEntities6, bad2, 256000000, 255982000, 30));
    ...
    this.RustPlanet = this.Add(new SpaceDestinationType(nameof (RustPlanet), parent13, name13, description13, 96 /*0x60*/, "new_06", elementTable13, artifactDropRate: perfect3, max: 384000000, min: 383980000, cycles: 60));
    ...
    this.ForestPlanet = this.Add(new SpaceDestinationType(nameof (ForestPlanet), parent14, name14, description14, 96 /*0x60*/, "new_07", elementTable14, recoverableEntities7, mediocre3, 384000000, 383980000, 24));
    ...
    this.RedDwarf = this.Add(new SpaceDestinationType(nameof (RedDwarf), parent15, name15, description15, 64 /*0x40*/, "sun", elementTable15, artifactDropRate: amazing4, max: 256000000, min: 255982000, cycles: 42));
    ...
    this.GoldAsteroid = this.Add(new SpaceDestinationType(nameof (GoldAsteroid), parent16, name16, description16, 32 /*0x20*/, "new_02", elementTable16, artifactDropRate: bad3, max: 128000000, min: 127988000, cycles: 90));
    ...
    this.HydrogenGiant = this.Add(new SpaceDestinationType("HeliumGiant", parent17, name17, description17, 96 /*0x60*/, "new_11", elementTable17, artifactDropRate: mediocre4, max: 384000000, min: 383980000, cycles: 78));
    ...
    this.OilyAsteroid = this.Add(new SpaceDestinationType("OilyAsteriod", parent18, name18, description18, 32 /*0x20*/, "new_09", elementTable18, artifactDropRate: mediocre5, max: 128000000, min: 127988000, cycles: 12));
    ...
    this.ShinyPlanet = this.Add(new SpaceDestinationType(nameof (ShinyPlanet), parent19, name19, description19, 96 /*0x60*/, "new_04", elementTable19, artifactDropRate: good2, max: 384000000, min: 383980000, cycles: 84));
    ...
    this.ChlorinePlanet = this.Add(new SpaceDestinationType(nameof (ChlorinePlanet), parent20, name20, description20, 96 /*0x60*/, "new_10", elementTable20, artifactDropRate: bad4, max: 256000000, min: 255982000, cycles: 90));
    ...
    this.SaltDesertPlanet = this.Add(new SpaceDestinationType(nameof (SaltDesertPlanet), parent21, name21, description21, 96 /*0x60*/, "new_10", elementTable21, recoverableEntities8, bad5, 384000000, 383980000, 60));
    ...
    this.Wormhole = this.Add(new SpaceDestinationType(nameof (Wormhole), parent22, name22, description22, 96 /*0x60*/, "new_03", elementTable22, artifactDropRate: perfect4, max: 0, min: 0, cycles: 0));
    this.Earth = this.Add(new SpaceDestinationType(nameof (Earth), parent, (string) UI.SPACEDESTINATIONS.PLANETS.SHATTEREDPLANET.NAME, (string) UI.SPACEDESTINATIONS.PLANETS.SHATTEREDPLANET.DESCRIPTION, 96 /*0x60*/, "earth", new Dictionary<SimHashes, MathUtil.MinMax>(), artifactDropRate: Db.Get().ArtifactDropRates.None, max: 0, min: 0, cycles: 0, visitable: false));
    if (DlcManager.IsContentSubscribed("DLC2_ID"))
    {
      ResourceSet parent23 = parent;
      string name23 = (string) UI.SPACEDESTINATIONS.PLANETS.DLC2CERESSPACEDESTINATION.NAME;
      string description23 = (string) UI.SPACEDESTINATIONS.PLANETS.DLC2CERESSPACEDESTINATION.DESCRIPTION;
      Dictionary<SimHashes, MathUtil.MinMax> elementTable23 = new Dictionary<SimHashes, MathUtil.MinMax>();
      elementTable23.Add(SimHashes.Cinnabar, new MathUtil.MinMax(100f, 200f));
      elementTable23.Add(SimHashes.Mercury, new MathUtil.MinMax(100f, 200f));
      elementTable23.Add(SimHashes.Ice, new MathUtil.MinMax(100f, 200f));
      Dictionary<string, int> recoverableEntities9 = new Dictionary<string, int>();
      recoverableEntities9.Add("WoodDeer", 3);
      recoverableEntities9.Add("HardSkinBerryPlantSeed", 4);
      ArtifactDropRate good3 = Db.Get().ArtifactDropRates.Good;
      this.DLC2CeresSpaceDestination = this.Add(new SpaceDestinationType(nameof (DLC2CeresSpaceDestination), parent23, name23, description23, 96 /*0x60*/, "ceres_debris_field", elementTable23, recoverableEntities9, good3, 384000000, 383980000, 60));
    }
    if (!DlcManager.IsContentSubscribed("DLC4_ID"))
      return;
    ResourceSet parent24 = parent;
    string name24 = (string) UI.SPACEDESTINATIONS.PLANETS.DLC4PREHISTORICSPACEDESTINATION.NAME;
    string description24 = (string) UI.SPACEDESTINATIONS.PLANETS.DLC4PREHISTORICSPACEDESTINATION.DESCRIPTION;
    Dictionary<SimHashes, MathUtil.MinMax> elementTable24 = new Dictionary<SimHashes, MathUtil.MinMax>();
    elementTable24.Add(SimHashes.NickelOre, new MathUtil.MinMax(100f, 200f));
    elementTable24.Add(SimHashes.Peat, new MathUtil.MinMax(100f, 200f));
    elementTable24.Add(SimHashes.Shale, new MathUtil.MinMax(100f, 200f));
    elementTable24.Add(SimHashes.Amber, new MathUtil.MinMax(100f, 200f));
    elementTable24.Add(SimHashes.Iridium, new MathUtil.MinMax(100f, 200f));
    Dictionary<string, int> recoverableEntities10 = new Dictionary<string, int>();
    recoverableEntities10.Add("Stego", 1);
    recoverableEntities10.Add("Raptor", 1);
    recoverableEntities10.Add("VineMotherSeed", 4);
    ArtifactDropRate good4 = Db.Get().ArtifactDropRates.Good;
    this.DLC4PrehistoricSpaceDestination = this.Add(new SpaceDestinationType(nameof (DLC4PrehistoricSpaceDestination), parent24, name24, description24, 96 /*0x60*/, "prehistoric_base", elementTable24, recoverableEntities10, good4, 384000000, 383980000, 60));
    ResourceSet parent25 = parent;
    string name25 = (string) UI.SPACEDESTINATIONS.PLANETS.DLC4PREHISTORICDEMOLIORSPACEDESTINATION.NAME;
    string description25 = (string) UI.SPACEDESTINATIONS.PLANETS.DLC4PREHISTORICDEMOLIORSPACEDESTINATION.DESCRIPTION;
    Dictionary<SimHashes, MathUtil.MinMax> elementTable25 = new Dictionary<SimHashes, MathUtil.MinMax>();
    elementTable25.Add(SimHashes.Iridium, new MathUtil.MinMax(100f, 200f));
    elementTable25.Add(SimHashes.MaficRock, new MathUtil.MinMax(100f, 200f));
    elementTable25.Add(SimHashes.Gold, new MathUtil.MinMax(100f, 200f));
    elementTable25.Add(SimHashes.Granite, new MathUtil.MinMax(100f, 200f));
    ArtifactDropRate none1 = Db.Get().ArtifactDropRates.None;
    this.DLC4PrehistoricDemoliorSpaceDestination = this.Add(new SpaceDestinationType(nameof (DLC4PrehistoricDemoliorSpaceDestination), parent25, name25, description25, 96 /*0x60*/, "prehistoric_demolior_debris1", elementTable25, artifactDropRate: none1, max: 384000000, min: 383980000, cycles: 60));
    ResourceSet parent26 = parent;
    string name26 = (string) UI.SPACEDESTINATIONS.PLANETS.DLC4PREHISTORICDEMOLIORSPACEDESTINATION2.NAME;
    string description26 = (string) UI.SPACEDESTINATIONS.PLANETS.DLC4PREHISTORICDEMOLIORSPACEDESTINATION2.DESCRIPTION;
    Dictionary<SimHashes, MathUtil.MinMax> elementTable26 = new Dictionary<SimHashes, MathUtil.MinMax>();
    elementTable26.Add(SimHashes.Isoresin, new MathUtil.MinMax(100f, 200f));
    elementTable26.Add(SimHashes.Petroleum, new MathUtil.MinMax(100f, 200f));
    elementTable26.Add(SimHashes.LiquidSulfur, new MathUtil.MinMax(100f, 200f));
    ArtifactDropRate none2 = Db.Get().ArtifactDropRates.None;
    this.DLC4PrehistoricDemoliorSpaceDestination2 = this.Add(new SpaceDestinationType(nameof (DLC4PrehistoricDemoliorSpaceDestination2), parent26, name26, description26, 96 /*0x60*/, "prehistoric_demolior_debris2", elementTable26, artifactDropRate: none2, max: 384000000, min: 383980000, cycles: 60));
    ResourceSet parent27 = parent;
    string name27 = (string) UI.SPACEDESTINATIONS.PLANETS.DLC4PREHISTORICDEMOLIORSPACEDESTINATION3.NAME;
    string description27 = (string) UI.SPACEDESTINATIONS.PLANETS.DLC4PREHISTORICDEMOLIORSPACEDESTINATION3.DESCRIPTION;
    Dictionary<SimHashes, MathUtil.MinMax> elementTable27 = new Dictionary<SimHashes, MathUtil.MinMax>();
    elementTable27.Add(SimHashes.MoltenIridium, new MathUtil.MinMax(100f, 200f));
    elementTable27.Add(SimHashes.LiquidOxygen, new MathUtil.MinMax(100f, 200f));
    elementTable27.Add(SimHashes.LiquidHydrogen, new MathUtil.MinMax(100f, 200f));
    elementTable27.Add(SimHashes.Magma, new MathUtil.MinMax(100f, 200f));
    ArtifactDropRate none3 = Db.Get().ArtifactDropRates.None;
    this.DLC4PrehistoricDemoliorSpaceDestination3 = this.Add(new SpaceDestinationType(nameof (DLC4PrehistoricDemoliorSpaceDestination3), parent27, name27, description27, 96 /*0x60*/, "prehistoric_demolior_debris3", elementTable27, artifactDropRate: none3, max: 384000000, min: 383980000, cycles: 60));
  }
}
