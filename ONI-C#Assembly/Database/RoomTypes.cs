...
public class RoomTypes : ResourceSet<RoomType>
{
    ...
    : base(nameof (RoomTypes), parent)
  {
    ...
    }, new RoomDetails.Detail[2]
    {
      RoomDetails.SIZE,
      RoomDetails.BUILDING_COUNT
    }, 2, single_assignee: true, priority_building_use: true, sortKey: 15));
    ...
    }, new RoomDetails.Detail[2]
    {
      RoomDetails.SIZE,
      RoomDetails.BUILDING_COUNT
    }, 2, single_assignee: true, priority_building_use: true, sortKey: 16 /*0x10*/);
    ...
    }, new RoomDetails.Detail[2]
    {
      RoomDetails.SIZE,
      RoomDetails.BUILDING_COUNT
    }, single_assignee: true, priority_building_use: true, sortKey: 17));
    ...
    }, new RoomDetails.Detail[4]
    {
      ...
      RoomDetails.CREATURE_COUNT,
      RoomDetails.PLANT_COUNT
    }, 1, effects: new string[1]{ "RoomNatureReserve" }, sortKey: 19));
