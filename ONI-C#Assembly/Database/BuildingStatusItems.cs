...
public class BuildingStatusItems : StatusItems
{
  ...
  private void CreateStatusItems()
  {
    ...
    this.ChangeStorageTileTarget = this.CreateStatusItem("ChangeStorageTileTarget", "BUILDING", "status_item_pending_switch_toggle", StatusItem.IconType.Custom, NotificationType.Neutral, false, OverlayModes.None.ID);
    this.ChangeStorageTileTarget.resolveStringCallback = (Func<string, object, string>) ((str, data) =>
    {
    ...
    this.GunkEmptierFull = this.CreateStatusItem("GunkEmptierFull", "BUILDING", "", StatusItem.IconType.Info, NotificationType.BadMinor, false, OverlayModes.None.ID, false);
    ...
    this.PowerBankChargerInProgress = this.CreateStatusItem("PowerBankChargerInProgress", "BUILDING", "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID);
    this.PowerBankChargerInProgress.resolveStringCallback = (Func<string, object, string>) ((str, data) =>
    {
      if (data == null)
        return str;
      ...
      if ((UnityEngine.Object) instance.targetElectrobank != (UnityEngine.Object) null)
        str = string.Format(str, (object) GameUtil.GetFormattedWattage(400f));
      return str;
    });
    ...
    this.NotSubmerged = this.CreateStatusItem("NotSubmerged", "BUILDING", "status_item_flooded", StatusItem.IconType.Custom, NotificationType.BadMinor, false, OverlayModes.None.ID);
    ...
    this.MercuryLight_Charging = this.CreateStatusItem("MercuryLight_Charging", "BUILDING", "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID);
    this.MercuryLight_Charging.resolveStringCallback = (Func<string, object, string>) ((str, data) =>
    {
      MercuryLight.Instance instance = (MercuryLight.Instance) data;
      str = string.Format(str, (object) GameUtil.GetFormattedPercent(instance.ChargeLevel * 100f));
      return str;
    });
    this.MercuryLight_Charging.resolveTooltipCallback = (Func<string, object, string>) ((str, data) =>
    {
      MercuryLight.Instance instance = (MercuryLight.Instance) data;
      str = string.Format(str, (object) GameUtil.GetFormattedTime((1f - instance.ChargeLevel) * instance.def.TURN_ON_DELAY));
      return str;
    });
    this.MercuryLight_Depleating = this.CreateStatusItem("MercuryLight_Depleating", "BUILDING", "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID);
    this.MercuryLight_Depleating.resolveStringCallback = (Func<string, object, string>) ((str, data) =>
    {
      MercuryLight.Instance instance = (MercuryLight.Instance) data;
      str = string.Format(str, (object) GameUtil.GetFormattedPercent(instance.ChargeLevel * 100f));
      return str;
    });
    this.MercuryLight_Charged = this.CreateStatusItem("MercuryLight_Charged", "BUILDING", "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID);
    this.MercuryLight_Depleated = this.CreateStatusItem("MercuryLight_Depleated", "BUILDING", "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID);
    ...
    this.CoolingWater = this.CreateStatusItem("CoolingWater", "BUILDING", "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID);
    ...
    this.NewDuplicantsAvailable.notificationClickCallback = (Notification.ClickCallback) (data =>
    {
      ...
      {
        if (Components.Telepads[idx2].GetComponent<KSelectable>().IsSelected)
        {
      ...
      GameUtil.FocusCameraOnWorld(targetTelepad.GetMyWorldId(), targetTelepad.transform.GetPosition(), callback: (System.Action) (() => SelectTool.Instance.Select(targetTelepad.GetComponent<KSelectable>())));
    });
    ...
    this.RequiresSkillPerk.resolveTooltipCallback = (Func<string, object, string>) ((str, data) =>
    {
      str = (string) (Game.IsDlcActiveForCurrentSave("DLC3_ID") ? BUILDING.STATUSITEMS.REQUIRESSKILLPERK.TOOLTIP_DLC3 : BUILDING.STATUSITEMS.REQUIRESSKILLPERK.TOOLTIP);
      str = str.Replace("{Skills}", GameUtil.NamesOfSkillsWithSkillPerk((string) data));
    ...
    this.DigRequiresSkillPerk.resolveStringCallback = (Func<string, object, string>) ((str, data) =>
    {
      str = str.Replace("{Skills}", GameUtil.NamesOfSkillsWithSkillPerk((string) data));
      return str;
    });
    this.DigRequiresSkillPerk.resolveTooltipCallback = (Func<string, object, string>) ((str, data) =>
    {
      str = (string) (Game.IsDlcActiveForCurrentSave("DLC3_ID") ? BUILDING.STATUSITEMS.DIGREQUIRESSKILLPERK.TOOLTIP_DLC3 : BUILDING.STATUSITEMS.DIGREQUIRESSKILLPERK.TOOLTIP);
      str = str.Replace("{Skills}", GameUtil.NamesOfSkillsWithSkillPerk((string) data));
      str = str.Replace("{Boosters}", GameUtil.NamesOfBoostersWithSkillPerk((string) data));
      return str;
    });
    ...
    {
      str = (string) (Game.IsDlcActiveForCurrentSave("DLC3_ID") ? BUILDING.STATUSITEMS.COLONYLACKSREQUIREDSKILLPERK.TOOLTIP_DLC3 : BUILDING.STATUSITEMS.COLONYLACKSREQUIREDSKILLPERK.TOOLTIP);
      str = str.Replace("{Skills}", GameUtil.NamesOfSkillsWithSkillPerk((string) data));
      str = str.Replace("{Boosters}", GameUtil.NamesOfBoostersWithSkillPerk((string) data));
      return str;
    });
    ...
    this.ClusterColonyLacksRequiredSkillPerk.resolveStringCallback = (Func<string, object, string>) ((str, data) =>
    {
      str = str.Replace("{Skills}", GameUtil.NamesOfSkillsWithSkillPerk((string) data));
      return str;
    });
    this.ClusterColonyLacksRequiredSkillPerk.resolveTooltipCallback = (Func<string, object, string>) ((str, data) =>
    {
      str = (string) (Game.IsDlcActiveForCurrentSave("DLC3_ID") ? BUILDING.STATUSITEMS.CLUSTERCOLONYLACKSREQUIREDSKILLPERK.TOOLTIP_DLC3 : BUILDING.STATUSITEMS.CLUSTERCOLONYLACKSREQUIREDSKILLPERK.TOOLTIP);
      str = str.Replace("{Skills}", GameUtil.NamesOfSkillsWithSkillPerk((string) data));
      str = str.Replace("{Boosters}", GameUtil.NamesOfBoostersWithSkillPerk((string) data));
      return str;
    });
    ...
    this.FossilMineIdle = this.CreateStatusItem("FossilIdle", "CODEX.STORY_TRAITS.FOSSILHUNT", "status_item_fabricator_select", StatusItem.IconType.Custom, NotificationType.Neutral, false, OverlayModes.None.ID);
    this.FossilMineEmpty = this.CreateStatusItem("FossilEmpty", "CODEX.STORY_TRAITS.FOSSILHUNT", "", StatusItem.IconType.Info, NotificationType.BadMinor, false, OverlayModes.None.ID);
    this.FossilMinePendingWork = this.CreateStatusItem("FossilMinePendingWork", "CODEX.STORY_TRAITS.FOSSILHUNT", "", StatusItem.IconType.Info, NotificationType.BadMinor, false, OverlayModes.None.ID);
    this.FossilEntombed = new StatusItem("FossilEntombed", "CODEX.STORY_TRAITS.FOSSILHUNT", "status_item_entombed", StatusItem.IconType.Custom, NotificationType.BadMinor, false, OverlayModes.None.ID);
    ...
    this.MilkSeparatorNeedsEmptying = this.CreateStatusItem("MilkSeparatorNeedsEmptying", "BUILDING", "status_item_need_supply_out", StatusItem.IconType.Custom, NotificationType.BadMinor, false, OverlayModes.None.ID);
    ...
    this.UnusableGunked = this.CreateStatusItem("UnusableGunked", "BUILDING", "", StatusItem.IconType.Info, NotificationType.BadMinor, false, OverlayModes.None.ID);
    ...
    this.KettleInsuficientSolids = this.CreateStatusItem("KettleInsuficientSolids", "BUILDING", "", StatusItem.IconType.Exclamation, NotificationType.Neutral, false, OverlayModes.None.ID, false);
    this.KettleInsuficientSolids.resolveStringCallback = (Func<string, object, string>) ((str, data) =>
    {
      IceKettle.Instance instance = (IceKettle.Instance) data;
      str = string.Format(str, (object) GameUtil.GetFormattedMass(instance.def.KGToMeltPerBatch));
      return str;
    });
    this.KettleInsuficientFuel = this.CreateStatusItem("KettleInsuficientFuel", "BUILDING", "", StatusItem.IconType.Exclamation, NotificationType.Neutral, false, OverlayModes.None.ID, false);
    this.KettleInsuficientFuel.resolveStringCallback = (Func<string, object, string>) ((str, data) =>
    {
      IceKettle.Instance instance = (IceKettle.Instance) data;
      str = string.Format(str, (object) GameUtil.GetFormattedMass(instance.FuelRequiredForNextBratch));
      return str;
    });
    this.KettleInsuficientLiquidSpace = this.CreateStatusItem("KettleInsuficientLiquidSpace", "BUILDING", "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID);
    this.KettleInsuficientLiquidSpace.resolveStringCallback = (Func<string, object, string>) ((str, data) =>
    {
      IceKettle.Instance instance = (IceKettle.Instance) data;
      str = string.Format(str, (object) GameUtil.GetFormattedMass(instance.LiquidStored), (object) GameUtil.GetFormattedMass(instance.LiquidTankCapacity), (object) GameUtil.GetFormattedMass(instance.def.KGToMeltPerBatch));
      return str;
    });
    this.KettleMelting = this.CreateStatusItem("KettleMelting", "BUILDING", "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID);
    this.KettleMelting.resolveStringCallback = (Func<string, object, string>) ((str, data) =>
    {
      IceKettle.Instance instance = (IceKettle.Instance) data;
      str = string.Format(str, (object) GameUtil.GetFormattedTemperature(instance.def.TargetTemperature));
      return str;
    });
    ...
    this.BatteryJoulesAvailable = this.CreateStatusItem("JoulesAvailable", "BUILDING", "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.Power.ID);
    this.BatteryJoulesAvailable.resolveStringCallback = (Func<string, object, string>) ((str, data) =>
    {
    ...
    this.ElectrobankJoulesAvailable = this.CreateStatusItem("ElectrobankJoulesAvailable", "BUILDING", "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.Power.ID);
    this.ElectrobankJoulesAvailable.resolveStringCallback = (Func<string, object, string>) ((str, data) =>
    {
    ...
    {
      str = str.Replace("{cycles}", $"{(ValueType) (float) ((3000.0 - (double) ((WarpPortal) data).rechargeProgress) / 600.0):0.0}");
      return str;
    });
    ...
    this.WaitingToLand = this.CreateStatusItem("WaitingToLand", "BUILDING", "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID);
    this.WaitingToLand.resolveStringCallback = (Func<string, object, string>) ((str, data) =>
    {
      ClusterGridEntity clusterGridEntity = (ClusterGridEntity) data;
      return str.Replace("{Destination}", clusterGridEntity.Name);
    });
    ...
    this.InFlight.resolveStringCallback = (Func<string, object, string>) ((str, data) =>
    {
      ...
      if (!((UnityEngine.Object) destinationSelector != (UnityEngine.Object) null))
      ...
      string newValue = (UnityEngine.Object) destinationPad != (UnityEngine.Object) null ? destinationPad.GetProperName() : UI.UISIDESCREENS.CLUSTERDESTINATIONSIDESCREEN.FIRSTAVAILABLE.ToString();
    ...
    this.NoRocketsToMissionControlBoost = this.CreateStatusItem("NoRocketsToMissionControlBoost", "BUILDING", "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID);
    ...
    this.TransitTubeEntranceWaxReady = this.CreateStatusItem("TransitTubeEntranceWaxReady", "BUILDING", "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID);
    this.TransitTubeEntranceWaxReady.resolveStringCallback = (Func<string, object, string>) ((str, data) =>
    {
    ...
    this.SpecialCargoBayClusterCritterStored = this.CreateStatusItem("SpecialCargoBayClusterCritterStored", "BUILDING", "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID);
    this.SpecialCargoBayClusterCritterStored.resolveStringCallback = (Func<string, object, string>) ((str, data) =>
    {
      SpecialCargoBayClusterReceptacle clusterReceptacle = data as SpecialCargoBayClusterReceptacle;
      if ((UnityEngine.Object) clusterReceptacle.Occupant != (UnityEngine.Object) null)
        str = str.Replace("{0}", clusterReceptacle.Occupant.GetProperName());
      return str;
    });
    ...
    this.InFlightPiloted = this.CreateStatusItem("InFlightPiloted", "BUILDING", "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID);
    this.InFlightPiloted.resolveTooltipCallback = (Func<string, object, string>) ((str, data) =>
    {
      Clustercraft clustercraft = (Clustercraft) data;
      bool is_robo_pilot;
      clustercraft.ModuleInterface.GetPrimaryPilotModule(out is_robo_pilot);
      str = is_robo_pilot ? (string) BUILDING.STATUSITEMS.INFLIGHTPILOTED.ROBO_TOOLTIP : string.Format((string) BUILDING.STATUSITEMS.INFLIGHTPILOTED.DUPE_TOOLTIP, (object) GameUtil.GetFormattedPercent((float) (((double) clustercraft.PilotSkillMultiplier - 1.0) * 100.0)));
      return str;
    });
    this.InFlightUnpiloted = this.CreateStatusItem("InFlightUnpiloted", "BUILDING", "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID);
    this.InFlightUnpiloted.resolveTooltipCallback = (Func<string, object, string>) ((str, data) =>
    {
      Clustercraft clustercraft = (Clustercraft) data;
      ...
      {
        if ((UnityEngine.Object) passengerModule == (UnityEngine.Object) null)
          return (string) BUILDING.STATUSITEMS.INFLIGHTUNPILOTED.ROBO_PILOT_ONLY_TOOLTIP;
        newValue = $"{newValue}\n    • {robotPilotModule.GetProperName()}";
      }
      return str.Replace("{penalty}", GameUtil.GetFormattedPercent(50f)).Replace("{modules}", newValue);
    });
    this.InFlightAutoPiloted = this.CreateStatusItem("InFlightAutoPiloted", "BUILDING", "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID);
    this.InFlightAutoPiloted.resolveTooltipCallback = (Func<string, object, string>) ((str, data) =>
    {
      ...
      DebugUtil.DevAssert((UnityEngine.Object) passengerModule != (UnityEngine.Object) null, "Auto pilot should never engage if there is no passenger module");
      return str;
    });
    this.InFlightSuperPilot = this.CreateStatusItem("InFlightSuperPilot", "BUILDING", "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID);
    this.InFlightSuperPilot.resolveTooltipCallback = (Func<string, object, string>) ((str, data) =>
    {
      Clustercraft clustercraft = (Clustercraft) data;
      str = string.Format(str, (object) GameUtil.GetFormattedPercent((float) (((double) clustercraft.PilotSkillMultiplier - 1.0) * 100.0)), (object) GameUtil.GetFormattedPercent(50f));
      return str;
    });
    ...
    this.TrapNeedsArming = this.CreateStatusItem("CREATURE_REUSABLE_TRAP.NEEDS_ARMING", "BUILDING", "status_item_bait", StatusItem.IconType.Custom, NotificationType.BadMinor, false, OverlayModes.None.ID);
    this.TrapArmed = this.CreateStatusItem("CREATURE_REUSABLE_TRAP.READY", "BUILDING", "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID);
    this.TrapHasCritter = this.CreateStatusItem("CREATURE_REUSABLE_TRAP.SPRUNG", "BUILDING", "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID);
    this.TrapHasCritter.resolveTooltipCallback = (Func<string, object, string>) ((str, data) =>
    {
      string newValue = "";
      if (data != null)
    ...
    this.GeoTunerGeyserStatus.resolveStringCallback = (Func<string, object, string>) ((str, data) =>
    {
      ...
      bool flag1 = (UnityEngine.Object) assignedGeyser != (UnityEngine.Object) null && assignedGeyser.smi.GetCurrentState() != null && assignedGeyser.smi.GetCurrentState().parent == assignedGeyser.smi.sm.erupt;
      bool flag2 = (UnityEngine.Object) assignedGeyser != (UnityEngine.Object) null && assignedGeyser.smi.GetCurrentState() == assignedGeyser.smi.sm.dormant;
    ...
    {
      Geyser assignedGeyser = ((GeoTuner.Instance) data).GetAssignedGeyser();
      if ((UnityEngine.Object) assignedGeyser != (UnityEngine.Object) null)
        assignedGeyser.gameObject.GetProperName();
      bool flag3 = (UnityEngine.Object) assignedGeyser != (UnityEngine.Object) null && assignedGeyser.smi.GetCurrentState() != null && assignedGeyser.smi.GetCurrentState().parent == assignedGeyser.smi.sm.erupt;
      bool flag4 = (UnityEngine.Object) assignedGeyser != (UnityEngine.Object) null && assignedGeyser.smi.GetCurrentState() == assignedGeyser.smi.sm.dormant;
    ...
    this.GeyserGeotuned.resolveStringCallback = (Func<string, object, string>) ((str, data) =>
    {
      ...
      int num1 = 0;
      int num2 = Components.GeoTuners.GetItems(geyser.GetMyWorldId()).Count<GeoTuner.Instance>((Func<GeoTuner.Instance, bool>) (x => (UnityEngine.Object) x.GetAssignedGeyser() == (UnityEngine.Object) geyser));
    ...
    this.GeyserGeotuned.resolveTooltipCallback = (Func<string, object, string>) ((str, data) =>
    {
      Geyser geyser = (Geyser) data;
      int num3 = 0;
      int num4 = Components.GeoTuners.GetItems(geyser.GetMyWorldId()).Count<GeoTuner.Instance>((Func<GeoTuner.Instance, bool>) (x => (UnityEngine.Object) x.GetAssignedGeyser() == (UnityEngine.Object) geyser));
      for (int index = 0; index < geyser.modifications.Count; ++index)
      {
        if (geyser.modifications[index].originID.Contains("GeoTuner"))
          ++num3;
    ...
    this.SkyVisNone = new StatusItem("SkyVisNone", (string) BUILDING.STATUSITEMS.SPACE_VISIBILITY_NONE.NAME, (string) BUILDING.STATUSITEMS.SPACE_VISIBILITY_NONE.TOOLTIP, "status_item_no_sky", StatusItem.IconType.Custom, NotificationType.Bad, false, OverlayModes.None.ID, resolve_string_callback: new Func<string, object, string>(SkyVisResolveStringCallback));
    this.SkyVisLimited = new StatusItem("SkyVisLimited", (string) BUILDING.STATUSITEMS.SPACE_VISIBILITY_REDUCED.NAME, (string) BUILDING.STATUSITEMS.SPACE_VISIBILITY_REDUCED.TOOLTIP, "status_item_no_sky", StatusItem.IconType.Info, NotificationType.BadMinor, false, OverlayModes.None.ID, showWorldIcon: false, resolve_string_callback: new Func<string, object, string>(SkyVisResolveStringCallback));
    ...
    this.CreatureManipulatorProgress.resolveTooltipCallback = (Func<string, object, string>) ((str, data) =>
    {
      ...
      else
      {
        foreach (Tag scannedSpecy in instance.ScannedSpecies)
          str = $"{str}\n • {(string) Strings.Get("STRINGS.CREATURES.FAMILY_PLURAL." + scannedSpecy.ToString().ToUpper())}";
      }
      return str;
    });
    ...
    this.MegaBrainTankActivationProgress.resolveStringCallback = (Func<string, object, string>) ((str, data) =>
    {
      ...
      return str.Replace("{ActivationProgress}", $"{statesInstance.ActivationProgress}/{(ValueType) (short) 25}");
    });
    ...
    this.FossilHuntExcavationOrdered = this.CreateStatusItem("FossilHuntExcavationOrdered", (string) BUILDING.STATUSITEMS.FOSSILHUNT.PENDING_EXCAVATION.NAME, (string) BUILDING.STATUSITEMS.FOSSILHUNT.PENDING_EXCAVATION.TOOLTIP, "", StatusItem.IconType.Info, NotificationType.Good, false, OverlayModes.None.ID);
    this.FossilHuntExcavationInProgress = this.CreateStatusItem("FossilHuntExcavationInProgress", (string) BUILDING.STATUSITEMS.FOSSILHUNT.EXCAVATING.NAME, (string) BUILDING.STATUSITEMS.FOSSILHUNT.EXCAVATING.TOOLTIP, "", StatusItem.IconType.Info, NotificationType.Good, false, OverlayModes.None.ID);
    this.ComplexFabricatorCooking = this.CreateStatusItem("COMPLEXFABRICATOR.COOKING", "BUILDING", "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID);
    this.ComplexFabricatorCooking.resolveStringCallback = (Func<string, object, string>) ((str, data) =>
    {
      ComplexFabricator complexFabricator = data as ComplexFabricator;
      if ((UnityEngine.Object) complexFabricator != (UnityEngine.Object) null && complexFabricator.CurrentWorkingOrder != null)
        str = str.Replace("{Item}", complexFabricator.CurrentWorkingOrder.FirstResult.ProperName());
      return str;
    });
    this.ComplexFabricatorProducing = this.CreateStatusItem("COMPLEXFABRICATOR.PRODUCING", "BUILDING", "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID);
    this.ComplexFabricatorProducing.resolveStringCallback = (Func<string, object, string>) ((str, data) =>
    {
      ComplexFabricator complexFabricator = data as ComplexFabricator;
      if ((UnityEngine.Object) complexFabricator != (UnityEngine.Object) null)
      {
        ...
        {
          string newValue = complexFabricator.CurrentWorkingOrder.results[0].facadeID.IsNullOrWhiteSpace() ? complexFabricator.CurrentWorkingOrder.FirstResult.ProperName() : ((Tag) complexFabricator.CurrentWorkingOrder.results[0].facadeID).ProperName();
          str = str.Replace("{Item}", newValue);
        }
        return str;
      }
      TinkerStation tinkerStation = data as TinkerStation;
      if ((UnityEngine.Object) tinkerStation != (UnityEngine.Object) null)
        str = str.Replace("{Item}", tinkerStation.outputPrefab.ProperName());
      return str;
    });
    this.ComplexFabricatorResearching = this.CreateStatusItem("COMPLEXFABRICATOR.RESEARCHING", "BUILDING", "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID);
    this.ComplexFabricatorResearching.resolveStringCallback = (Func<string, object, string>) ((str, data) =>
    {
    ...
    this.ArtifactAnalysisAnalyzing = this.CreateStatusItem("COMPLEXFABRICATOR.ANALYZING", "BUILDING", "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID);
    this.ArtifactAnalysisAnalyzing.resolveStringCallback = (Func<string, object, string>) ((str, data) =>
    {
      if ((UnityEngine.Object) (data as GameObject) != (UnityEngine.Object) null)
        str = str.Replace("{Item}", (data as GameObject).GetProperName());
      return str;
    });
    this.ComplexFabricatorTraining = this.CreateStatusItem("COMPLEXFABRICATOR.UNTRAINING", "BUILDING", "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID);
    this.ComplexFabricatorTraining.resolveStringCallback = (Func<string, object, string>) ((str, data) =>
    {
      ResetSkillsStation resetSkillsStation = data as ResetSkillsStation;
      if ((UnityEngine.Object) resetSkillsStation != (UnityEngine.Object) null && resetSkillsStation.assignable.assignee != null)
        str = str.Replace("{Duplicant}", resetSkillsStation.assignable.assignee.GetProperName());
      return str;
    });
    this.TelescopeWorking = this.CreateStatusItem("COMPLEXFABRICATOR.TELESCOPE", "BUILDING", "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID);
    this.ClusterTelescopeMeteorWorking = this.CreateStatusItem("COMPLEXFABRICATOR.CLUSTERTELESCOPEMETEOR", "BUILDING", "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID);
    this.MorbRoverMakerDusty = this.CreateStatusItem("MorbRoverMakerDusty", (string) CODEX.STORY_TRAITS.MORB_ROVER_MAKER.STATUSITEMS.DUSTY.NAME, (string) CODEX.STORY_TRAITS.MORB_ROVER_MAKER.STATUSITEMS.DUSTY.TOOLTIP, "", StatusItem.IconType.Info, NotificationType.BadMinor, false, OverlayModes.None.ID);
    this.MorbRoverMakerBuildingRevealed = this.CreateStatusItem("MorbRoverMakerBuildingRevealed", (string) CODEX.STORY_TRAITS.MORB_ROVER_MAKER.STATUSITEMS.BUILDING_BEING_REVEALED.NAME, (string) CODEX.STORY_TRAITS.MORB_ROVER_MAKER.STATUSITEMS.BUILDING_BEING_REVEALED.TOOLTIP, "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID);
    this.MorbRoverMakerGermCollectionProgress = this.CreateStatusItem("MorbRoverMakerGermCollectionProgress", (string) CODEX.STORY_TRAITS.MORB_ROVER_MAKER.STATUSITEMS.GERM_COLLECTION_PROGRESS.NAME, (string) CODEX.STORY_TRAITS.MORB_ROVER_MAKER.STATUSITEMS.GERM_COLLECTION_PROGRESS.TOOLTIP, "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID);
    this.MorbRoverMakerGermCollectionProgress.resolveStringCallback = (Func<string, object, string>) ((str, data) =>
    {
    ...
    this.MorbRoverMakerGermCollectionProgress.resolveTooltipCallback = (Func<string, object, string>) ((str, data) =>
    {
      MorbRoverMaker.Instance instance = (MorbRoverMaker.Instance) data;
      return str.Replace("{GERM_NAME}", Db.Get().Diseases[instance.def.GERM_TYPE].Name).Replace("{0}", GameUtil.GetFormattedDiseaseAmount(instance.def.MAX_GERMS_TAKEN_PER_PACKAGE, GameUtil.TimeSlice.PerSecond)).Replace("{1}", GameUtil.GetFormattedDiseaseAmount(instance.MorbDevelopment_GermsCollected)).Replace("{2}", GameUtil.GetFormattedDiseaseAmount(instance.def.GERMS_PER_ROVER));
    });
    this.MorbRoverMakerNoGermsConsumedAlert = this.CreateStatusItem("MorbRoverMakerNoGermsConsumedAlert", (string) CODEX.STORY_TRAITS.MORB_ROVER_MAKER.STATUSITEMS.NOGERMSCONSUMEDALERT.NAME, (string) CODEX.STORY_TRAITS.MORB_ROVER_MAKER.STATUSITEMS.NOGERMSCONSUMEDALERT.TOOLTIP, "status_item_no_germs", StatusItem.IconType.Custom, NotificationType.Bad, false, OverlayModes.None.ID);
    this.MorbRoverMakerNoGermsConsumedAlert.resolveStringCallback = (Func<string, object, string>) ((str, data) =>
    {
      MorbRoverMaker.Instance instance = (MorbRoverMaker.Instance) data;
      return str.Replace("{0}", Db.Get().Diseases[instance.def.GERM_TYPE].Name);
    });
    this.MorbRoverMakerNoGermsConsumedAlert.resolveTooltipCallback = (Func<string, object, string>) ((str, data) =>
    {
      MorbRoverMaker.Instance instance = (MorbRoverMaker.Instance) data;
      return str.Replace("{0}", Db.Get().Diseases[instance.def.GERM_TYPE].Name);
    });
    this.MorbRoverMakerCraftingBody = this.CreateStatusItem("MorbRoverMakerCraftingBody", (string) CODEX.STORY_TRAITS.MORB_ROVER_MAKER.STATUSITEMS.CRAFTING_ROBOT_BODY.NAME, (string) CODEX.STORY_TRAITS.MORB_ROVER_MAKER.STATUSITEMS.CRAFTING_ROBOT_BODY.TOOLTIP, "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID);
    this.MorbRoverMakerReadyForDoctor = this.CreateStatusItem("MorbRoverMakerReadyForDoctor", (string) CODEX.STORY_TRAITS.MORB_ROVER_MAKER.STATUSITEMS.DOCTOR_READY.NAME, (string) CODEX.STORY_TRAITS.MORB_ROVER_MAKER.STATUSITEMS.DOCTOR_READY.TOOLTIP, "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID);
    this.MorbRoverMakerDoctorWorking = this.CreateStatusItem("MorbRoverMakerDoctorWorking", (string) CODEX.STORY_TRAITS.MORB_ROVER_MAKER.STATUSITEMS.BUILDING_BEING_WORKED_BY_DOCTOR.NAME, (string) CODEX.STORY_TRAITS.MORB_ROVER_MAKER.STATUSITEMS.BUILDING_BEING_WORKED_BY_DOCTOR.TOOLTIP, "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID);
    this.GeoVentQuestBlockage = this.CreateStatusItem("GeoVentQuestBlockage", (string) COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.STATUSITEMS.VENT.QUEST_BLOCKED_NAME, (string) COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.STATUSITEMS.VENT.QUEST_BLOCKED_TOOLTIP, "", StatusItem.IconType.Info, NotificationType.BadMinor, false, OverlayModes.None.ID);
    this.GeoVentQuestBlockage.resolveStringCallback = (Func<string, object, string>) ((str, obj) => str.Replace("{Name}", (obj as GeothermalVent).GetProperName()));
    this.GeoVentQuestBlockage.resolveStringCallback_shouldStillCallIfDataIsNull = false;
    this.GeoVentsDisconnected = this.CreateStatusItem("GeoVentsDisconnected", (string) COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.STATUSITEMS.VENT.DISCONNECTED_NAME, (string) COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.STATUSITEMS.VENT.DISCONNECTED_TOOLTIP, "", StatusItem.IconType.Info, NotificationType.BadMinor, false, OverlayModes.None.ID);
    this.GeoVentsDisconnected.resolveStringCallback = (Func<string, object, string>) ((str, obj) => str.Replace("{Name}", (obj as GeothermalVent).GetProperName()));
    this.GeoVentsDisconnected.resolveStringCallback_shouldStillCallIfDataIsNull = false;
    this.GeoVentsOverpressure = this.CreateStatusItem("GeoVentsOverpressure", (string) COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.STATUSITEMS.VENT.OVERPRESSURE_NAME, (string) COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.STATUSITEMS.VENT.OVERPRESSURE_TOOLTIP, "status_item_vent_disabled", StatusItem.IconType.Custom, NotificationType.BadMinor, false, OverlayModes.None.ID);
    this.GeoVentsOverpressure.resolveStringCallback = (Func<string, object, string>) ((str, obj) => str.Replace("{Name}", (obj as GeothermalVent).GetProperName()));
    this.GeoVentsOverpressure.resolveStringCallback_shouldStillCallIfDataIsNull = false;
    this.GeoControllerCantVent = this.CreateStatusItem("GeoControllerCantVent", (string) COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.STATUSITEMS.CONTROLLER.CANNOT_PUSH_NO_CONNECTED_NAME, (string) COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.STATUSITEMS.CONTROLLER.CANNOT_PUSH_NO_CONNECTED_TOOLTIP, "status_item_vent_disabled", StatusItem.IconType.Custom, NotificationType.BadMinor, false, OverlayModes.None.ID);
    this.GeoControllerCantVent.resolveStringCallback = (Func<string, object, string>) ((str, obj) =>
    {
      GeothermalController geothermalController = obj as GeothermalController;
      if ((UnityEngine.Object) geothermalController == (UnityEngine.Object) null)
        return str;
      GeothermalVent geothermalVent = geothermalController.FirstObstructedVent();
      if ((UnityEngine.Object) geothermalVent == (UnityEngine.Object) null)
        return (string) COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.STATUSITEMS.CONTROLLER.CANNOT_PUSH_NO_CONNECTED_NAME;
    ...
    this.GeoControllerCantVent.resolveTooltipCallback = (Func<string, object, string>) ((str, obj) =>
    {
      GeothermalController geothermalController = obj as GeothermalController;
      if ((UnityEngine.Object) geothermalController == (UnityEngine.Object) null)
        return str;
      GeothermalVent geothermalVent = geothermalController.FirstObstructedVent();
      if ((UnityEngine.Object) geothermalVent == (UnityEngine.Object) null)
        return (string) COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.STATUSITEMS.CONTROLLER.CANNOT_PUSH_NO_CONNECTED_TOOLTIP;
    ...
    this.GeoControllerCantVent.statusItemClickCallback = (Action<object>) (obj =>
    {
      GeothermalController geothermalController = obj as GeothermalController;
      GeothermalVent geothermalVent = (UnityEngine.Object) geothermalController != (UnityEngine.Object) null ? geothermalController.FirstObstructedVent() : (GeothermalVent) null;
      if (!((UnityEngine.Object) geothermalVent != (UnityEngine.Object) null))
        return;
      SelectTool.Instance.SelectAndFocus(geothermalVent.transform.position, geothermalVent.GetComponent<KSelectable>());
    });
    this.GeoVentsReady = this.CreateStatusItem("GeoVentsReady", (string) COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.STATUSITEMS.VENT.READY_NAME, (string) COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.STATUSITEMS.VENT.READY_TOOLTIP, "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID);
    this.GeoVentsReady.resolveStringCallback = (Func<string, object, string>) ((str, obj) => str.Replace("{Name}", (obj as GeothermalVent).GetProperName()));
    this.GeoVentsReady.resolveStringCallback_shouldStillCallIfDataIsNull = false;
    this.GeoVentsVenting = this.CreateStatusItem("GeoVentsVenting", (string) COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.STATUSITEMS.VENT.VENTING_NAME, (string) COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.STATUSITEMS.VENT.VENTING_TOOLTIP, "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID);
    this.GeoVentsVenting.resolveStringCallback = (Func<string, object, string>) ((str, obj) =>
    {
      GeothermalVent cmp = obj as GeothermalVent;
      return str.Replace("{Name}", cmp.GetProperName()).Replace("{Quantity}", GameUtil.GetFormattedMass(cmp.MaterialAvailable()));
    });
    this.GeoVentsVenting.resolveStringCallback_shouldStillCallIfDataIsNull = false;
    this.GeoVentsVenting.resolveTooltipCallback = (Func<string, object, string>) ((str, data) =>
    {
      GeothermalVent geothermalVent = data as GeothermalVent;
      return (UnityEngine.Object) geothermalVent != (UnityEngine.Object) null ? str.Replace("{Quantity}", GameUtil.GetFormattedMass(geothermalVent.MaterialAvailable())) : str;
    });
    this.GeoVentsReady.resolveTooltipCallback_shouldStillCallIfDataIsNull = false;
    this.GeoQuestPendingReconnectPipes = this.CreateStatusItem("GeoQuestPendingReconnectPipes", (string) COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.STATUSITEMS.CONTROLLER.PENDING_RECONNECTION_NAME, (string) COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.STATUSITEMS.CONTROLLER.PENDING_RECONNECTION_TOOLTIP, "", StatusItem.IconType.Info, NotificationType.BadMinor, false, OverlayModes.None.ID);
    this.GeoQuestPendingUncover = this.CreateStatusItem("GeoQuestPendingUncover", (string) COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.STATUSITEMS.VENT.PENDING_REVEAL_NAME, (string) COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.STATUSITEMS.VENT.PENDING_REVEAL_TOOLTIP, "", StatusItem.IconType.Info, NotificationType.BadMinor, false, OverlayModes.None.ID);
    this.GeoControllerOffline = this.CreateStatusItem("GeoControllerOffline", (string) COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.STATUSITEMS.CONTROLLER.OFFLINE_NAME, (string) COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.STATUSITEMS.CONTROLLER.OFFLINE_TOOLTIP, "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID);
    this.GeoControllerStorageStatus = this.CreateStatusItem("GeoControllerStorageStatus", (string) COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.STATUSITEMS.CONTROLLER.STORAGE_STATUS_NAME, (string) COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.STATUSITEMS.CONTROLLER.STORAGE_STATUS_TOOLTIP, "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID);
    this.GeoControllerStorageStatus = this.CreateStatusItem("GeoControllerStorageStatus", (string) COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.STATUSITEMS.CONTROLLER.STORAGE_STATUS_NAME, (string) COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.STATUSITEMS.CONTROLLER.STORAGE_STATUS_TOOLTIP, "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID);
    this.GeoControllerStorageStatus.resolveStringCallback = (Func<string, object, string>) ((str, obj) =>
    {
      GeothermalController geothermalController = obj as GeothermalController;
      float percent = (UnityEngine.Object) geothermalController != (UnityEngine.Object) null ? geothermalController.GetPressure() * 100f : 0.0f;
      return str.Replace("{Amount}", GameUtil.GetFormattedPercent(percent));
    });
    this.GeoControllerStorageStatus.resolveTooltipCallback = (Func<string, object, string>) ((str, obj) =>
    {
      GeothermalController geothermalController = obj as GeothermalController;
      float num = (UnityEngine.Object) geothermalController != (UnityEngine.Object) null ? geothermalController.GetPressure() : 0.0f;
    ...
    this.GeoControllerTemperatureStatus = this.CreateStatusItem("GeoControllerTemperatureStatus", (string) COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.STATUSITEMS.CONTROLLER.STORAGE_TEMPERATURE_NAME, (string) COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.STATUSITEMS.CONTROLLER.STORAGE_TEMPERATURE_TOOLTIP, "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID);
    this.GeoControllerTemperatureStatus.resolveStringCallback = (Func<string, object, string>) ((str, obj) =>
    {
      GeothermalController geothermalController = obj as GeothermalController;
      float temp = (UnityEngine.Object) geothermalController != (UnityEngine.Object) null ? geothermalController.ComputeContentTemperature() : 0.0f;
    ...
    this.RemoteWorkDockMakingWorker = new StatusItem("RemoteWorkDockMakingWorker", (string) BUILDING.STATUSITEMS.REMOTEWORKERDEPOT.MAKINGWORKER.NAME, (string) BUILDING.STATUSITEMS.REMOTEWORKERDEPOT.MAKINGWORKER.TOOLTIP, "", StatusItem.IconType.Info, NotificationType.Good, false, OverlayModes.None.ID);
    this.RemoteWorkTerminalNoDock = new StatusItem("RemoteWorkTerminalNoDock", (string) BUILDING.STATUSITEMS.REMOTEWORKTERMINAL.NODOCK.NAME, (string) BUILDING.STATUSITEMS.REMOTEWORKTERMINAL.NODOCK.TOOLTIP, "status_item_exclamation", StatusItem.IconType.Custom, NotificationType.Bad, false, OverlayModes.None.ID);
    this.DataMinerEfficiency = new StatusItem("RemoteWorkTerminalNoDock", (string) BUILDING.STATUSITEMS.DATAMINER.PRODUCTIONRATE.NAME, (string) BUILDING.STATUSITEMS.DATAMINER.PRODUCTIONRATE.TOOLTIP, "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID);
    this.DataMinerEfficiency.resolveStringCallback = (Func<string, object, string>) ((str, obj) =>
    {
