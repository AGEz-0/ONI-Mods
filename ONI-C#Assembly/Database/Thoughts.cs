...
public class Thoughts : ResourceSet<Thought>
{
    ...
    : base(nameof (Thoughts), parent)
  {
    ...
    this.ExpellingGunk = new Thought(nameof (ExpellingGunk), (ResourceSet) this, "crew_state_gunk_dump_desire", (string) null, "crew_state_gunk_dump_desire", "bubble_alert", SpeechMonitor.PREFIX_SAD, DUPLICANTS.THOUGHTS.EXPELLINGSPOILEDOIL.TOOLTIP);
    this.ExpellGunkDesire = new Thought(nameof (ExpellGunkDesire), (ResourceSet) this, "crew_state_gunk_dump_desire", (string) null, "crew_state_gunk_dump_desire", "bubble_alert", SpeechMonitor.PREFIX_SAD, DUPLICANTS.THOUGHTS.EXPELLGUNKDESIRE.TOOLTIP);
    this.RefillOilDesire = new Thought(nameof (RefillOilDesire), (ResourceSet) this, "crew_state_oil_change_desire", (string) null, "crew_state_oil_change_desire", "bubble_alert", SpeechMonitor.PREFIX_SAD, DUPLICANTS.THOUGHTS.REFILLOILDESIRE.TOOLTIP);
