...
public class Emotes : ResourceSet<Resource>
{
  ...
  public class MinionEmotes : ResourceSet<Emote>
  {
    ...
    private void InitializePhysicalStatus()
    {
      ...
      this.Cold = new Emote((ResourceSet) this, "Cold", Emotes.MinionEmotes.DEFAULT_IDLE_STEPS, "anim_idle_cold_kanim");
  ...
  public class CritterEmotes : ResourceSet<Emote>
  {
    ...
    {
      this.Hungry = new Emote((ResourceSet) this, "Hungry", new EmoteStep[1]
      {
        new EmoteStep() { anim = (HashedString) "react_hungry" }
      });
    }
