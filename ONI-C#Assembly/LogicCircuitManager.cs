...
public class LogicCircuitManager
{
  ...
  private void Refresh(float dt)
  {
    ...
    else if ((UnityEngine.Object) SpeedControlScreen.Instance != (UnityEngine.Object) null && !SpeedControlScreen.Instance.IsPaused)
    {
      this.elapsedTime += dt;
  ...
  public List<ILogicUIElement> GetVisElements() => this.uiVisElements;
  ...
  private struct Signal(int cell, int value)
  {
