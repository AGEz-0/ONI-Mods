...
public class Lighting : MonoBehaviour
{
  ...
  private Color PremultiplyAlpha(Color c) => c * c.a;
  ...
  private void UpdateLighting()
  {
    ...
    float w = (!((UnityEngine.Object) SimDebugView.Instance != (UnityEngine.Object) null) ? 0 : (SimDebugView.Instance.GetMode() == OverlayModes.Disease.ID ? 1 : 0)) != 0 ? 1f : 0.0f;
    if (this.disableLighting)
      Shader.SetGlobalVector(Lighting._AnimParameters, new Vector4(1f, this.Settings.WorldZoneAnimBlend, 0.0f, w));
    else
      Shader.SetGlobalVector(Lighting._AnimParameters, new Vector4(this.Settings.AnimIntensity, this.Settings.WorldZoneAnimBlend, 0.0f, w));
    ...
    Shader.SetGlobalColor(Lighting._CharacterLitColour, (Color) this.Settings.characterLighting.litColour);
    Shader.SetGlobalColor(Lighting._CharacterUnlitColour, (Color) this.Settings.characterLighting.unlitColour);
