...
public class PropDeskConfig : IEntityConfig
{
  public GameObject CreatePrefab()
  {
    ...
    GameObject placedEntity = EntityTemplates.CreatePlacedEntity("PropDesk", name, desc, 50f, anim, "off", Grid.SceneLayer.Building, 3, 2, decor, PermittedRotations.R90, noise: noise, additionalTags: new List<Tag>()
    {
      GameTags.Gravitas
    });
