...
public class HabitatModuleSmallConfig : IBuildingConfig
{
  ...
  public override BuildingDef CreateBuildingDef()
  {
    ...
    BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef("HabitatModuleSmall", 3, 3, "rocket_nosecone_kanim", 1000, 60f, denseTieR0, rawMetals, 9999f, BuildLocationRule.Anywhere, none, noise);
