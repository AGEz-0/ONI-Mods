...
public class BuildingAttachPoint : KMonoBehaviour
{
  ...
  public struct HardPoint(
    CellOffset position,
    Tag attachableType,
    AttachableBuilding attachedBuilding)
  {
    public CellOffset position = position;
    public Tag attachableType = attachableType;
    public AttachableBuilding attachedBuilding = attachedBuilding;
  }
}
