...
public class EarlyBird : StateMachineComponent<EarlyBird.StatesInstance>
{
  ...
  public class StatesInstance(EarlyBird master) : 
    GameStateMachine<EarlyBird.States, EarlyBird.StatesInstance, EarlyBird, object>.GameInstance(master)
  {
    public bool IsMorning()
    {
      return !((UnityEngine.Object) ScheduleManager.Instance == (UnityEngine.Object) null) && !(this.master.kPrefabID.PrefabTag == GameTags.MinionSelectPreview) && Math.Min((int) ((double) GameClock.Instance.GetCurrentCycleAsPercentage() * 24.0), 23) < TUNING.TRAITS.EARLYBIRD_SCHEDULEBLOCK;
    }
  }
