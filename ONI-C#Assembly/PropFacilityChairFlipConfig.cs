...
// Type: PropFacilityChairFlipConfig
...
public class PropFacilityChairFlipConfig : IEntityConfig
{
  public GameObject CreatePrefab()
  {
    ...
    KAnimFile anim = Assets.GetAnim((HashedString) "gravitas_chairFlip_kanim");
    EffectorValues decor = tieR0_1;
    EffectorValues noise = tieR0_2;
    GameObject placedEntity = EntityTemplates.CreatePlacedEntity("PropFacilityChairFlip", name, desc, 50f, anim, "off", Grid.SceneLayer.Building, 2, 2, decor, PermittedRotations.R90, noise: noise, additionalTags: new List<Tag>()
    {
      GameTags.Gravitas
    });
