...
public class ProExoSetLockerConfig : IEntityConfig
{
  ...
  {
    string name = (string) STRINGS.BUILDINGS.PREFABS.PROPEXOSETLOCKER.NAME;
    string desc = (string) STRINGS.BUILDINGS.PREFABS.PROPEXOSETLOCKER.DESC;
    EffectorValues tieR0_1 = TUNING.BUILDINGS.DECOR.BONUS.TIER0;
    EffectorValues tieR0_2 = NOISE_POLLUTION.NOISY.TIER0;
    KAnimFile anim = Assets.GetAnim((HashedString) "zipper_locker_kanim");
    EffectorValues decor = tieR0_1;
    EffectorValues noise = tieR0_2;
    GameObject placedEntity = EntityTemplates.CreatePlacedEntity("PropExoSetLocker", name, desc, 100f, anim, "on", Grid.SceneLayer.Building, 1, 2, decor, noise, additionalTags: new List<Tag>()
    {
      GameTags.Gravitas
    });
