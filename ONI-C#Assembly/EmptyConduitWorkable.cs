...
public class EmptyConduitWorkable : Workable, IEmptyConduitWorkable
{
  ...
  protected override void OnPrefabInit()
  {
    ...
    {
      EmptyConduitWorkable.emptyLiquidConduitStatusItem = new StatusItem("EmptyLiquidConduit", (string) BUILDINGS.PREFABS.CONDUIT.STATUS_ITEM.NAME, (string) BUILDINGS.PREFABS.CONDUIT.STATUS_ITEM.TOOLTIP, "status_item_empty_pipe", StatusItem.IconType.Custom, NotificationType.Neutral, false, OverlayModes.LiquidConduits.ID, 66);
      EmptyConduitWorkable.emptyGasConduitStatusItem = new StatusItem("EmptyGasConduit", (string) BUILDINGS.PREFABS.CONDUIT.STATUS_ITEM.NAME, (string) BUILDINGS.PREFABS.CONDUIT.STATUS_ITEM.TOOLTIP, "status_item_empty_pipe", StatusItem.IconType.Custom, NotificationType.Neutral, false, OverlayModes.GasConduits.ID, 130);
    }
  ...
  private bool HasContents()
  {
    ...
    return (double) this.GetFlowManager().GetContents(cell).mass > 0.0;
  }
  ...
  public void EmptyContents()
  {
    ...
    instance.CreateChunk(conduitContents.element, conduitContents.mass, conduitContents.temperature, conduitContents.diseaseIdx, conduitContents.diseaseCount, Grid.CellToPosCCC(cell, Grid.SceneLayer.Ore)).Trigger(580035959, (object) this.worker);
  }
