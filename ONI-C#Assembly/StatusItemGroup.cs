...
public class StatusItemGroup
{
  ...
  public struct Entry(StatusItem item, StatusItemCategory category, object data) : 
    IComparable<StatusItemGroup.Entry>,
    IEquatable<StatusItemGroup.Entry>
  {
    ...
    public StatusItem item = item;
    public object data = data;
    public Notification notification = (Notification) null;
    public StatusItemCategory category = category;
