  ...
  GameStateMachine<LaunchPadMaterialDistributor, LaunchPadMaterialDistributor.Instance, IStateMachineTarget, LaunchPadMaterialDistributor.Def>
{
  ...
  public new class Instance(IStateMachineTarget master, LaunchPadMaterialDistributor.Def def) : 
    GameStateMachine<LaunchPadMaterialDistributor, LaunchPadMaterialDistributor.Instance, IStateMachineTarget, LaunchPadMaterialDistributor.Def>.GameInstance(master, def)
  {
    public RocketModuleCluster GetLandedRocketFromPad()
    {
      return this.GetComponent<LaunchPad>().LandedRocket;
    }
