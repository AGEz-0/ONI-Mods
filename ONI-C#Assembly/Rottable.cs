  ...
  GameStateMachine<Rottable, Rottable.Instance, IStateMachineTarget, Rottable.Def>
{
  ...
  private static readonly Tag[] PRESERVED_TAGS = new Tag[3]
  {
    GameTags.Preserved,
    GameTags.Dehydrated,
    GameTags.Entombed
  ...
  public override void InitializeStates(out StateMachine.BaseState default_state)
  {
    ...
    double num1;
    this.Fresh.ToggleStatusItem(Db.Get().CreatureStatusItems.Fresh, (Func<Rottable.Instance, object>) (smi => (object) smi)).ParamTransition<float>((StateMachine<Rottable, Rottable.Instance, IStateMachineTarget, Rottable.Def>.Parameter<float>) this.rotParameter, this.Stale_Pre, (StateMachine<Rottable, Rottable.Instance, IStateMachineTarget, Rottable.Def>.Parameter<float>.Callback) ((smi, p) => (double) p <= (double) smi.def.spoilTime - ((double) smi.def.spoilTime - (double) smi.def.staleTime))).Update((System.Action<Rottable.Instance, float>) ((smi, dt) => num1 = (double) smi.sm.rotParameter.Set(smi.RotValue, smi)), UpdateRate.SIM_1000ms, true).FastUpdate("Rot", (UpdateBucketWithUpdater<Rottable.Instance>.IUpdater) Rottable.rotCB, UpdateRate.SIM_1000ms, true);
    ...
    double num2;
    this.Stale.ToggleStatusItem(Db.Get().CreatureStatusItems.Stale, (Func<Rottable.Instance, object>) (smi => (object) smi)).ParamTransition<float>((StateMachine<Rottable, Rottable.Instance, IStateMachineTarget, Rottable.Def>.Parameter<float>) this.rotParameter, this.Fresh, (StateMachine<Rottable, Rottable.Instance, IStateMachineTarget, Rottable.Def>.Parameter<float>.Callback) ((smi, p) => (double) p > (double) smi.def.spoilTime - ((double) smi.def.spoilTime - (double) smi.def.staleTime))).ParamTransition<float>((StateMachine<Rottable, Rottable.Instance, IStateMachineTarget, Rottable.Def>.Parameter<float>) this.rotParameter, this.Spoiled, GameStateMachine<Rottable, Rottable.Instance, IStateMachineTarget, Rottable.Def>.IsLTEZero).Update((System.Action<Rottable.Instance, float>) ((smi, dt) => num2 = (double) smi.sm.rotParameter.Set(smi.RotValue, smi)), UpdateRate.SIM_1000ms).FastUpdate("Rot", (UpdateBucketWithUpdater<Rottable.Instance>.IUpdater) Rottable.rotCB, UpdateRate.SIM_1000ms);
  ...
  public static bool IsInActiveFridge(IRottable rottable)
  {
    ...
    return (UnityEngine.Object) component2 != (UnityEngine.Object) null && component2.IsActive();
  }
    ...
    IRottable
  {
    ...
    public bool IsRottableInSpace()
    {
      if ((UnityEngine.Object) this.gameObject.GetMyWorld() == (UnityEngine.Object) null)
      {
        ...
        if ((UnityEngine.Object) component != (UnityEngine.Object) null && (bool) (UnityEngine.Object) component.storage && ((bool) (UnityEngine.Object) component.storage.GetComponent<RocketModuleCluster>() || (bool) (UnityEngine.Object) component.storage.GetComponent<ClusterTraveler>()))
          return true;
      }
      return false;
    }
    ...
    public void RefreshModifiers(float dt)
    {
      ...
      if (component.HasTag((Tag) Db.Get().Spices.PreservingSpice.Id))
    ...
    {
      return (double) Mathf.Abs(this.RotConstitutionPercentage - other.RotConstitutionPercentage) < 0.10000000149011612;
    }
