...
public class UrgeMonitor : GameStateMachine<UrgeMonitor, UrgeMonitor.Instance>
{
    ...
    GameStateMachine<UrgeMonitor, UrgeMonitor.Instance, IStateMachineTarget, object>.GameInstance
  {
    ...
    {
      return this.schedulable.IsAllowed(this.scheduleBlock) ? this.inScheduleThreshold : this.outOfScheduleThreshold;
    }
    ...
    public bool HasUrge()
    {
      return this.isThresholdMinimum ? (double) this.amountInstance.value >= (double) this.GetThreshold() : (double) this.amountInstance.value <= (double) this.GetThreshold();
    }
  }
}
