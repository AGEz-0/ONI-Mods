...
public class SquirrelConfig : IEntityConfig
{
  ...
  {
    return EntityTemplates.ExtendEntityToFertileCreature(SquirrelConfig.CreateSquirrel("Squirrel", (string) CREATURES.SPECIES.SQUIRREL.NAME, (string) CREATURES.SPECIES.SQUIRREL.DESC, "squirrel_kanim", false), this as IHasDlcRestrictions, "SquirrelEgg", (string) CREATURES.SPECIES.SQUIRREL.EGG_NAME, (string) CREATURES.SPECIES.SQUIRREL.DESC, "egg_squirrel_kanim", SquirrelTuning.EGG_MASS, "SquirrelBaby", 60.0000038f, 20f, SquirrelTuning.EGG_CHANCES_BASE, SquirrelConfig.EGG_SORT_ORDER);
  }
