...
#nullable disable
public class UtilityNetworkTubesManager(int game_width, int game_height, int tile_layer) : 
  UtilityNetworkManager<TravelTubeNetwork, TravelTube>(game_width, game_height, tile_layer)
{
  ...
  {
    return (this.GetConnections(cell, is_physical_building) & connection) != 0;
  }
}
