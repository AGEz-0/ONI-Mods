...
public class TemperatureSwitchSideScreen : SideScreenContent, IRender200ms
{
  ...
  protected override void OnSpawn()
  {
    ...
    component2.SetText(warmerButton);
  ...
  {
    this.targetTemperature.text = GameUtil.GetFormattedTemperature(this.targetTemperatureSwitch.thresholdTemperature);
  }

  private void UpdateLabels()
  {
    this.currentTemperature.text = string.Format((string) STRINGS.UI.UISIDESCREENS.TEMPERATURESWITCHSIDESCREEN.CURRENT_TEMPERATURE, (object) GameUtil.GetFormattedTemperature(this.targetTemperatureSwitch.GetTemperature()));
  }
}
