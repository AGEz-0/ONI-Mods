...
public class Oxyfern : StateMachineComponent<Oxyfern.StatesInstance>
{
  ...
  public class StatesInstance(Oxyfern master) : 
    GameStateMachine<Oxyfern.States, Oxyfern.StatesInstance, Oxyfern, object>.GameInstance(master)
  {
  }
  ...
  public class States : GameStateMachine<Oxyfern.States, Oxyfern.StatesInstance, Oxyfern>
  {
    ...
    public override void InitializeStates(out StateMachine.BaseState default_state)
    {
      ...
      dead.ToggleStatusItem(name, tooltip, render_overlay: render_overlay, category: category).Enter((StateMachine<Oxyfern.States, Oxyfern.StatesInstance, Oxyfern, object>.State.Callback) (smi =>
      {
