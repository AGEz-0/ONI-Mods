...
public class LandingBeacon : GameStateMachine<LandingBeacon, LandingBeacon.Instance>
{
  ...
  public override void InitializeStates(out StateMachine.BaseState default_state)
  {
    ...
    this.working.loop.PlayAnim("working_loop", KAnim.PlayMode.Loop).Enter("SetActive", (StateMachine<LandingBeacon, LandingBeacon.Instance, IStateMachineTarget, object>.State.Callback) (smi => smi.operational.SetActive(true))).Exit("SetActive", (StateMachine<LandingBeacon, LandingBeacon.Instance, IStateMachineTarget, object>.State.Callback) (smi => smi.operational.SetActive(false)));
  }
