...
public class GourmetCookingStationConfig : IBuildingConfig
{
  ...
  private void ConfigureRecipes()
  {
    ...
    SalsaConfig.recipe = new ComplexRecipe(ComplexRecipeManager.MakeRecipeID("GourmetCookingStation", (IList<ComplexRecipe.RecipeElement>) recipeElementArray1, (IList<ComplexRecipe.RecipeElement>) recipeElementArray2), recipeElementArray1, recipeElementArray2)
    {
      ...
      description = (string) STRINGS.ITEMS.FOOD.SALSA.RECIPEDESC,
    ...
    {
      time = TUNING.FOOD.RECIPES.STANDARD_COOK_TIME,
      description = (string) STRINGS.ITEMS.FOOD.MUSHROOMWRAP.RECIPEDESC,
      nameDisplay = ComplexRecipe.RecipeNameDisplay.Result,
      fabricators = new List<Tag>()
      {
        (Tag) "GourmetCookingStation"
    ...
    {
      time = TUNING.FOOD.RECIPES.STANDARD_COOK_TIME,
      description = (string) STRINGS.ITEMS.FOOD.SURFANDTURF.RECIPEDESC,
      nameDisplay = ComplexRecipe.RecipeNameDisplay.Result,
      fabricators = new List<Tag>()
      {
        (Tag) "GourmetCookingStation"
    ...
    {
      time = TUNING.FOOD.RECIPES.STANDARD_COOK_TIME,
      description = (string) STRINGS.ITEMS.FOOD.SPICEBREAD.RECIPEDESC,
      nameDisplay = ComplexRecipe.RecipeNameDisplay.Result,
      fabricators = new List<Tag>()
      {
        (Tag) "GourmetCookingStation"
    ...
    {
      time = TUNING.FOOD.RECIPES.STANDARD_COOK_TIME,
      description = (string) STRINGS.ITEMS.FOOD.SPICYTOFU.RECIPEDESC,
      nameDisplay = ComplexRecipe.RecipeNameDisplay.Result,
      fabricators = new List<Tag>()
      {
        (Tag) "GourmetCookingStation"
    ...
    {
      time = TUNING.FOOD.RECIPES.STANDARD_COOK_TIME,
      description = (string) STRINGS.ITEMS.FOOD.CURRY.RECIPEDESC,
      nameDisplay = ComplexRecipe.RecipeNameDisplay.Result,
      fabricators = new List<Tag>()
      {
        (Tag) "GourmetCookingStation"
    ...
    {
      time = TUNING.FOOD.RECIPES.STANDARD_COOK_TIME,
      description = (string) STRINGS.ITEMS.FOOD.QUICHE.RECIPEDESC,
      nameDisplay = ComplexRecipe.RecipeNameDisplay.Result,
      fabricators = new List<Tag>()
      {
        (Tag) "GourmetCookingStation"
    ...
    {
      time = TUNING.FOOD.RECIPES.STANDARD_COOK_TIME,
      description = (string) STRINGS.ITEMS.FOOD.BURGER.RECIPEDESC,
      nameDisplay = ComplexRecipe.RecipeNameDisplay.Result,
      fabricators = new List<Tag>()
      {
        (Tag) "GourmetCookingStation"
    ...
    {
      time = TUNING.FOOD.RECIPES.STANDARD_COOK_TIME,
      description = (string) STRINGS.ITEMS.FOOD.BERRYPIE.RECIPEDESC,
      nameDisplay = ComplexRecipe.RecipeNameDisplay.Result,
      fabricators = new List<Tag>()
      {
        (Tag) "GourmetCookingStation"
