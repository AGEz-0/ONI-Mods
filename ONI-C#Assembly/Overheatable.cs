  ...
  IGameObjectEffectDescriptor
{
  ...
  public void ResetTemperature() => this.GetComponent<PrimaryElement>().Temperature = 293.15f;
  ...
  public List<Descriptor> GetDescriptors(GameObject go)
  {
    ...
    if (this.overheatTemp != null && this.fatalTemp != null)
    {
      ...
      Descriptor descriptor = new Descriptor(string.Format((string) UI.BUILDINGEFFECTS.OVERHEAT_TEMP, (object) formattedValue1, (object) formattedValue2), string.Format(format, (object) formattedValue1, (object) formattedValue2));
    ...
    else if ((double) this.baseOverheatTemp != 0.0)
    {
      ...
      Descriptor descriptor = new Descriptor(string.Format((string) UI.BUILDINGEFFECTS.OVERHEAT_TEMP, (object) formattedTemperature1, (object) formattedTemperature2), string.Format(overheatTemp, (object) formattedTemperature1, (object) formattedTemperature2));
      descriptors.Add(descriptor);
    }
    return descriptors;
  }

  public class StatesInstance(Overheatable smi) : 
    GameStateMachine<Overheatable.States, Overheatable.StatesInstance, Overheatable, object>.GameInstance(smi)
  {
