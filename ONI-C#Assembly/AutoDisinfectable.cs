...
public class AutoDisinfectable : Workable
{
  ...
  private static readonly EventSystem.IntraObjectHandler<AutoDisinfectable> OnRefreshUserMenuDelegate = new EventSystem.IntraObjectHandler<AutoDisinfectable>((Action<AutoDisinfectable, object>) ((component, data) => component.OnRefreshUserMenu(data)));
