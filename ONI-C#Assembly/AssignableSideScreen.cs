...
public class AssignableSideScreen : SideScreenContent
{
  ...
  {
    return (UnityEngine.Object) this.targetAssignable != (UnityEngine.Object) null ? string.Format(base.GetTitle(), (object) this.targetAssignable.GetProperName()) : base.GetTitle();
  }
  ...
  protected override void OnSpawn()
  {
    ...
    this.Subscribe(Game.Instance.gameObject, 875045922, new Action<object>(this.OnRefreshData));
  }

  private void OnRefreshData(object obj) => this.SetTarget(this.targetAssignable.gameObject);
  ...
  {
    return (UnityEngine.Object) target.GetComponent<Assignable>() != (UnityEngine.Object) null && target.GetComponent<Assignable>().CanBeAssigned && (UnityEngine.Object) target.GetComponent<AssignmentGroupController>() == (UnityEngine.Object) null;
  }
  ...
  public override void SetTarget(GameObject target)
  {
    ...
    {
      Debug.LogError((object) $"{target.GetProperName()} selected has no Assignable component.");
    }
    else
    {
