...
public class Vent : KMonoBehaviour, IGameObjectEffectDescriptor
{
  ...
  {
    return this.lifeTimeVentMass.ContainsKey(element) ? this.lifeTimeVentMass[element] : 0.0f;
  }
    ...
    GameStateMachine<Vent.States, Vent.StatesInstance, Vent, object>.GameInstance
  {
    ...
    {
      return (UnityEngine.Object) this.exhaust != (UnityEngine.Object) null && this.master.GetEndPointState() != Vent.State.Ready && this.master.endpointType == Endpoint.Source;
    }

    public bool Blocked()
    {
      return this.master.GetEndPointState() == Vent.State.Blocked && this.master.endpointType != 0;
    }

    public bool OverPressure()
    {
      return (UnityEngine.Object) this.exhaust != (UnityEngine.Object) null && this.master.GetEndPointState() == Vent.State.OverPressure && this.master.endpointType != 0;
    }
