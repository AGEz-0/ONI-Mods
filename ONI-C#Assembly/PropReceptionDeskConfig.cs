...
public class PropReceptionDeskConfig : IEntityConfig
{
  public GameObject CreatePrefab()
  {
    ...
    GameObject placedEntity = EntityTemplates.CreatePlacedEntity("PropReceptionDesk", name, desc, 50f, anim, "off", Grid.SceneLayer.Building, 5, 3, decor, PermittedRotations.R90, noise: noise, additionalTags: new List<Tag>()
    {
      GameTags.Gravitas
    });
