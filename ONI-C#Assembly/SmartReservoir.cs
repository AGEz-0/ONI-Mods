...
public class SmartReservoir : KMonoBehaviour, IActivationRangeTarget, ISim200ms
{
  ...
  {
    get => (string) BUILDINGS.PREFABS.SMARTRESERVOIR.SIDESCREEN_TITLE;
  }

  public string ActivateSliderLabelText
  {
    get => (string) BUILDINGS.PREFABS.SMARTRESERVOIR.SIDESCREEN_DEACTIVATE;
  }

  public string DeactivateSliderLabelText
  {
    get => (string) BUILDINGS.PREFABS.SMARTRESERVOIR.SIDESCREEN_ACTIVATE;
  }
}
