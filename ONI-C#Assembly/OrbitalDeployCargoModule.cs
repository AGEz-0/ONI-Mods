  ...
  GameStateMachine<OrbitalDeployCargoModule, OrbitalDeployCargoModule.StatesInstance, IStateMachineTarget, OrbitalDeployCargoModule.Def>
{
    ...
    IEmptyableCargo
  {
      ...
      : base(master, def)
    {
      ...
      this.gameObject.Subscribe(-1683615038, new System.Action<object>(this.SetupMeter));
    }
    ...
    {
      this.gameObject.Unsubscribe(-1683615038, new System.Action<object>(this.SetupMeter));
      base.OnCleanUp();
    }
    ...
    {
      return (UnityEngine.Object) this.GetComponent<RocketModuleCluster>().CraftInterface.GetComponent<Clustercraft>().GetOrbitAsteroid() != (UnityEngine.Object) null;
    }
