...
public class PropTallPlantConfig : IEntityConfig
{
  public GameObject CreatePrefab()
  {
    ...
    GameObject placedEntity = EntityTemplates.CreatePlacedEntity("PropTallPlant", name, desc, 50f, anim, "off", Grid.SceneLayer.Building, 1, 3, decor, PermittedRotations.R90, noise: noise, additionalTags: new List<Tag>()
    {
      GameTags.Gravitas
    });
