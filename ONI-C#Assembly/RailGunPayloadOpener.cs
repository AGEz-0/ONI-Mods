  ...
  ISecondaryOutput
{
  ...
  protected override void OnSpawn()
  {
    ...
    this.payloadMeter = new MeterController((KAnimControllerBase) this.GetComponent<KBatchedAnimController>(), "meter_storage_target", "meter_storage", Meter.Offset.Infront, Grid.SceneLayer.NoLayer, Array.Empty<string>());
    this.smi.StartSM();
  }
  ...
  {
    ConduitDispenser conduitDispenser = this.gameObject.AddComponent<ConduitDispenser>();
    ...
    flowNetworkItem = new FlowUtilityNetwork.NetworkItem(outputType, Endpoint.Source, outputCell, this.gameObject);
    int cell = outputCell;
  ...
  private SolidConduitDispenser CreateSolidConduitDispenser(
    ...
    out FlowUtilityNetwork.NetworkItem flowNetworkItem)
  {
    SolidConduitDispenser conduitDispenser = this.gameObject.AddComponent<SolidConduitDispenser>();
    conduitDispenser.storage = this.resourceStorage;
    conduitDispenser.alwaysDispense = true;
    conduitDispenser.useSecondaryOutput = true;
    conduitDispenser.solidOnly = true;
    flowNetworkItem = new FlowUtilityNetwork.NetworkItem(ConduitType.Solid, Endpoint.Source, outputCell, this.gameObject);
  ...
  public void EmptyPayload()
  {
    ...
    if (!((UnityEngine.Object) component != (UnityEngine.Object) null) || component.items.Count <= 0)
      return;
    GameObject original = this.payloadStorage.items[0];
    original.GetComponent<Storage>().Transfer(this.resourceStorage);
  ...
  public bool PowerOperationalChanged()
  {
    ...
    return (UnityEngine.Object) component != (UnityEngine.Object) null && component.IsPowered;
  }
  ...
  public class StatesInstance(RailGunPayloadOpener master) : 
    GameStateMachine<RailGunPayloadOpener.States, RailGunPayloadOpener.StatesInstance, RailGunPayloadOpener, object>.GameInstance(master)
  {
    ...
    GameStateMachine<RailGunPayloadOpener.States, RailGunPayloadOpener.StatesInstance, RailGunPayloadOpener>
  {
    ...
    public override void InitializeStates(out StateMachine.BaseState default_state)
    {
      ...
      this.operational.loop.PlayAnim("working_loop", KAnim.PlayMode.Loop).ScheduleGoTo(10f, (StateMachine.BaseState) this.operational.pst);
