...
public class ThresholdSwitchSideScreen : SideScreenContent, IRender200ms
{
  ...
  protected override void OnSpawn()
  {
    ...
    string belowButton = (string) UI.UISIDESCREENS.THRESHOLD_SWITCH_SIDESCREEN.BELOW_BUTTON;
    component2.SetText(belowButton);
  ...
  {
    this.numberInput.SetDisplayValue(this.thresholdSwitch.Format(this.thresholdSwitch.Threshold, false) + (string) this.thresholdSwitch.ThresholdValueUnits());
  ...
  {
    return (UnityEngine.Object) this.target != (UnityEngine.Object) null ? (string) this.thresholdSwitch.Title : (string) UI.UISIDESCREENS.THRESHOLD_SWITCH_SIDESCREEN.TITLE;
  }
}
