...
public class WiltCondition : KMonoBehaviour
{
  ...
  private static readonly EventSystem.IntraObjectHandler<WiltCondition> SetPollinatedDelegate = new EventSystem.IntraObjectHandler<WiltCondition>((Action<WiltCondition, object>) ((component, data) => component.SetCondition(WiltCondition.Condition.Pollination, (bool) data)));
  ...
  protected override void OnPrefabInit()
  {
    ...
    this.Subscribe<WiltCondition>(-200207042, WiltCondition.SetPollinatedDelegate);
  }
