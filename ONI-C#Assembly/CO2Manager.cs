...
public class CO2Manager : KMonoBehaviour, ISim33ms
{
  ...
  protected override void OnPrefabInit()
  {
    ...
    this.co2Pool = new GameObjectPool(new Func<GameObject>(this.InstantiateCO2), 16 /*0x10*/);
    this.breathPool = new GameObjectPool(new Func<GameObject>(this.InstantiateBreath), 16 /*0x10*/);
  }
