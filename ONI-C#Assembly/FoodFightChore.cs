...
public class FoodFightChore : Chore<FoodFightChore.StatesInstance>
{
    ...
    : base(Db.Get().ChoreTypes.Party, master, master.GetComponent<ChoreProvider>(), false, master_priority_class: PriorityScreen.PriorityClass.high, report_type: ReportManager.ReportType.PersonalTime)
  {
    ...
    this.AddPrecondition(FoodFightChore.EdibleIsNotNull, (object) null);
  }
    ...
    GameStateMachine<FoodFightChore.States, FoodFightChore.StatesInstance, FoodFightChore, object>.GameInstance
  {
    ...
    public void UpdateAttackTarget()
    {
      ...
      while (Components.LiveMinionIdentities.Count > 1 && ((UnityEngine.Object) this.sm.attackableTarget.Get(this.smi) != (UnityEngine.Object) null && (UnityEngine.Object) minionIdentity.gameObject == (UnityEngine.Object) this.sm.attackableTarget.Get(this.smi).gameObject || Game.Instance.roomProber.GetRoomOfGameObject(minionIdentity.gameObject) == null || Game.Instance.roomProber.GetRoomOfGameObject(minionIdentity.gameObject).roomType != Db.Get().RoomTypes.MessHall && Game.Instance.roomProber.GetRoomOfGameObject(minionIdentity.gameObject).roomType != Db.Get().RoomTypes.GreatHall || (UnityEngine.Object) minionIdentity.gameObject == (UnityEngine.Object) this.smi.master.gameObject || Game.Instance.roomProber.GetRoomOfGameObject(minionIdentity.gameObject) != Game.Instance.roomProber.GetRoomOfGameObject(this.smi.master.gameObject)));
      if ((UnityEngine.Object) minionIdentity == (UnityEngine.Object) null)
        this.smi.GoTo((StateMachine.BaseState) this.sm.end);
      else
        this.smi.sm.attackableTarget.Set((KMonoBehaviour) minionIdentity.GetComponent<AttackableBase>(), this.smi);
    }
  }
    ...
    GameStateMachine<FoodFightChore.States, FoodFightChore.StatesInstance, FoodFightChore>
  {
    ...
    public override void InitializeStates(out StateMachine.BaseState default_state)
    {
      ...
      this.fight.throwFood.Enter((StateMachine<FoodFightChore.States, FoodFightChore.StatesInstance, FoodFightChore, object>.State.Callback) (smi =>
      {
        ...
        GameObject gameObject = Util.KInstantiate(Assets.GetPrefab((Tag) FoodCometConfig.ID), smi.master.transform.position + Vector3.up);
        gameObject.SetActive(true);
        Comet comet = gameObject.GetComponent<Comet>();
        Vector3 vector3 = this.attackableTarget.Get(smi).transform.position - smi.master.transform.position;
        vector3.Normalize();
        comet.Velocity = (Vector2) (vector3 * 5f);
        comet.OnImpact += (System.Action) (() =>
        {
          GameObject go = Grid.Objects[Grid.PosToCell((KMonoBehaviour) comet), 0];
          if (!((UnityEngine.Object) go != (UnityEngine.Object) null))
            return;
          if (UnityEngine.Random.Range(0, 100) > 75)
          {
            FleeChore fleeChore = new FleeChore(go.GetComponent<IStateMachineTarget>(), smi.master.gameObject);
          }
          else
            go.Trigger(508119890);
        });
        ...
        if ((UnityEngine.Object) first != (UnityEngine.Object) null)
        {
          ...
          ReportManager.Instance.ReportValue(ReportManager.ReportType.CaloriesCreated, -num, StringFormatter.Replace((string) UI.ENDOFDAYREPORT.NOTES.FOODFIGHT_CONTEXT, "{0}", component.GetProperName()));
