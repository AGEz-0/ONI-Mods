  ...
  GameStateMachine<IncubationMonitor, IncubationMonitor.Instance, IStateMachineTarget, IncubationMonitor.Def>
{
  ...
  {
    return !smi.gameObject.HasTag(GameTags.Entombed) && (double) smi.incubation.value >= (double) smi.incubation.GetMax();
  }
  ...
  {
    return !smi.gameObject.HasTag(GameTags.Entombed) && (double) smi.viability.value <= (double) smi.viability.GetMin();
  }
  ...
  private static void SpawnGenericEgg(IncubationMonitor.Instance smi)
  {
    ...
    KSelectable component = smi.gameObject.GetComponent<KSelectable>();
    if (!((UnityEngine.Object) gameObject != (UnityEngine.Object) null) || !((UnityEngine.Object) SelectTool.Instance != (UnityEngine.Object) null) || !((UnityEngine.Object) SelectTool.Instance.selected != (UnityEngine.Object) null) || !((UnityEngine.Object) SelectTool.Instance.selected == (UnityEngine.Object) component))
      return;
    SelectTool.Instance.Select(gameObject.GetComponent<KSelectable>());
  }
    ...
    GameStateMachine<IncubationMonitor, IncubationMonitor.Instance, IStateMachineTarget, IncubationMonitor.Def>.GameInstance
  {
    ...
    {
      return !((UnityEngine.Object) this.transform.parent != (UnityEngine.Object) null) ? (Storage) null : this.transform.parent.GetComponent<Storage>();
    }
    ...
    public void OnOperationalChanged(object data = null)
    {
      ...
      EggIncubator component = (bool) (UnityEngine.Object) storage ? storage.GetComponent<EggIncubator>() : (EggIncubator) null;
      this.UpdateIncubationState(stored, component);
    }
    ...
    private void UpdateIncubationState(bool stored, EggIncubator incubator)
    {
      ...
      Operational component = (bool) (UnityEngine.Object) incubator ? incubator.GetComponent<Operational>() : (Operational) null;
      this.smi.sm.incubatorIsActive.Set((bool) (UnityEngine.Object) incubator && ((UnityEngine.Object) component == (UnityEngine.Object) null || component.IsOperational), this.smi);
    }
