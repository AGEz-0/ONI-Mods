...
public class HatchVeggieConfig : IEntityConfig
{
  ...
  {
    return EntityTemplates.ExtendEntityToFertileCreature(HatchVeggieConfig.CreateHatch("HatchVeggie", (string) STRINGS.CREATURES.SPECIES.HATCH.VARIANT_VEGGIE.NAME, (string) STRINGS.CREATURES.SPECIES.HATCH.VARIANT_VEGGIE.DESC, "hatch_kanim", false), this as IHasDlcRestrictions, "HatchVeggieEgg", (string) STRINGS.CREATURES.SPECIES.HATCH.VARIANT_VEGGIE.EGG_NAME, (string) STRINGS.CREATURES.SPECIES.HATCH.VARIANT_VEGGIE.DESC, "egg_hatch_kanim", HatchTuning.EGG_MASS, "HatchVeggieBaby", 60.0000038f, 20f, HatchTuning.EGG_CHANCES_VEGGIE, HatchVeggieConfig.EGG_SORT_ORDER);
  }
