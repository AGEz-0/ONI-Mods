  ...
  IGameObjectEffectDescriptor
{
  ...
  private void EmitContents()
  {
    ...
    if (!((UnityEngine.Object) primaryElement != (UnityEngine.Object) null))
      return;
    SimMessages.AddRemoveSubstance(Grid.CellRight(Grid.CellAbove(Grid.PosToCell(this.gameObject))), ElementLoader.GetElementIndex(primaryElement.ElementID), CellEventLogger.Instance.ExhaustSimUpdate, primaryElement.Mass, primaryElement.Temperature, primaryElement.DiseaseIdx, primaryElement.DiseaseCount);
  ...
  private void CoolContents(float dt)
  {
    ...
    foreach (GameObject gameObject in this.gasStorage.items)
    {
      ...
      if (!((UnityEngine.Object) component == (UnityEngine.Object) null) && (double) component.Mass >= 0.10000000149011612 && (double) component.Temperature >= (double) this.minCooledTemperature)
      {
  ...
  public List<Descriptor> GetDescriptors(GameObject go)
  {
    ...
    descriptor.SetupDescriptor(string.Format((string) UI.BUILDINGEFFECTS.HEATCONSUMED, (object) GameUtil.GetFormattedHeatEnergy(this.coolingKilowatts)), string.Format((string) UI.BUILDINGEFFECTS.TOOLTIPS.HEATCONSUMED, (object) GameUtil.GetFormattedHeatEnergy(this.coolingKilowatts)));
    descriptors.Add(descriptor);
    return descriptors;
  }

  public class StatesInstance(LiquidCooledFan smi) : 
    GameStateMachine<LiquidCooledFan.States, LiquidCooledFan.StatesInstance, LiquidCooledFan, object>.GameInstance(smi)
  {
    ...
    GameStateMachine<LiquidCooledFan.States, LiquidCooledFan.StatesInstance, LiquidCooledFan>
  {
    ...
    public override void InitializeStates(out StateMachine.BaseState default_state)
    {
      ...
      this.workable.ToggleChore(new Func<LiquidCooledFan.StatesInstance, Chore>(this.CreateUseChore), this.work_pst).EventTransition(GameHashes.ActiveChanged, this.workable.consuming, (StateMachine<LiquidCooledFan.States, LiquidCooledFan.StatesInstance, LiquidCooledFan, object>.Transition.ConditionCallback) (smi => (UnityEngine.Object) smi.master.workable.worker != (UnityEngine.Object) null)).EventTransition(GameHashes.OperationalChanged, this.workable.consuming, (StateMachine<LiquidCooledFan.States, LiquidCooledFan.StatesInstance, LiquidCooledFan, object>.Transition.ConditionCallback) (smi => (UnityEngine.Object) smi.master.workable.worker != (UnityEngine.Object) null)).Transition(this.unworkable, (StateMachine<LiquidCooledFan.States, LiquidCooledFan.StatesInstance, LiquidCooledFan, object>.Transition.ConditionCallback) (smi => !smi.IsWorkable()));
    ...
    {
      return (Chore) new WorkChore<LiquidCooledFanWorkable>(Db.Get().ChoreTypes.LiquidCooledFan, (IStateMachineTarget) smi.master.workable);
    }
