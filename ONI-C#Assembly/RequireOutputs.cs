...
public class RequireOutputs : KMonoBehaviour
{
  ...
  protected override void OnSpawn()
  {
    ...
    if (layer != null)
      this.partitionerEntry = GameScenePartitioner.Instance.Add(nameof (RequireOutputs), (object) this.gameObject, this.utilityCell, layer, (Action<object>) (data => this.UpdateConnectionState()));
