...
public class PrickleFlowerConfig : IEntityConfig
{
  ...
  public GameObject CreatePrefab()
  {
    ...
    placedEntity.AddOrGet<DiseaseSourceVisualizer>().alwaysShowDisease = "PollenGerms";
    ...
    EntityTemplates.CreateAndRegisterPreviewForPlant(EntityTemplates.CreateAndRegisterSeedForPlant(plant, dlcRestrictions, SeedProducer.ProductionType.Harvest, "PrickleFlowerSeed", name2, desc2, anim2, additionalTags: additionalTags, replantGroundTag: replantGroundTag, sortOrder: 2, domesticatedDescription: domesticatedDescription), "PrickleFlower_preview", Assets.GetAnim((HashedString) "bristleblossom_kanim"), "place", 1, 2);
