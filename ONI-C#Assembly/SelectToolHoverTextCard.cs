...
public class SelectToolHoverTextCard : HoverTextConfiguration
{
  ...
  public override void UpdateHoverElements(List<KSelectable> hoverObjects)
  {
    ...
    if ((UnityEngine.Object) OverlayScreen.Instance == (UnityEngine.Object) null || !Grid.IsValidCell(cell1))
      return;
    ...
    if (mode == OverlayModes.Temperature.ID && Game.Instance.temperatureOverlayMode == Game.TemperatureOverlayModes.HeatFlow)
    {
      ...
      {
        float thermalComfort1 = GameUtil.GetThermalComfort(GameTags.Minions.Models.Standard, cell1, 0.0f);
        float thermalComfort2 = GameUtil.GetThermalComfort(GameTags.Minions.Models.Standard, cell1, -DUPLICANTSTATS.STANDARD.BaseStats.DUPLICANT_BASE_GENERATION_KILOWATTS);
        float num = 0.0f;
        float dtu_s = 1f * thermalComfort1;
        string text = $"{str1} ({GameUtil.GetFormattedHeatEnergyRate(dtu_s)})";
        if ((double) thermalComfort2 * (1.0 / 1000.0) > -(double) ExternalTemperatureMonitor.BASE_STRESS_TOLERANCE_COLD - (double) num && (double) thermalComfort2 * (1.0 / 1000.0) < (double) ExternalTemperatureMonitor.BASE_STRESS_TOLERANCE_WARM + (double) num)
          text = string.Format((string) UI.OVERLAYS.HEATFLOW.NEUTRAL_DUPE, (object) text);
        else if ((double) thermalComfort2 <= (double) ExternalTemperatureMonitor.GetExternalColdThreshold((Attributes) null))
          text = string.Format((string) UI.OVERLAYS.HEATFLOW.COOLING_DUPE, (object) text);
        else if ((double) thermalComfort2 >= (double) ExternalTemperatureMonitor.GetExternalWarmThreshold((Attributes) null))
          text = string.Format((string) UI.OVERLAYS.HEATFLOW.HEATING_DUPE, (object) text);
    ...
    else if (mode == OverlayModes.Logic.ID)
    {
      foreach (KSelectable hoverObject in hoverObjects)
      {
        ...
        bool isInput;
        if ((UnityEngine.Object) component1 != (UnityEngine.Object) null && component1.TryGetPortAtCell(cell1, out port1, out isInput))
        {
        ...
        if ((UnityEngine.Object) component2 != (UnityEngine.Object) null && component2.TryGetPortAtCell(cell1, out port2))
        {
    ...
    {
      if ((UnityEngine.Object) this.overlayValidHoverObjects[index1] != (UnityEngine.Object) null && !CellSelectionObject.IsSelectionObject(this.overlayValidHoverObjects[index1].gameObject))
      {
        ...
        {
          PrimaryElement component3 = validHoverObject.GetComponent<PrimaryElement>();
          ...
          string str4 = GameUtil.GetUnitFormattedName(this.overlayValidHoverObjects[index1].gameObject, true);
          if ((UnityEngine.Object) component3 != (UnityEngine.Object) null && (UnityEngine.Object) validHoverObject.GetComponent<Building>() != (UnityEngine.Object) null)
            str4 = StringFormatter.Replace(StringFormatter.Replace((string) UI.TOOLS.GENERIC.BUILDING_HOVER_NAME_FMT, "{Name}", str4), "{Element}", component3.Element.nameUpperCase);
          drawer.DrawText(str4, this.Styles_Title.Standard);
          bool flag6 = false;
          string text = (string) UI.OVERLAYS.DISEASE.NO_DISEASE;
          if (flag1)
          {
            if ((UnityEngine.Object) component3 != (UnityEngine.Object) null && component3.DiseaseIdx != byte.MaxValue)
              text = GameUtil.GetFormattedDisease(component3.DiseaseIdx, component3.DiseaseCount, true);
            flag6 = true;
            Storage component4 = validHoverObject.GetComponent<Storage>();
            if ((UnityEngine.Object) component4 != (UnityEngine.Object) null && component4.showInUI)
            {
              ...
              for (int index2 = 0; index2 < items.Count; ++index2)
              {
                ...
                if ((UnityEngine.Object) gameObject != (UnityEngine.Object) null)
                {
                  ...
                  if (component5.DiseaseIdx != byte.MaxValue)
                    text += string.Format((string) UI.OVERLAYS.DISEASE.CONTAINER_FORMAT, (object) gameObject.GetComponent<KSelectable>().GetProperName(), (object) GameUtil.GetFormattedDisease(component5.DiseaseIdx, component5.DiseaseCount, true));
                }
              }
            }
          }
          ...
          float temp = 0.0f;
          bool flag7 = true;
          bool flag8 = OverlayModes.Temperature.ID == SimDebugView.Instance.GetMode() && Game.Instance.temperatureOverlayMode != Game.TemperatureOverlayModes.HeatFlow;
          if ((bool) (UnityEngine.Object) validHoverObject.GetComponent<Constructable>())
            flag7 = false;
          else if (flag8 && (bool) (UnityEngine.Object) component3)
            temp = component3.Temperature;
          else if ((bool) (UnityEngine.Object) validHoverObject.GetComponent<Building>() && (bool) (UnityEngine.Object) component3)
            temp = component3.Temperature;
          else if (CellSelectionObject.IsSelectionObject(validHoverObject.gameObject))
          ...
          BuildingComplete component6 = validHoverObject.GetComponent<BuildingComplete>();
          if ((UnityEngine.Object) component6 != (UnityEngine.Object) null && component6.Def.IsFoundation && Grid.Element[cell1].IsSolid)
            flag2 = false;
    ...
    if (flag2)
    {
      ...
      if (!element1.IsVacuum)
      {
        ...
        string str5 = this.cachedTemperatureString;
        float num3 = Grid.Temperature[cell1];
        if ((double) num3 != (double) this.cachedTemperature)
        {
          this.cachedTemperature = num3;
          str5 = GameUtil.GetFormattedTemperature(Grid.Temperature[cell1]);
          this.cachedTemperatureString = str5;
        }
        string text = (double) element2.specificHeatCapacity == 0.0 ? "N/A" : str5;
        drawer.DrawText(text, this.Styles_BodyText.Standard);
      }
      ...
      if (Game.Instance.GetComponent<EntombedItemVisualizer>().IsEntombedItem(cell1))
      {
        drawer.NewLine();
        drawer.DrawIcon(this.iconDash);
      ...
      if (element1.sublimateId != (SimHashes) 0 && element1.IsSolid | flag10)
      {
        ...
        string text9 = ((string) BUILDING.STATUSITEMS.EMITTINGGASAVG.NAME).Replace("{FlowRate}", GameUtil.GetFormattedMass(mass, GameUtil.TimeSlice.PerSecond)).Replace("{Element}", nameByElementHash2);
        drawer.NewLine();
        drawer.DrawIcon(this.iconDash);
        drawer.DrawText(text9, this.Styles_BodyText.Standard);
        bool all_not_gaseous;
        bool all_over_pressure;
        GameUtil.IsEmissionBlocked(cell1, out all_not_gaseous, out all_over_pressure);
        string str6 = (string) null;
        if (all_not_gaseous)
          str6 = (string) MISC.STATUSITEMS.SUBLIMATIONBLOCKED.NAME;
        else if (all_over_pressure)
          str6 = (string) MISC.STATUSITEMS.SUBLIMATIONOVERPRESSURE.NAME;
        if (str6 != null)
        {
          string text10 = str6.Replace("{Element}", nameByElementHash1).Replace("{SubElement}", nameByElementHash2);
          drawer.NewLine();
          drawer.DrawIcon(this.iconDash);
          drawer.DrawText(text10, this.Styles_BodyText.Standard);
        }
      }
      drawer.EndShadowBar();
    }
  ...
  {
    drawer.DrawIcon(icon, this.GetLogicColorFromStyle(style));
  }

  public void DrawLogicText(HoverTextDrawer drawer, string text, TextStyleSetting style)
  {
    drawer.DrawText(text, style, this.GetLogicColorFromStyle(style));
  }
  ...
  {
    return !((UnityEngine.Object) OverlayScreen.Instance == (UnityEngine.Object) null) && ((StatusItem.StatusItemOverlays) status.status_overlays & StatusItem.GetStatusItemOverlayBySimViewMode(OverlayScreen.Instance.GetMode())) == StatusItem.GetStatusItemOverlayBySimViewMode(OverlayScreen.Instance.GetMode());
  }
  ...
  {
    return ((UnityEngine.Object) selectable.GetComponent<AlgaeHabitat>() != (UnityEngine.Object) null ? 1 : ((UnityEngine.Object) selectable.GetComponent<Electrolyzer>() != (UnityEngine.Object) null ? 1 : 0)) != 0 || (UnityEngine.Object) selectable.GetComponent<AirFilter>() != (UnityEngine.Object) null;
  }
  ...
  {
    return (UnityEngine.Object) selectable.GetComponent<HighEnergyParticle>() != (UnityEngine.Object) null || (bool) (UnityEngine.Object) selectable.GetComponent<HighEnergyParticlePort>();
  }
