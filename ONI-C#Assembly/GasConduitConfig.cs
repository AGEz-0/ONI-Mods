...
public class GasConduitConfig : IBuildingConfig
{
  ...
  public override BuildingDef CreateBuildingDef()
  {
    ...
    string[] mineralsOrMetals = MATERIALS.RAW_MINERALS_OR_METALS;
    EffectorValues none1 = NOISE_POLLUTION.NONE;
    EffectorValues none2 = BUILDINGS.DECOR.NONE;
    EffectorValues noise = none1;
    BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef("GasConduit", 1, 1, "utilities_gas_kanim", 10, 3f, tieR0, mineralsOrMetals, 1600f, BuildLocationRule.Anywhere, none2, noise);
