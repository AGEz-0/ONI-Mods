...
public class MingleChore : Chore<MingleChore.StatesInstance>, IWorkerPrioritizable
{
  ...
  public class States : GameStateMachine<MingleChore.States, MingleChore.StatesInstance, MingleChore>
  {
    ...
    public override void InitializeStates(out StateMachine.BaseState default_state)
    {
      ...
      this.onfloor.ToggleAnims("anim_generic_convo_kanim").PlayAnim("idle", KAnim.PlayMode.Loop).ScheduleGoTo((Func<MingleChore.StatesInstance, float>) (smi => (float) UnityEngine.Random.Range(5, 10)), (StateMachine.BaseState) this.success).ToggleTag(GameTags.AlwaysConverse);
