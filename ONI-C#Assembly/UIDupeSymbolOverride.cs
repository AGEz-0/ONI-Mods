...
public class UIDupeSymbolOverride : MonoBehaviour
{
  ...
  public void Apply(MinionIdentity minionIdentity)
  {
    ...
    if ((Object) this.symbolOverrideController == (Object) null)
    ...
    DebugUtil.DevAssert(fromNameStringKey != null, "Personality is not found");
  ...
  private KAnimHashedString SetAccessory(KBatchedAnimController minion, Accessory accessory)
  {
    ...
    this.symbolOverrideController.TryRemoveSymbolOverride((HashedString) accessory.slot.targetSymbolId);
    this.symbolOverrideController.AddSymbolOverride((HashedString) accessory.slot.targetSymbolId, accessory.symbol);
