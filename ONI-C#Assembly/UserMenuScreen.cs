...
public class UserMenuScreen : KIconButtonMenu
{
  ...
  protected override void OnSpawn()
  {
    ...
    KInputManager.InputChange.AddListener(new UnityAction(((KIconButtonMenu) this).RefreshButtonTooltip));
  }

  protected override void OnForcedCleanUp()
  {
    KInputManager.InputChange.RemoveListener(new UnityAction(((KIconButtonMenu) this).RefreshButtonTooltip));
  ...
  public void RefreshSliders()
  {
    ...
    for (int index = 0; index < this.slidersInfos.Count; ++index)
    {
      ...
      Transform parent = (UnityEngine.Object) this.sliderParent != (UnityEngine.Object) null ? this.sliderParent.transform : this.transform;
