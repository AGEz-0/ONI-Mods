...
public class SquirrelHugConfig : IEntityConfig
{
  ...
  {
    return EntityTemplates.ExtendEntityToFertileCreature(SquirrelHugConfig.CreateSquirrelHug("SquirrelHug", (string) STRINGS.CREATURES.SPECIES.SQUIRREL.VARIANT_HUG.NAME, (string) STRINGS.CREATURES.SPECIES.SQUIRREL.VARIANT_HUG.DESC, "squirrel_kanim", false), this as IHasDlcRestrictions, "SquirrelHugEgg", (string) STRINGS.CREATURES.SPECIES.SQUIRREL.VARIANT_HUG.EGG_NAME, (string) STRINGS.CREATURES.SPECIES.SQUIRREL.VARIANT_HUG.DESC, "egg_squirrel_kanim", SquirrelTuning.EGG_MASS, "SquirrelHugBaby", 60.0000038f, 20f, SquirrelTuning.EGG_CHANCES_HUG, SquirrelHugConfig.EGG_SORT_ORDER);
  }
