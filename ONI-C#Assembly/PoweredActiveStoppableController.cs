  ...
  GameStateMachine<PoweredActiveStoppableController, PoweredActiveStoppableController.Instance>
{
  ...
  public new class Instance(IStateMachineTarget master, PoweredActiveStoppableController.Def def) : 
    GameStateMachine<PoweredActiveStoppableController, PoweredActiveStoppableController.Instance, IStateMachineTarget, object>.GameInstance(master, (object) def)
  {
  }
}
