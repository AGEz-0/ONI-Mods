...
public class AlgaeDistillery : StateMachineComponent<AlgaeDistillery.StatesInstance>
{
  ...
  public class StatesInstance(AlgaeDistillery smi) : 
    GameStateMachine<AlgaeDistillery.States, AlgaeDistillery.StatesInstance, AlgaeDistillery, object>.GameInstance(smi)
  {
    public void TryEmit()
    {
