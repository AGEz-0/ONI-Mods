...
public class Prioritizable : KMonoBehaviour
{
  ...
  protected override void OnSpawn()
  {
    ...
    this.scenePartitionerEntry = GameScenePartitioner.Instance.Add(this.name, (object) this, new Extents((int) position.x, (int) position.y, 1, 1), GameScenePartitioner.Instance.prioritizableObjects, (Action<object>) null);
  ...
  private void SetTopPriorityOnWorld(bool state)
  {
    ...
    if ((UnityEngine.Object) Game.Instance == (UnityEngine.Object) null || (UnityEngine.Object) myWorld == (UnityEngine.Object) null)
      return;
    if (state)
  ...
  protected override void OnCleanUp()
  {
    ...
    {
      Debug.LogWarning((object) ("World has been destroyed before prioritizable " + this.name));
