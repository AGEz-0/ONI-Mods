...
public class StaminaMonitor : GameStateMachine<StaminaMonitor, StaminaMonitor.Instance>
{
  ...
  public override void InitializeStates(out StateMachine.BaseState default_state)
  {
    ...
    this.sleepy.Update("Check Sleep State", (System.Action<StaminaMonitor.Instance, float>) ((smi, dt) => smi.TryExitSleepState()), UpdateRate.SIM_1000ms).DefaultState(this.sleepy.needssleep);
    ...
    GameStateMachine<StaminaMonitor, StaminaMonitor.Instance, IStateMachineTarget, object>.GameInstance
  {
    ...
    {
      bool flag = false;
      if (this.WantsToSleep() && (UnityEngine.Object) this.choreDriver.GetComponent<WorkerBase>().GetWorkable() != (UnityEngine.Object) null)
        flag = true;
      return flag;
    }
