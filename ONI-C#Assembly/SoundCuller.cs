...
public struct SoundCuller
{
  ...
  public Vector3 GetVerticallyScaledPosition(Vector3 pos, bool objectIsSelectedAndVisible = false)
  {
    ...
    Vector3 verticallyScaledPosition = new Vector3(pos.x, pos.y + num4, 0.0f);
  ...
  public static SoundCuller CreateCuller()
  {
    ...
    culler.min = (Vector2) new Vector3(worldPoint2.x, worldPoint2.y, 0.0f);
    culler.max = (Vector2) new Vector3(worldPoint1.x, worldPoint1.y, 0.0f);
    culler.cameraPos = (Vector2) main.transform.GetPosition();
