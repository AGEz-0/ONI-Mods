...
public class ConversationManager : KMonoBehaviour, ISim200ms
{
  ...
  private static readonly Tag[] invalidConvoTags = new Tag[4]
  {
    GameTags.Asleep,
  ...
  public void Sim200ms(float dt)
  {
    for (int index1 = this.activeSetups.Count - 1; index1 >= 0; --index1)
    {
      ...
      {
        bool flag1 = true;
        bool flag2 = (UnityEngine.Object) activeSetup.minions.Find((Predicate<MinionIdentity>) (match => !match.HasTag(GameTags.Partying))) == (UnityEngine.Object) null;
        ...
        {
          int index3 = (activeSetup.minions.IndexOf(activeSetup.lastTalked) + UnityEngine.Random.Range(1, activeSetup.minions.Count)) % activeSetup.minions.Count;
