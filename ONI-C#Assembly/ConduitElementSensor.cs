...
public class ConduitElementSensor : ConduitSensor
{
  ...
  private void GetContentsElement(out Tag element, out bool hasMass)
  {
    ...
    else
    {
      ...
      KPrefabID component = (UnityEngine.Object) pickupable != (UnityEngine.Object) null ? pickupable.GetComponent<KPrefabID>() : (KPrefabID) null;
      if ((UnityEngine.Object) component != (UnityEngine.Object) null && (double) pickupable.PrimaryElement.Mass > 0.0)
      {
        element = component.PrefabTag;
        hasMass = true;
      }
      else
      {
