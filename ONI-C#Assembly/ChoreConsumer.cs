...
public class ChoreConsumer : KMonoBehaviour, IPersonalPriorityManager
{
  ...
  public bool FindNextChore(ref Chore.Precondition.Context out_context)
  {
    ...
    int num = this.ChooseChore(ref out_context, succeededContexts) ? 1 : 0;
    if (num == 0)
      return num != 0;
  ...
  {
    return (bool) (UnityEngine.Object) this.navigator ? !((UnityEngine.Object) this == (UnityEngine.Object) null) && !((UnityEngine.Object) this.gameObject == (UnityEngine.Object) null) && Grid.IsCellOffsetOf(Grid.PosToCell((KMonoBehaviour) this), approachable.GetCell(), approachable.GetOffsets()) : this.consumerState.hasSolidTransferArm && this.consumerState.solidTransferArm.IsCellReachable(approachable.GetCell());
  }
    ...
    SelectToolHoverTextCard hover_text_card)
  {
    ...
    string str1 = precondition.condition.description;
    if (string.IsNullOrEmpty(str1))
      str1 = precondition.condition.id;
  ...
  {
    bool flag = false;
    Traits component = this.gameObject.GetComponent<Traits>();
    if ((UnityEngine.Object) component != (UnityEngine.Object) null && component.IsChoreGroupDisabled(chore_group))
      flag = true;
    return flag;
  }
