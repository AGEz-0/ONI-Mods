...
public class RescueIncapacitatedChore : Chore<RescueIncapacitatedChore.StatesInstance>
{
  ...
  public class StatesInstance(RescueIncapacitatedChore master) : 
    GameStateMachine<RescueIncapacitatedChore.States, RescueIncapacitatedChore.StatesInstance, RescueIncapacitatedChore, object>.GameInstance(master)
  {
  }
    ...
    GameStateMachine<RescueIncapacitatedChore.States, RescueIncapacitatedChore.StatesInstance, RescueIncapacitatedChore>
  {
    ...
    public override void InitializeStates(out StateMachine.BaseState default_state)
    {
      ...
      {
        smi.sm.rescueTarget.Get(smi).Subscribe(1623392196, (Action<object>) (d => smi.GoTo((StateMachine.BaseState) this.holding.ditch)));
