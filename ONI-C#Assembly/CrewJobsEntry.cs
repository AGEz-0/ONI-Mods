...
public class CrewJobsEntry : CrewListEntry
{
  ...
  {
    GameObject gameObject = Util.KInstantiateUI(this.Prefab_JobPriorityButton, this.transform.gameObject);
  ...
  {
    GameObject gameObject = Util.KInstantiateUI(this.Prefab_JobPriorityButtonAllTasks, this.transform.gameObject);
  ...
  private void Refresh(object data = null)
  {
    ...
    else
    {
      ...
      foreach (CrewJobsEntry.PriorityButton priorityButton in this.PriorityButtons)
      {
        ...
        Color baseBorderColor = priorityButton.baseBorderColor with
        {
          r = Mathf.Lerp(priorityButton.baseBorderColor.r, 0.721568644f, t),
          g = Mathf.Lerp(priorityButton.baseBorderColor.g, 0.443137258f, t),
          b = Mathf.Lerp(priorityButton.baseBorderColor.b, 0.5803922f, t)
        };
        if (priorityButton.border.color != baseBorderColor)
          priorityButton.border.color = baseBorderColor;
        Color color = priorityButton.baseBackgroundColor with
        {
          a = Mathf.Lerp(0.0f, 1f, t)
        };
