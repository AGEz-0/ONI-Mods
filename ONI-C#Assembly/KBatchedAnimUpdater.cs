      ...
      if (queuedRegistration.register)
      {
        if (!((UnityEngine.Object) queuedRegistration.controller == (UnityEngine.Object) null))
        {
          ...
          if (Singleton<CellChangeMonitor>.Instance != null)
          {
            ...
            Singleton<CellChangeMonitor>.Instance.RegisterMovementStateChanged(queuedRegistration.controller.transform, new Action<Transform, bool>(this.OnMovementStateChanged));
          }
