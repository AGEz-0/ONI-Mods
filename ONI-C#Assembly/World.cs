...
public class World : KMonoBehaviour
{
  ...
  protected override void OnSpawn()
  {
    ...
    this.GetComponent<PropertyTextures>().OnReset();
    ...
    Sim.LiquidChangeInfo* liquid_change_info)
  {
    ...
    if (this.changedCells.Count != 0)
    {
      ...
      GameScenePartitioner.Instance.TriggerEvent((IEnumerable<int>) this.changedCells, GameScenePartitioner.Instance.solidChangedLayer, (object) null);
    }
    ...
    instance.TriggerEvent((IEnumerable<int>) this.changedCells, GameScenePartitioner.Instance.liquidChangedLayer, (object) null);
  }
  ...
  private void LateUpdate()
  {
    ...
    if (this.revealedCells.Count <= 0)
      return;
    GameScenePartitioner.Instance.TriggerEvent((IEnumerable<int>) this.revealedCells, GameScenePartitioner.Instance.fogOfWarChangedLayer, (object) null);
    this.revealedCells.Clear();
  }
}
