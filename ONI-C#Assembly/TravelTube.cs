  ...
  IHaveUtilityNetworkMgr
{
  ...
  private void UpdateExitListener(bool enable)
  {
    ...
    {
      this.dirtyNavCellUpdatedEntry = GameScenePartitioner.Instance.Add("TravelTube.OnDirtyNavCellUpdated", (object) this, Grid.PosToCell(this.transform.GetPosition()), GameScenePartitioner.Instance.dirtyNavCellUpdateLayer, new Action<object>(this.OnDirtyNavCellUpdated));
