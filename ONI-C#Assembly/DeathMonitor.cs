  ...
  GameStateMachine<DeathMonitor, DeathMonitor.Instance, IStateMachineTarget, DeathMonitor.Def>
{
  ...
  public override void InitializeStates(out StateMachine.BaseState default_state)
  {
    ...
    this.dead_creature.Enter((StateMachine<DeathMonitor, DeathMonitor.Instance, IStateMachineTarget, DeathMonitor.Def>.State.Callback) (smi => smi.gameObject.AddTag(GameTags.Dead))).PlayAnim("idle_dead", KAnim.PlayMode.Loop);
  }
