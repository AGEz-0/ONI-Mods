...
public class PacuCleanerConfig : IEntityConfig
{
  ...
  public static GameObject CreatePacu(
    ...
    bool is_baby)
  {
    GameObject wildCreature = EntityTemplates.ExtendEntityToWildCreature(BasePacuConfig.CreatePrefab(id, "PacuCleanerBaseTrait", name, desc, anim_file, is_baby, "glp_", 243.15f, 278.15f, 223.15f, 298.15f), PacuTuning.PEN_SIZE_PER_CREATURE, false);
    if (!is_baby)
    {
  ...
  {
    return EntityTemplates.ExtendEntityToFertileCreature(EntityTemplates.ExtendEntityToWildCreature(PacuCleanerConfig.CreatePacu("PacuCleaner", (string) STRINGS.CREATURES.SPECIES.PACU.VARIANT_CLEANER.NAME, (string) STRINGS.CREATURES.SPECIES.PACU.VARIANT_CLEANER.DESC, "pacu_kanim", false), PacuTuning.PEN_SIZE_PER_CREATURE, false), this as IHasDlcRestrictions, "PacuCleanerEgg", (string) STRINGS.CREATURES.SPECIES.PACU.VARIANT_CLEANER.EGG_NAME, (string) STRINGS.CREATURES.SPECIES.PACU.VARIANT_CLEANER.DESC, "egg_pacu_kanim", PacuTuning.EGG_MASS, "PacuCleanerBaby", 15.000001f, 5f, PacuTuning.EGG_CHANCES_CLEANER, 501, false, true, 0.75f);
  }
