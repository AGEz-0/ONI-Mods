...
public class TeleportalPadConfig : IBuildingConfig
{
  ...
  public override BuildingDef CreateBuildingDef()
  {
    ...
    {
      LogicPorts.Port.InputPort((HashedString) "TeleportalPad_ID_PORT_0", new CellOffset(-1, 0), (string) STRINGS.BUILDINGS.PREFABS.TELEPORTALPAD.LOGIC_PORT, (string) STRINGS.BUILDINGS.PREFABS.TELEPORTALPAD.LOGIC_PORT_ACTIVE, (string) STRINGS.BUILDINGS.PREFABS.TELEPORTALPAD.LOGIC_PORT_INACTIVE),
      LogicPorts.Port.InputPort((HashedString) "TeleportalPad_ID_PORT_1", new CellOffset(0, 0), (string) STRINGS.BUILDINGS.PREFABS.TELEPORTALPAD.LOGIC_PORT, (string) STRINGS.BUILDINGS.PREFABS.TELEPORTALPAD.LOGIC_PORT_ACTIVE, (string) STRINGS.BUILDINGS.PREFABS.TELEPORTALPAD.LOGIC_PORT_INACTIVE),
      LogicPorts.Port.InputPort((HashedString) "TeleportalPad_ID_PORT_2", new CellOffset(1, 0), (string) STRINGS.BUILDINGS.PREFABS.TELEPORTALPAD.LOGIC_PORT, (string) STRINGS.BUILDINGS.PREFABS.TELEPORTALPAD.LOGIC_PORT_ACTIVE, (string) STRINGS.BUILDINGS.PREFABS.TELEPORTALPAD.LOGIC_PORT_INACTIVE),
      LogicPorts.Port.InputPort((HashedString) "TeleportalPad_ID_PORT_3", new CellOffset(2, 0), (string) STRINGS.BUILDINGS.PREFABS.TELEPORTALPAD.LOGIC_PORT, (string) STRINGS.BUILDINGS.PREFABS.TELEPORTALPAD.LOGIC_PORT_ACTIVE, (string) STRINGS.BUILDINGS.PREFABS.TELEPORTALPAD.LOGIC_PORT_INACTIVE),
