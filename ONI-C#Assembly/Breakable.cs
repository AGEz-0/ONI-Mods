...
public class Breakable : Workable
{
  ...
  public bool IsInvincible => (UnityEngine.Object) this.hp == (UnityEngine.Object) null || this.hp.invincible;
  ...
  public Notification CreateDamageNotification()
  {
    ...
    return new Notification((string) BUILDING.STATUSITEMS.ANGERDAMAGE.NOTIFICATION, NotificationType.BadMinor, (Func<List<Notification>, object, string>) ((notificationList, data) => string.Format((string) BUILDING.STATUSITEMS.ANGERDAMAGE.NOTIFICATION_TOOLTIP, (object) notificationList.ReduceMessages(false))), (object) component.GetProperName(), false);
  }
