  ...
  GameStateMachine<ReturnToChargeStationStates, ReturnToChargeStationStates.Instance, IStateMachineTarget, ReturnToChargeStationStates.Def>
{
  ...
  public override void InitializeStates(out StateMachine.BaseState default_state)
  {
    ...
    this.emote.ToggleStatusItem(Db.Get().RobotStatusItems.MovingToChargeStation, (Func<ReturnToChargeStationStates.Instance, object>) (smi => (object) smi.gameObject), Db.Get().StatusItemCategories.Main).PlayAnim("react_lobatt", KAnim.PlayMode.Once).OnAnimQueueComplete(this.movingToChargingStation);
    ...
    GameStateMachine<ReturnToChargeStationStates, ReturnToChargeStationStates.Instance, IStateMachineTarget, ReturnToChargeStationStates.Def>.GameInstance
  {
    ...
    {
      return (UnityEngine.Object) this.smi.sm.GetSweepLocker(this.smi) == (UnityEngine.Object) null || !this.smi.sm.GetSweepLocker(this.smi).GetComponent<Operational>().IsActive;
    }
