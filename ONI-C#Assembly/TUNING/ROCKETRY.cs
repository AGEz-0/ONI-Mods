...
public class ROCKETRY
{
  ...
  public static Vector2I ROCKET_INTERIOR_SIZE = new Vector2I(32 /*0x20*/, 32 /*0x20*/);
  ...
  public class ROCKET_HEIGHT
  {
    ...
    public static int SHORT = 16 /*0x10*/;
  ...
  {
    public static int EARLY_WEAK = 16 /*0x10*/;
    public static int EARLY_STRONG = 23;
    public static int MID_VERY_STRONG = 48 /*0x30*/;
    public static int MID_STRONG = 31 /*0x1F*/;
