...
public class OilFloaterDecorConfig : IEntityConfig
{
  ...
  public GameObject CreatePrefab()
  {
    ...
    EntityTemplates.ExtendEntityToFertileCreature(oilFloater, this as IHasDlcRestrictions, "OilfloaterDecorEgg", (string) STRINGS.CREATURES.SPECIES.OILFLOATER.VARIANT_DECOR.EGG_NAME, (string) STRINGS.CREATURES.SPECIES.OILFLOATER.VARIANT_DECOR.DESC, "egg_oilfloater_kanim", OilFloaterTuning.EGG_MASS, "OilfloaterDecorBaby", 90f, 30f, OilFloaterTuning.EGG_CHANCES_DECOR, OilFloaterDecorConfig.EGG_SORT_ORDER);
    return oilFloater;
  }
