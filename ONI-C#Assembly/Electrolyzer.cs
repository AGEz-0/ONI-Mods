...
public class Electrolyzer : StateMachineComponent<Electrolyzer.StatesInstance>
{
  ...
  private bool RoomForPressure
  {
    get
    {
      return !GameUtil.FloodFillCheck<Electrolyzer>(new Func<int, Electrolyzer, bool>(Electrolyzer.OverPressure), this, Grid.OffsetCell(Grid.PosToCell(this.transform.GetPosition()), this.emissionOffset), 3, true, true);
    }
  }
  ...
  public class StatesInstance(Electrolyzer smi) : 
    GameStateMachine<Electrolyzer.States, Electrolyzer.StatesInstance, Electrolyzer, object>.GameInstance(smi)
  {
  }
