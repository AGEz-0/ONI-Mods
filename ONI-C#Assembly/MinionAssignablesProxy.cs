...
public class MinionAssignablesProxy : KMonoBehaviour, IAssignableIdentity
{
  ...
  public GameObject GetTargetGameObject()
  {
    ...
    return (UnityEngine.Object) target != (UnityEngine.Object) null ? target.gameObject : (GameObject) null;
  }
  ...
  {
    MinionIdentity component1 = this.GetTargetGameObject().GetComponent<MinionIdentity>();
    if ((UnityEngine.Object) component1 != (UnityEngine.Object) null)
      return component1.model;
    ...
    Debug.LogError((object) "Could not get minion model");
    return Tag.Invalid;
  }
    ...
    IAssignableIdentity source)
  {
    ...
    {
      GameObject gameObject2 = GameUtil.KInstantiate(Assets.GetPrefab((Tag) MinionAssignablesProxyConfig.ID), Grid.SceneLayer.NoLayer);
