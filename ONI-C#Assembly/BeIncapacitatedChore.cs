...
public class BeIncapacitatedChore : Chore<BeIncapacitatedChore.StatesInstance>
{
  ...
  public void FindAvailableMedicalBed(Navigator navigator)
  {
    ...
    if (!((UnityEngine.Object) clinic1 != (UnityEngine.Object) null) || !navigator.CanReach((IApproachable) clinic1))
      return;
    this.smi.sm.clinic.Set(clinic1.gameObject, this.smi, false);
  ...
  public class StatesInstance(BeIncapacitatedChore master) : 
    GameStateMachine<BeIncapacitatedChore.States, BeIncapacitatedChore.StatesInstance, BeIncapacitatedChore, object>.GameInstance(master)
  {
  }
    ...
    GameStateMachine<BeIncapacitatedChore.States, BeIncapacitatedChore.StatesInstance, BeIncapacitatedChore>
  {
    ...
    public override void InitializeStates(out StateMachine.BaseState default_state)
    {
      ...
      this.incapacitation_root.lookingForBed.Update("LookForAvailableClinic", (Action<BeIncapacitatedChore.StatesInstance, float>) ((smi, dt) => smi.master.FindAvailableMedicalBed(smi.master.GetComponent<Navigator>())), UpdateRate.SIM_1000ms).Enter("PlayAnim", (StateMachine<BeIncapacitatedChore.States, BeIncapacitatedChore.StatesInstance, BeIncapacitatedChore, object>.State.Callback) (smi =>
      {
      ...
      this.incapacitation_root.rescue.carried.Update("LookForAvailableClinic", (Action<BeIncapacitatedChore.StatesInstance, float>) ((smi, dt) =>
      {
        ...
        if (!flag)
          return;
        smi.GoTo((StateMachine.BaseState) this.incapacitation_root.lookingForBed);
      }), UpdateRate.SIM_1000ms).Enter((StateMachine<BeIncapacitatedChore.States, BeIncapacitatedChore.StatesInstance, BeIncapacitatedChore, object>.State.Callback) (smi => smi.Queue(BeIncapacitatedChore.IncapacitatedDuplicantAnim_carry, KAnim.PlayMode.Loop))).Exit((StateMachine<BeIncapacitatedChore.States, BeIncapacitatedChore.StatesInstance, BeIncapacitatedChore, object>.State.Callback) (smi => smi.Play(BeIncapacitatedChore.IncapacitatedDuplicantAnim_place)));
