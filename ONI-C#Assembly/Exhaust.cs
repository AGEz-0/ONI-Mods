...
public class Exhaust : KMonoBehaviour, ISim200ms
{
  ...
  protected override void OnPrefabInit()
  {
    ...
    this.GetComponent<RequireInputs>().visualizeRequirements = RequireInputs.Requirements.NoWire;
    this.simRenderLoadBalance = true;
  }

  protected override void OnSpawn() => this.OnConduitStateChanged((object) null);

  private void OnConduitStateChanged(object data)
  {
    this.operational.SetActive(this.operational.IsOperational && !this.vent.IsBlocked);
  }
  ...
  private bool EmitCommon(int cell, PrimaryElement primary_element, Exhaust.EmitDelegate emit)
  {
    ...
    if (this.lastElementEmmited != primary_element.ElementID)
    {
      ...
      if (primary_element.Element != null && primary_element.Element.substance != null)
        this.Trigger(-793429877, (object) primary_element.Element.substance.colour);
    }
