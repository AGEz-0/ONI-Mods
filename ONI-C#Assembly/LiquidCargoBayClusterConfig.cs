...
// Type: LiquidCargoBayClusterConfig
...
public class LiquidCargoBayClusterConfig : IBuildingConfig
{
  ...
  public float CAPACITY = TUNING.ROCKETRY.LIQUID_CARGO_BAY_CLUSTER_CAPACITY * TUNING.ROCKETRY.CARGO_CAPACITY_SCALE;
  ...
  public override BuildingDef CreateBuildingDef()
  {
    ...
    BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef("LiquidCargoBayCluster", 5, 5, "rocket_cluster_storage_liquid_kanim", 1000, 60f, denseTieR2, construction_materials, 9999f, BuildLocationRule.Anywhere, none, noise);
