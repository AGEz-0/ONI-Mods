...
public class BeanPlantConfig : IEntityConfig
{
  ...
  public GameObject CreatePrefab()
  {
    ...
    GameObject registerSeedForPlant = EntityTemplates.CreateAndRegisterSeedForPlant(plant, dlcRestrictions, SeedProducer.ProductionType.Crop, "BeanPlantSeed", name3, desc2, anim2, additionalTags: additionalTags, replantGroundTag: replantGroundTag, sortOrder: 3, domesticatedDescription: domesticatedDescription, collisionShape: EntityTemplates.CollisionShape.RECTANGLE, width: 0.6f, height: 0.3f, ignoreDefaultSeedTag: true);
