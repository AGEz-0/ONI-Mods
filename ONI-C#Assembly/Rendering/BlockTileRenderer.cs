...
public class BlockTileRenderer : MonoBehaviour
{
  ...
  {
    return (UnityEngine.Object) go != (UnityEngine.Object) null && (UnityEngine.Object) go.GetComponent<Building>().Def == (UnityEngine.Object) def;
  }
  ...
  public virtual BlockTileRenderer.Bits GetConnectionBits(int x, int y, int query_layer)
  {
    ...
    BuildingDef def = (UnityEngine.Object) gameObject != (UnityEngine.Object) null ? gameObject.GetComponent<Building>().Def : (BuildingDef) null;
    if (y > 0)
    {
  ...
  public virtual BlockTileRenderer.Bits GetDecorConnectionBits(int x, int y, int query_layer)
  {
    ...
    {
      int cell = (y - 1) * Grid.WidthInCells + x;
      if (x > 0 && (UnityEngine.Object) Grid.Objects[cell - 1, query_layer] != (UnityEngine.Object) null)
        decorConnectionBits |= BlockTileRenderer.Bits.DownLeft;
      if ((UnityEngine.Object) Grid.Objects[cell, query_layer] != (UnityEngine.Object) null)
        decorConnectionBits |= BlockTileRenderer.Bits.Down;
      if (x < Grid.WidthInCells - 1 && (UnityEngine.Object) Grid.Objects[cell + 1, query_layer] != (UnityEngine.Object) null)
  ...
  private void Render()
  {
    ...
    if (GameUtil.IsCapturingTimeLapse())
    {
      ...
      vector2I2 = new Vector2I(Grid.WidthInCells / 16 /*0x10*/, Grid.HeightInCells / 16 /*0x10*/);
    }
    else
    {
      GridArea visibleArea = GridVisibleArea.GetVisibleArea();
      vector2I1 = new Vector2I(visibleArea.Min.x / 16 /*0x10*/, visibleArea.Min.y / 16 /*0x10*/);
      vector2I2 = new Vector2I((visibleArea.Max.x + 16 /*0x10*/ - 1) / 16 /*0x10*/, (visibleArea.Max.y + 16 /*0x10*/ - 1) / 16 /*0x10*/);
    }
    foreach (KeyValuePair<KeyValuePair<BuildingDef, BlockTileRenderer.RenderInfoLayer>, BlockTileRenderer.RenderInfo> keyValuePair in this.renderInfo)
    {
  ...
  protected class RenderInfo
  {
      ...
      SimHashes element)
    {
      ...
      int num_x_chunks = Grid.WidthInCells / 16 /*0x10*/ + 1;
      int num_y_chunks = Grid.HeightInCells / 16 /*0x10*/ + 1;
      ...
      List<Color> colours)
    {
      ...
      indices.Clear();
      colours.Clear();
      for (int y = chunk_y * 16 /*0x10*/; y < chunk_y * 16 /*0x10*/ + 16 /*0x10*/; ++y)
      {
        for (int x = chunk_x * 16 /*0x10*/; x < chunk_x * 16 /*0x10*/ + 16 /*0x10*/; ++x)
        {
      ...
      if (this.decorRenderInfo == null)
        return;
      this.decorRenderInfo.Rebuild(renderer, this.occupiedCells, chunk_x, chunk_y, this.decorZOffset, 16 /*0x10*/, vertices, uvs, colours, indices, this.element);
    }
