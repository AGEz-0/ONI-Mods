...
public static class Expectations
{
  public static List<Expectation[]> ExpectationsByTier = new List<Expectation[]>()
  {
    ...
    new Expectation[1]
    {
      (Expectation) Expectations.QOLExpectation(16 /*0x10*/, (string) UI.ROLES_SCREEN.EXPECTATIONS.QUALITYOFLIFE.TIER5.NAME, (string) UI.ROLES_SCREEN.EXPECTATIONS.QUALITYOFLIFE.TIER5.DESCRIPTION)
    },
    new Expectation[1]
    {
  ...
  {
    return new AttributeModifier(Db.Get().Attributes.QualityOfLifeExpectation.Id, (float) level, (string) DUPLICANTS.NEEDS.QUALITYOFLIFE.EXPECTATION_MOD_NAME);
  }
