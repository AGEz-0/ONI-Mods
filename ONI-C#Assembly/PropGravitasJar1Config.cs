...
public class PropGravitasJar1Config : IEntityConfig, IHasDlcRestrictions
{
  ...
  public GameObject CreatePrefab()
  {
    ...
    KAnimFile anim = Assets.GetAnim((HashedString) "gravitas_jar1_kanim");
    EffectorValues decor = tieR0_1;
    EffectorValues noise = tieR0_2;
    GameObject placedEntity = EntityTemplates.CreatePlacedEntity("PropGravitasJar1", name, desc, 50f, anim, "off", Grid.SceneLayer.Building, 1, 2, decor, noise, additionalTags: new List<Tag>()
    {
      GameTags.Gravitas
    });
