...
public class WormPlantConfig : IEntityConfig, IHasDlcRestrictions
{
  ...
  public GameObject CreatePrefab()
  {
    ...
    KAnimFile anim = Assets.GetAnim((HashedString) "seed_wormwood_kanim");
    ...
    EntityTemplates.CreateAndRegisterPreviewForPlant(EntityTemplates.CreateAndRegisterSeedForPlant(plant, (IHasDlcRestrictions) this, SeedProducer.ProductionType.Harvest, "WormPlantSeed", name, desc, anim, additionalTags: additionalTags, replantGroundTag: replantGroundTag, sortOrder: 3, domesticatedDescription: domesticatedDescription, width: 0.3f, height: 0.3f), "WormPlant_preview", Assets.GetAnim((HashedString) "wormwood_kanim"), "place", 1, 2);
    return plant;
  }
  ...
  public void OnPrefabInit(GameObject prefab)
  {
    ...
    transformingPlant.eventDataCondition = (Func<object, bool>) (data =>
    {
      ...
      if (tendingEventData != null)
      {
        ...
        if ((UnityEngine.Object) component != (UnityEngine.Object) null && component.species == GameTags.Creatures.Species.DivergentSpecies)
          return true;
      }
      return false;
    });
