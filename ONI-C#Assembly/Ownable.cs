...
public class Ownable : Assignable, ISaveLoadable, IGameObjectEffectDescriptor
{
  ...
  private void UpdateTint()
  {
    ...
    {
      component1.TintColour = (Color32) (this.assignee == null ? this.unownedTint : this.ownedTint);
    }
    else
    {
      ...
      if (!((UnityEngine.Object) component2 != (UnityEngine.Object) null) || !component2.HasBatchInstanceData)
        return;
      component2.TintColour = (Color32) (this.assignee == null ? this.unownedTint : this.ownedTint);
    }
  }
