...
public class PropFacilityChairConfig : IEntityConfig
{
  public GameObject CreatePrefab()
  {
    ...
    GameObject placedEntity = EntityTemplates.CreatePlacedEntity("PropFacilityChair", name, desc, 50f, anim, "off", Grid.SceneLayer.Building, 2, 2, decor, PermittedRotations.R90, noise: noise, additionalTags: new List<Tag>()
    {
      GameTags.Gravitas
    });
