...
public class GlomConfig : IEntityConfig
{
  ...
  public GameObject CreatePrefab()
  {
    ...
    EntityTemplates.ExtendEntityToBasicCreature(placedEntity, FactionManager.FactionID.Pest, "GlomBaseTrait", onDeathDropID: "", onDeathDropCount: 0.0f, warningLowTemperature: 303.15f, warningHighTemperature: 373.15f, lethalLowTemperature: 273.15f, lethalHighTemperature: 473.15f);
    placedEntity.AddWeapon(1f, 1f);
    placedEntity.AddOrGet<Pickupable>().sortOrder = TUNING.CREATURES.SORTING.CRITTER_ORDER["Glom"];
