  ...
  IBasicBuilding
{
  ...
  protected override void OnSpawn()
  {
    ...
    this.GetComponent<DirectionControl>().onDirectionChanged += new Action<WorkableReactable.AllowedDirection>(this.OnDirectionChanged);
  ...
  private class WashHandsReactable(
    Workable workable,
    ChoreType chore_type,
    WorkableReactable.AllowedDirection allowed_direction = WorkableReactable.AllowedDirection.Any) : 
    WorkableReactable(workable, (HashedString) "WashHands", chore_type, allowed_direction)
  {
      ...
      Navigator.ActiveTransition transition)
    {
      ...
      {
        HandSanitizer component1 = this.workable.GetComponent<HandSanitizer>();
  ...
  public class SMInstance(HandSanitizer master) : 
    GameStateMachine<HandSanitizer.States, HandSanitizer.SMInstance, HandSanitizer, object>.GameInstance(master)
  {
    ...
    public bool OutputFull()
    {
      ...
      return (UnityEngine.Object) primaryElement != (UnityEngine.Object) null && (double) primaryElement.Mass >= (double) this.master.maxUses * (double) this.master.massConsumedPerUse;
    }
  ...
  public class Work : Workable, IGameObjectEffectDescriptor
  {
    ...
    protected override bool OnWorkTick(WorkerBase worker, float dt)
    {
      ...
      if (component1.canSanitizeStorage && (bool) (UnityEngine.Object) worker.GetComponent<Storage>())
      {
