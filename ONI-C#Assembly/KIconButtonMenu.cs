...
public class KIconButtonMenu : KScreen
{
  ...
  public void RefreshButtonTooltip()
  {
    for (int index = 0; index < this.buttons.Count; ++index)
    {
      ...
      if ((UnityEngine.Object) button.buttonGo == (UnityEngine.Object) null || button == null)
        break;
      ToolTip componentInChildren1 = button.buttonGo.GetComponentInChildren<ToolTip>();
      if (button.text != null && button.text != "" && (UnityEngine.Object) componentInChildren1 != (UnityEngine.Object) null)
      {
  ...
  public virtual void RefreshButtons()
  {
    ...
    for (int index = 0; index < this.buttons.Count; ++index)
    {
      ...
      if (button != null)
      {
        ...
        Transform parent = (UnityEngine.Object) this.buttonParent != (UnityEngine.Object) null ? this.buttonParent : this.transform;
        ...
        if ((UnityEngine.Object) componentInChildren3 != (UnityEngine.Object) null)
        {
          ...
          Navigation navigation = componentInChildren3.navigation with
          {
            mode = this.automaticNavigation ? Navigation.Mode.Automatic : Navigation.Mode.None
          };
