...
public abstract class BaseLogicWireConfig : IBuildingConfig
{
  ...
  protected void DoPostConfigureComplete(LogicWire.BitDepth rating, GameObject go)
  {
    ...
    descriptor.SetupDescriptor(string.Format((string) UI.BUILDINGEFFECTS.MAX_BITS, (object) bitDepthAsInt), string.Format((string) UI.BUILDINGEFFECTS.TOOLTIPS.MAX_BITS));
