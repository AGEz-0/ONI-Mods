...
public class IceCooledFan : StateMachineComponent<IceCooledFan.StatesInstance>
{
  ...
  public class StatesInstance(IceCooledFan smi) : 
    GameStateMachine<IceCooledFan.States, IceCooledFan.StatesInstance, IceCooledFan, object>.GameInstance(smi)
  {
    ...
    GameStateMachine<IceCooledFan.States, IceCooledFan.StatesInstance, IceCooledFan>
  {
    ...
    public override void InitializeStates(out StateMachine.BaseState default_state)
    {
      ...
      this.workable.ToggleChore(new Func<IceCooledFan.StatesInstance, Chore>(IceCooledFan.States.CreateUseChore), new Action<IceCooledFan.StatesInstance, Chore>(IceCooledFan.States.SetRemoteChore), this.work_pst).EventTransition(GameHashes.ActiveChanged, this.workable.cooling, (StateMachine<IceCooledFan.States, IceCooledFan.StatesInstance, IceCooledFan, object>.Transition.ConditionCallback) (smi => (UnityEngine.Object) smi.master.workable.worker != (UnityEngine.Object) null)).EventTransition(GameHashes.OperationalChanged, this.workable.cooling, (StateMachine<IceCooledFan.States, IceCooledFan.StatesInstance, IceCooledFan, object>.Transition.ConditionCallback) (smi => (UnityEngine.Object) smi.master.workable.worker != (UnityEngine.Object) null)).Transition(this.unworkable, (StateMachine<IceCooledFan.States, IceCooledFan.StatesInstance, IceCooledFan, object>.Transition.ConditionCallback) (smi => !smi.IsWorkable()));
    ...
    {
      return (Chore) new WorkChore<IceCooledFanWorkable>(Db.Get().ChoreTypes.IceCooledFan, (IStateMachineTarget) smi.master.workable);
    }
