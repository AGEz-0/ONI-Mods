  ...
  private static IEnumerator Sequence()
  {
    ...
    foreach (MinionIdentity liveMinionIdentity in Components.LiveMinionIdentities)
    {
      if ((UnityEngine.Object) liveMinionIdentity != (UnityEngine.Object) null)
      {
        ...
        Db db = Db.Get();
        EmoteChore emoteChore = new EmoteChore((IStateMachineTarget) liveMinionIdentity.GetComponent<ChoreProvider>(), db.ChoreTypes.EmoteHighPriority, db.Emotes.Minion.Cheer, 4);
      }
    }
    ...
    {
      if ((UnityEngine.Object) spaceArtifact1 != (UnityEngine.Object) null && spaceArtifact1.HasTag(GameTags.Stored) && !spaceArtifact1.HasTag(GameTags.CharmedArtifact))
      {
        bool flag = true;
        foreach (SpaceArtifact spaceArtifact2 in spaceArtifactList)
        {
          if (!((UnityEngine.Object) spaceArtifact2 == (UnityEngine.Object) spaceArtifact1) && ((UnityEngine.Object) spaceArtifact1.GetMyWorld() == (UnityEngine.Object) spaceArtifact2.GetMyWorld() || Grid.GetCellDistance(Grid.PosToCell((KMonoBehaviour) spaceArtifact1), Grid.PosToCell((KMonoBehaviour) spaceArtifact2)) < 10))
          {
            flag = false;
            break;
          }
    ...
    if (spaceArtifactList.Count < 3)
    {
      foreach (SpaceArtifact spaceArtifact in Components.SpaceArtifacts)
      {
        ...
        {
          if ((UnityEngine.Object) spaceArtifact != (UnityEngine.Object) null && !spaceArtifact.HasTag(GameTags.CharmedArtifact))
          {
            ...
            else
            {
              ...
              {
                if (!((UnityEngine.Object) cmp == (UnityEngine.Object) spaceArtifact) && Grid.GetCellDistance(Grid.PosToCell((KMonoBehaviour) spaceArtifact), Grid.PosToCell((KMonoBehaviour) cmp)) < 10)
                {
                  flag = false;
                  break;
                }
