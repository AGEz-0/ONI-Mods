  ...
  GameStateMachine<SweepStates, SweepStates.Instance, IStateMachineTarget, SweepStates.Def>
{
  ...
  public new class Instance(Chore<SweepStates.Instance> chore, SweepStates.Def def) : 
    GameStateMachine<SweepStates, SweepStates.Instance, IStateMachineTarget, SweepStates.Def>.GameInstance((IStateMachineTarget) chore, def)
  {
