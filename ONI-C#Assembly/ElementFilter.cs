...
public class ElementFilter : KMonoBehaviour, ISaveLoadable, ISecondaryOutput
{
  ...
  protected override void OnSpawn()
  {
    ...
    if (layer == null)
      return;
    this.partitionerEntry = GameScenePartitioner.Instance.Add("ElementFilterConduitExists", (object) this.gameObject, this.filteredCell, layer, (Action<object>) (data => this.UpdateConduitExistsStatus()));
  }
