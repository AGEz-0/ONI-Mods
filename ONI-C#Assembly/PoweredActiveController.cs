  ...
  GameStateMachine<PoweredActiveController, PoweredActiveController.Instance, IStateMachineTarget, PoweredActiveController.Def>
{
  ...
  public new class Instance(IStateMachineTarget master, PoweredActiveController.Def def) : 
    GameStateMachine<PoweredActiveController, PoweredActiveController.Instance, IStateMachineTarget, PoweredActiveController.Def>.GameInstance(master, def)
  {
  }
}
