...
public class BatterySmart : Battery, IActivationRangeTarget
{
  ...
  {
    this.logicMeter = new MeterController((KAnimControllerBase) this.GetComponent<KBatchedAnimController>(), "logicmeter_target", "logicmeter", Meter.Offset.Infront, Grid.SceneLayer.NoLayer, Array.Empty<string>());
  }
  ...
  {
    get => (string) BUILDINGS.PREFABS.BATTERYSMART.SIDESCREEN_TITLE;
  }

  public string ActivateSliderLabelText
  {
    get => (string) BUILDINGS.PREFABS.BATTERYSMART.SIDESCREEN_DEACTIVATE;
  }

  public string DeactivateSliderLabelText
  {
    get => (string) BUILDINGS.PREFABS.BATTERYSMART.SIDESCREEN_ACTIVATE;
  }
}
