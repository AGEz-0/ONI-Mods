...
{
  private const int COUNTER_MODULUS_INVALID = -2147483648 /*0x80000000*/;
  ...
  public override void OnPlay(AnimEventManager.EventPlayerData behaviour)
  {
    ...
    Vector3 vector3 = behaviour.position;
    float volume = 1f;
    ...
    if (num1 >= 0)
    {
      int num3 = (int) instance.setParameterByName("eventCount", (float) num1);
    }
