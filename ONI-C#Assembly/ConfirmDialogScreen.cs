...
public class ConfirmDialogScreen : KModalScreen
{
    ...
    Sprite image_sprite = null)
  {
    ...
    this.confirmButton.GetComponentInChildren<LocText>().text = confirm_text == null ? STRINGS.UI.CONFIRMDIALOG.OK.text : confirm_text;
    this.cancelButton.GetComponentInChildren<LocText>().text = cancel_text == null ? STRINGS.UI.CONFIRMDIALOG.CANCEL.text : cancel_text;
