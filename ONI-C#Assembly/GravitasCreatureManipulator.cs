  ...
  GameStateMachine<GravitasCreatureManipulator, GravitasCreatureManipulator.Instance, IStateMachineTarget, GravitasCreatureManipulator.Def>
{
  ...
  public override void InitializeStates(out StateMachine.BaseState default_state)
  {
    ...
    this.operational.idle.PlayAnim("idle", KAnim.PlayMode.Loop).Enter(new StateMachine<GravitasCreatureManipulator, GravitasCreatureManipulator.Instance, IStateMachineTarget, GravitasCreatureManipulator.Def>.State.Callback(GravitasCreatureManipulator.CheckForCritter)).ToggleMainStatusItem(Db.Get().BuildingStatusItems.CreatureManipulatorWaiting).ParamTransition<GameObject>((StateMachine<GravitasCreatureManipulator, GravitasCreatureManipulator.Instance, IStateMachineTarget, GravitasCreatureManipulator.Def>.Parameter<GameObject>) this.creatureTarget, this.operational.capture, (StateMachine<GravitasCreatureManipulator, GravitasCreatureManipulator.Instance, IStateMachineTarget, GravitasCreatureManipulator.Def>.Parameter<GameObject>.Callback) ((smi, p) => (UnityEngine.Object) p != (UnityEngine.Object) null && !smi.IsCritterStored)).ParamTransition<GameObject>((StateMachine<GravitasCreatureManipulator, GravitasCreatureManipulator.Instance, IStateMachineTarget, GravitasCreatureManipulator.Def>.Parameter<GameObject>) this.creatureTarget, this.operational.working.pre, (StateMachine<GravitasCreatureManipulator, GravitasCreatureManipulator.Instance, IStateMachineTarget, GravitasCreatureManipulator.Def>.Parameter<GameObject>.Callback) ((smi, p) => (UnityEngine.Object) p != (UnityEngine.Object) null && smi.IsCritterStored)).ParamTransition<float>((StateMachine<GravitasCreatureManipulator, GravitasCreatureManipulator.Instance, IStateMachineTarget, GravitasCreatureManipulator.Def>.Parameter<float>) this.cooldownTimer, this.operational.cooldown, GameStateMachine<GravitasCreatureManipulator, GravitasCreatureManipulator.Instance, IStateMachineTarget, GravitasCreatureManipulator.Def>.IsGTZero);
    ...
    double num2;
    this.operational.working.loop.PlayAnim("working_loop", KAnim.PlayMode.Loop).Update((System.Action<GravitasCreatureManipulator.Instance, float>) ((smi, dt) => num2 = (double) smi.sm.workingTimer.DeltaClamp(-dt, 0.0f, float.MaxValue, smi)), UpdateRate.SIM_1000ms).ParamTransition<float>((StateMachine<GravitasCreatureManipulator, GravitasCreatureManipulator.Instance, IStateMachineTarget, GravitasCreatureManipulator.Def>.Parameter<float>) this.workingTimer, this.operational.working.pst, GameStateMachine<GravitasCreatureManipulator, GravitasCreatureManipulator.Instance, IStateMachineTarget, GravitasCreatureManipulator.Def>.IsLTEZero).OnTargetLost(this.creatureTarget, this.operational.idle);
    ...
    double num3;
    GameStateMachine<GravitasCreatureManipulator, GravitasCreatureManipulator.Instance, IStateMachineTarget, GravitasCreatureManipulator.Def>.State state = this.operational.cooldown.PlayAnim("working_cooldown", KAnim.PlayMode.Loop).Update((System.Action<GravitasCreatureManipulator.Instance, float>) ((smi, dt) => num3 = (double) smi.sm.cooldownTimer.DeltaClamp(-dt, 0.0f, float.MaxValue, smi)), UpdateRate.SIM_1000ms).ParamTransition<float>((StateMachine<GravitasCreatureManipulator, GravitasCreatureManipulator.Instance, IStateMachineTarget, GravitasCreatureManipulator.Def>.Parameter<float>) this.cooldownTimer, this.operational.idle, GameStateMachine<GravitasCreatureManipulator, GravitasCreatureManipulator.Instance, IStateMachineTarget, GravitasCreatureManipulator.Def>.IsLTEZero);
    ...
    Func<string, GravitasCreatureManipulator.Instance, string> func1 = new Func<string, GravitasCreatureManipulator.Instance, string>(GravitasCreatureManipulator.Processing);
    ...
    Func<string, GravitasCreatureManipulator.Instance, string> resolve_string_callback = func1;
    Func<string, GravitasCreatureManipulator.Instance, string> resolve_tooltip_callback = func2;
  ...
  private static void CheckForCritter(GravitasCreatureManipulator.Instance smi)
  {
    ...
    while (objectLayerListItem != null)
    {
      ...
      if (!((UnityEngine.Object) gameObject2 == (UnityEngine.Object) null) && smi.IsAccepted(gameObject2))
      {
    ...
    GameStateMachine<GravitasCreatureManipulator, GravitasCreatureManipulator.Instance, IStateMachineTarget, GravitasCreatureManipulator.Def>.GameInstance
  {
    ...
    public void DropCritter()
    {
      ...
      Vector3 posCbc = Grid.CellToPosCBC(Grid.PosToCell((StateMachine.Instance) this.smi), Grid.SceneLayer.Creatures);
      this.smi.def.dropOffset.ToVector3();
      if (this.m_storage.items.Count > 0 && (UnityEngine.Object) this.m_storage.items[0] != (UnityEngine.Object) null)
      {
        KBoxCollider2D component = this.m_storage.items[0].GetComponent<KBoxCollider2D>();
        if ((UnityEngine.Object) component != (UnityEngine.Object) null && (double) component.size.x > 1.5 && component.PrefabID() != (Tag) "Moo")
          posCbc.x += 0.5f;
      }
      this.m_storage.DropAll(posCbc, offset: this.smi.def.dropOffset.ToVector3(), collect_dropped_items: collect_dropped_items);
