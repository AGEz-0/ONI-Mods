  ...
  GameStateMachine<DecompositionMonitor, DecompositionMonitor.Instance>
{
  ...
  {
    return !smi.isMasterNull ? new FliesFX.Instance(smi.master, new Vector3(0.0f, 0.0f, -0.1f)) : (FliesFX.Instance) null;
  }
    ...
    GameStateMachine<DecompositionMonitor, DecompositionMonitor.Instance, IStateMachineTarget, object>.GameInstance
  {
    ...
    public bool IsExposed()
    {
      ...
      return (UnityEngine.Object) component == (UnityEngine.Object) null || !component.HasTag(GameTags.Preserved);
    }
