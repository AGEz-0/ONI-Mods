...
public class DevAutoPlumber
{
  ...
  public static void DoElectricalPlumbing(Building building)
  {
    ...
    GameObject go = Grid.Objects[cell, 26];
    if ((UnityEngine.Object) go != (UnityEngine.Object) null)
      go.Trigger(-790448070);
  ...
  public static void SetupSolidOreDelivery(Building building)
  {
    ...
    {
      int num1 = (UnityEngine.Object) DevAutoPlumber.TrySpawnElementOreFromTag(component.RequestedItemTag, Grid.PosToCell((KMonoBehaviour) building), component.Capacity) == (UnityEngine.Object) null ? 1 : 0;
    }
    else
    {
      foreach (ComplexRecipe recipe in ComplexRecipeManager.Get().recipes)
      {
        ...
        {
          if (fabricator == (Tag) building.Def.PrefabID)
          {
            foreach (ComplexRecipe.RecipeElement ingredient in recipe.ingredients)
            {
              int num2 = (UnityEngine.Object) DevAutoPlumber.TrySpawnElementOreFromTag(ingredient.material, Grid.PosToCell((KMonoBehaviour) building), ingredient.amount * 10f) == (UnityEngine.Object) null ? 1 : 0;
            }
          }
        }
      }
  ...
  private static void SetupPlumbingInput(Building building)
  {
    ...
    switch (component.ConduitType)
    {
      ...
      case ConduitType.Liquid:
        ...
        conduitTypeLayers = new int[2]{ 16 /*0x10*/, 19 };
        break;
    }
  ...
  private static Element GuessMostRelevantElementForPump(Building destinationBuilding)
  {
    ...
    {
      if ((UnityEngine.Object) elementConverter != (UnityEngine.Object) null)
      {
        bool flag = false;
        for (int index = 0; index < elementConverter.consumedElements.Length; ++index)
        {
          if (elementConverter.consumedElements[index].Tag == match.tag)
          {
            flag = true;
            break;
          }
      ...
      else if ((UnityEngine.Object) elementConsumer != (UnityEngine.Object) null)
      {
        bool flag = false;
      ...
      else if ((UnityEngine.Object) rocketEngineCluster != (UnityEngine.Object) null)
      {
        bool flag = false;
    ...
    DevAutoPlumber.PortSelection portSelection)
  {
    ...
    if ((UnityEngine.Object) sourceBuilding == (UnityEngine.Object) null)
    ...
    return DevAutoPlumber.GetGridPath(conduitStart, conduitEnd, (Func<int, bool>) (cell =>
    {
      ...
      foreach (int conduitTypeLayer in conduitTypeLayers)
      {
        ...
        bool flag1 = (UnityEngine.Object) gameObject == (UnityEngine.Object) sourceBuilding.gameObject || (UnityEngine.Object) gameObject == (UnityEngine.Object) destinationBuilding.gameObject;
        bool flag2 = cell == conduitEnd || cell == conduitStart;
        if ((UnityEngine.Object) gameObject != (UnityEngine.Object) null && (!flag1 || flag1 && !flag2))
          return false;
      }
      return true;
    }));
