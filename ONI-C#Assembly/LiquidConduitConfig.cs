...
public class LiquidConduitConfig : IBuildingConfig
{
  ...
  public override BuildingDef CreateBuildingDef()
  {
    ...
    string[] plumbableOrMetals = MATERIALS.PLUMBABLE_OR_METALS;
    EffectorValues none1 = NOISE_POLLUTION.NONE;
    EffectorValues none2 = BUILDINGS.DECOR.NONE;
    EffectorValues noise = none1;
    BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef("LiquidConduit", 1, 1, "utilities_liquid_kanim", 10, 3f, tieR2, plumbableOrMetals, 1600f, BuildLocationRule.Anywhere, none2, noise);
