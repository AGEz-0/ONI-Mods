...
{
  public static string ID = nameof (CopperCometConfig);

  public GameObject CreatePrefab()
  {
    GameObject entity = EntityTemplates.CreateEntity(CopperCometConfig.ID, (string) UI.SPACEDESTINATIONS.COMETS.COPPERCOMET.NAME);
    ...
    {
      Assets.GetAnim((HashedString) "meteor_copper_kanim")
    };
