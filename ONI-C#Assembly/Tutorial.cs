...
public class Tutorial : KMonoBehaviour, IRender1000ms
{
  ...
  protected override void OnSpawn()
  {
    if (this.tutorialMessagesRemaining.Count != 0)
    {
      ...
      if (GameUtil.GetCurrentCycle() > 100)
      {
        ...
        this.tutorialMessagesSeen.Add(16 /*0x10*/);
        this.tutorialMessagesSeen.Add(17);
      }
      if (BuildingInventory.Instance.BuildingCount((Tag) "SuitLocker") > 0)
        this.tutorialMessagesSeen.Add(12);
    }
    if (this.saved_TM_COUNT < 24)
    {
      Debug.Log((object) "Upgraded tutorial messages");
  ...
  private void OnDiscover(Tag category_tag, Tag tag)
  {
    ...
    if (elementByHash == null || !(tag == elementByHash.tag))
      return;
  ...
  public Message TutorialMessage(Tutorial.TutorialMessages tm, bool queueMessage = true)
  {
    ...
    switch (tm)
    {
      ...
      case Tutorial.TutorialMessages.TM_Radiation:
        message = (Message) new global::TutorialMessage(Tutorial.TutorialMessages.TM_Radiation, (string) MISC.NOTIFICATIONS.RADIATION.NAME, (string) MISC.NOTIFICATIONS.RADIATION.MESSAGEBODY, (string) MISC.NOTIFICATIONS.RADIATION.TOOLTIP, icon: "icon_category_radiation", requiredDlcIds: DlcManager.EXPANSION1);
        break;
      case Tutorial.TutorialMessages.TM_BionicBattery:
        message = (Message) new global::TutorialMessage(Tutorial.TutorialMessages.TM_BionicBattery, (string) MISC.NOTIFICATIONS.BIONICBATTERY.NAME, (string) MISC.NOTIFICATIONS.BIONICBATTERY.MESSAGEBODY, (string) MISC.NOTIFICATIONS.BIONICBATTERY.TOOLTIP, icon: "electrobank_large", requiredDlcIds: DlcManager.DLC3);
        break;
      case Tutorial.TutorialMessages.TM_GunkedToilet:
        message = (Message) new global::TutorialMessage(Tutorial.TutorialMessages.TM_GunkedToilet, (string) MISC.NOTIFICATIONS.GUNKEDTOILET.NAME, (string) MISC.NOTIFICATIONS.GUNKEDTOILET.MESSAGEBODY, (string) MISC.NOTIFICATIONS.GUNKEDTOILET.TOOLTIP, icon: "icon_plunger", requiredDlcIds: DlcManager.DLC3);
        break;
      case Tutorial.TutorialMessages.TM_SlipperySurface:
        message = (Message) new global::TutorialMessage(Tutorial.TutorialMessages.TM_SlipperySurface, (string) MISC.NOTIFICATIONS.SLIPPERYSURFACE.NAME, (string) MISC.NOTIFICATIONS.SLIPPERYSURFACE.MESSAGEBODY, (string) MISC.NOTIFICATIONS.SLIPPERYSURFACE.TOOLTIP, icon: "icon_action_mop");
        break;
      case Tutorial.TutorialMessages.TM_BionicOil:
        message = (Message) new global::TutorialMessage(Tutorial.TutorialMessages.TM_BionicOil, (string) MISC.NOTIFICATIONS.BIONICOIL.NAME, (string) MISC.NOTIFICATIONS.BIONICOIL.MESSAGEBODY, (string) MISC.NOTIFICATIONS.BIONICOIL.TOOLTIP, icon: "icon_oil", requiredDlcIds: DlcManager.DLC3);
        break;
    }
    DebugUtil.AssertArgs((message != null | flag ? 1 : 0) != 0, (object) "No tutorial message:", (object) tm);
    if (queueMessage)
    {
      DebugUtil.AssertArgs((!flag ? 1 : 0) != 0, (object) "Attempted to queue deprecated Tutorial Message", (object) tm);
  ...
  private string OnLowFoodTooltip(List<Notification> notifications, object data)
  {
    ...
    float calories = WorldResourceAmountTracker<RationTracker>.Get().CountAmount((Dictionary<string, float>) null, ((WorldContainer) data).worldInventory);
    float f = (float) Components.LiveMinionIdentities.GetWorldItems(((WorldContainer) data).id).Count * DUPLICANTSTATS.STANDARD.BaseStats.CALORIES_BURNED_PER_CYCLE;
  ...
  public void DebugNotification()
  {
    ...
    this.notifier.Add(new Notification($"{str} ({this.debugMessageCount++.ToString()})", type, (Func<List<Notification>, object, string>) ((n, d) => MISC.NOTIFICATIONS.NEEDTOILET.TOOLTIP.text)));
  }
  ...
  private int GetUnrefrigeratedFood(List<Pickupable> foods)
  {
    ...
    if ((UnityEngine.Object) ClusterManager.Instance.activeWorld.worldInventory != (UnityEngine.Object) null)
    {
      ...
      {
        if ((UnityEngine.Object) cmp.storage != (UnityEngine.Object) null && ((UnityEngine.Object) cmp.storage.GetComponent<RationBox>() != (UnityEngine.Object) null || (UnityEngine.Object) cmp.storage.GetComponent<Refrigerator>() != (UnityEngine.Object) null))
        {
  ...
  private bool BedExists() => Components.NormalBeds.GlobalCount > 0;
  ...
  private bool EnoughFood()
  {
    ...
    return (double) WorldResourceAmountTracker<RationTracker>.Get().CountAmount((Dictionary<string, float>) null, ClusterManager.Instance.activeWorld.worldInventory) / (double) ((float) count * TUNING.FOOD.FOOD_CALORIES_PER_CYCLE) >= 1.0;
  }
  ...
  private void ZoomToNextOxygenGenerator()
  {
    ...
    if ((UnityEngine.Object) oxygenGenerator != (UnityEngine.Object) null)
      CameraController.Instance.SetTargetPos(oxygenGenerator.transform.GetPosition(), 8f, true);
    else
  ...
  private void ZoomToNextUnrefrigeratedFood()
  {
    ...
    Pickupable pickupable = foods[this.focusedUnrefrigFood];
