...
public class MournChore : Chore<MournChore.StatesInstance>
{
  ...
  {
    string name = "anim_react_mourning_kanim";
    ...
    if ((UnityEngine.Object) component == (UnityEngine.Object) null)
      return Assets.GetAnim((HashedString) name);
    return component.model == BionicMinionConfig.MODEL ? Assets.GetAnim((HashedString) "anim_bionic_react_mourning_kanim") : Assets.GetAnim((HashedString) name);
  }
  ...
  public class StatesInstance(MournChore master) : 
    GameStateMachine<MournChore.States, MournChore.StatesInstance, MournChore, object>.GameInstance(master)
  {
  ...
  public class States : GameStateMachine<MournChore.States, MournChore.StatesInstance, MournChore>
  {
    ...
    public override void InitializeStates(out StateMachine.BaseState default_state)
    {
      ...
      this.root.ToggleAnims(new Func<MournChore.StatesInstance, KAnimFile>(MournChore.GetAnimFileName)).Exit("DestroyLocator", (StateMachine<MournChore.States, MournChore.StatesInstance, MournChore, object>.State.Callback) (smi => smi.DestroyLocator()));
