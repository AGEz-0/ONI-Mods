...
public class PrickleFruitConfig : IEntityConfig
{
  ...
  {
    return EntityTemplates.ExtendEntityToFood(EntityTemplates.CreateLooseEntity(PrickleFruitConfig.ID, (string) STRINGS.ITEMS.FOOD.PRICKLEFRUIT.NAME, (string) STRINGS.ITEMS.FOOD.PRICKLEFRUIT.DESC, 1f, false, Assets.GetAnim((HashedString) "bristleberry_kanim"), "object", Grid.SceneLayer.Front, EntityTemplates.CollisionShape.RECTANGLE, 0.8f, 0.4f, true), TUNING.FOOD.FOOD_TYPES.PRICKLEFRUIT);
  }
