  ...
  ISim200ms
{
  ...
  {
    (HashedString) "anim_interacts_windtunnel_center_kanim",
    (HashedString) "anim_interacts_windtunnel_left_kanim",
    (HashedString) "anim_interacts_windtunnel_right_kanim"
  };
  ...
  protected override void OnSpawn()
  {
    ...
    this.GetComponent<KSelectable>().ToggleStatusItem(Db.Get().BuildingStatusItems.WindTunnelIntake, this.invalidIntake, (object) this);
    ...
    GameStateMachine<VerticalWindTunnel.States, VerticalWindTunnel.StatesInstance, VerticalWindTunnel>
  {
    ...
    public override void InitializeStates(out StateMachine.BaseState default_state)
    {
      ...
      this.operational.playing.PlayAnim("working_loop", KAnim.PlayMode.Loop).Enter((StateMachine<VerticalWindTunnel.States, VerticalWindTunnel.StatesInstance, VerticalWindTunnel, object>.State.Callback) (smi => smi.SetActive(true))).Exit((StateMachine<VerticalWindTunnel.States, VerticalWindTunnel.StatesInstance, VerticalWindTunnel, object>.State.Callback) (smi => smi.SetActive(false))).ParamTransition<int>((StateMachine<VerticalWindTunnel.States, VerticalWindTunnel.StatesInstance, VerticalWindTunnel, object>.Parameter<int>) this.playerCount, this.operational.post, (StateMachine<VerticalWindTunnel.States, VerticalWindTunnel.StatesInstance, VerticalWindTunnel, object>.Parameter<int>.Callback) ((smi, p) => p == 0)).Enter("GasWalls", (StateMachine<VerticalWindTunnel.States, VerticalWindTunnel.StatesInstance, VerticalWindTunnel, object>.State.Callback) (smi => smi.master.SetGasWalls(true))).Exit("GasWalls", (StateMachine<VerticalWindTunnel.States, VerticalWindTunnel.StatesInstance, VerticalWindTunnel, object>.State.Callback) (smi => smi.master.SetGasWalls(false)));
