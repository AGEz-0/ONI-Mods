...
public class LonelyMinionHouseConfig : IBuildingConfig
{
  ...
  public static readonly HashedString ANSWER = (HashedString) "answer";
  public static readonly HashedString LIGHTS_OFF = (HashedString) "meter_lights_off";
  public static readonly HashedString LIGHTS_ON = (HashedString) "meter_lights_on_loop";
  public static readonly HashedString STORAGE = (HashedString) "storage_off";
  public static readonly HashedString STORAGE_WORK_PST = (HashedString) "working_pst";
  ...
  public override void ConfigureBuildingTemplate(GameObject go, Tag prefab_tag)
  {
    ...
    {
      Assets.GetAnim((HashedString) "anim_interacts_doorknock_kanim")
    };
    knockKnock.workAnims = new HashedString[2]
    {
      (HashedString) "knocking_pre",
      (HashedString) "knocking_loop"
    };
    knockKnock.workingPstComplete = new HashedString[1]
    {
      (HashedString) "knocking_pst"
    };
  ...
  private void ConfigureLights(GameObject go)
  {
    ...
    controller.initialMode = KAnim.PlayMode.Loop;
    ...
    kbatchedAnimTracker.symbol = (HashedString) "lights_target";
    kbatchedAnimTracker.offset = Vector3.zero;
    for (int index = 0; index < LonelyMinionHouseConfig.LIGHTS_SYMBOLS.Length; ++index)
      component.SetSymbolVisiblity((KAnimHashedString) LonelyMinionHouseConfig.LIGHTS_SYMBOLS[index], false);
  }
}
