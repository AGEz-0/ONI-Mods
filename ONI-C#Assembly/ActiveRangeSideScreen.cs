...
public class ActiveRangeSideScreen : SideScreenContent
{
  ...
  {
    this.activateValueSlider.GetComponentInChildren<ToolTip>().SetSimpleTooltip(string.Format(this.target.ActivateTooltip, (object) this.activateValueSlider.value, (object) this.deactivateValueSlider.value));
    this.deactivateValueSlider.GetComponentInChildren<ToolTip>().SetSimpleTooltip(string.Format(this.target.DeactivateTooltip, (object) this.deactivateValueSlider.value, (object) this.activateValueSlider.value));
  }
  ...
  {
    return this.target != null ? this.target.ActivationRangeTitleText : (string) UI.UISIDESCREENS.ACTIVATION_RANGE_SIDE_SCREEN.NAME;
  }
}
