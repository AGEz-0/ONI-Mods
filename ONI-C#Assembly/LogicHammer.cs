  ...
  private bool TriggerAudio()
  {
    ...
    if ((UnityEngine.Object) gameObject == (UnityEngine.Object) null)
    {
      ...
      if ((UnityEngine.Object) gameObject == (UnityEngine.Object) null)
      {
        ...
        {
          gameObject = Grid.Objects[this.resonator_cell, 31 /*0x1F*/];
          if ((UnityEngine.Object) gameObject != (UnityEngine.Object) null)
          {
          ...
          else
          {
            ...
            {
              gameObject = Grid.Objects[this.resonator_cell, 16 /*0x10*/];
              if ((UnityEngine.Object) gameObject != (UnityEngine.Object) null)
              {
                Conduit component = gameObject.GetComponent<Conduit>();
    ...
    if (b == null)
      return false;
    EventInstance instance = KFMOD.BeginOneShot(GlobalAssets.GetSound(StringFormatter.Combine(LogicHammer.SOUND_EVENT_PREFIX, b), true) ?? GlobalAssets.GetSound(LogicHammer.DEFAULT_NO_SOUND_EVENT), this.transform.position with
    {
      z = 0.0f
    });
    if (!float.IsNaN(f))
    {
      int num1 = (int) instance.setParameterByName(LogicHammer.PARAMETER_NAME, f);
    }
