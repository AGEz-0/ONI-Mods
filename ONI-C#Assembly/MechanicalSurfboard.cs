  ...
  IGameObjectEffectDescriptor
{
  ...
  public class StatesInstance(MechanicalSurfboard smi) : 
    GameStateMachine<MechanicalSurfboard.States, MechanicalSurfboard.StatesInstance, MechanicalSurfboard, object>.GameInstance(smi)
  {
  }
}
