...
public class TimerSideScreen : SideScreenContent, IRenderEveryTick
{
  ...
  {
    return (UnityEngine.Object) target.GetComponent<LogicTimerSensor>() != (UnityEngine.Object) null;
  }

  public override void SetTarget(GameObject target)
  {
    this.greenActiveZone.color = (Color) GlobalAssets.Instance.colorSet.logicOnSidescreen;
    this.redActiveZone.color = (Color) GlobalAssets.Instance.colorSet.logicOffSidescreen;
